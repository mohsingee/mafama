...
class ClientManagementVideoReminder extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'reminder:clientvideoreminder';
    ...
    {
        $reminders = DB::table('manage_client_video_email')->where('date', date('Y-m-d'))->where('status', "pending")->where('time', date('H:i'))->get();
