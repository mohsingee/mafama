...
class ClientManagementReminder extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'reminder:clientreminder';
    ...
    {
        $reminders = DB::table('manage_client_email')->where('date', date('Y-m-d'))->where('status', "pending")->where('time', date('H:i'))->get();
