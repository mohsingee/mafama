...
class ClientManagementCard extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'reminder:clientcard';
    ...
    {
        $reminders = DB::table('manage_client_card_email')->where('date', date('Y-m-d'))->where('status', "pending")->where('time', null)->get();
