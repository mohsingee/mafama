        ...
        <tr>
            ...
            if($value== 1){
                ...
                foreach($revenue as $value){
                    ...
                    <tr id="revenue_count_'.$temp.'" class="odd gradeX">
                        ...
                        '; }
                        $actual_total2 = DB::table('revenue_record')->whereYear('transaction_date', $year)->where('account_description', $value->account_description)->sum('amount_paid');
            ...
            foreach($expense as $value){
                    ...
                    <tr class="odd gradeX" id="exp_row_'.$tem.'">
                        ...
                        '; }
                        $actual_total2 = DB::table('expense_record')->whereYear('transaction_date', $year)->where('account_description', $value->account_description)->sum('amount_paid');
                        if($actual_total2 != 0){ echo '
