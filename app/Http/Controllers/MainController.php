...
public function calculator_function()
    ...
    public function account_description_amount(Request $request)
    {
        ...
        $account = DB::table('revenue_account')->where('account_name', $description)->where('uid', $uid)->first();
        if($account != ""){
  ...
  public static function get_revenue_by_col($email,$month,$col,$year="")
    ...
    public static function get_revenue_by_col1($email,$month,$col,$year="")
    {
        $year = date('Y');
        $uid = "";
        if((Auth::user()->role) == "affiliate"){
...
public function get_client_id($email){
 ...
 foreach($clients as $value){
    ...
    $balance_amount123 = \App\Http\Controllers\MainController::get_revenue_by_col($value->email,$month,'balance',$year);

    if ($balance_amount123 != 0) {
        $bill_amount1 +=\App\Http\Controllers\MainController::get_revenue_by_col($value->email,$month,'bill',$year);
        $discount1 +=\App\Http\Controllers\MainController::get_revenue_by_col($value->email,$month,'discount',$year);
...
<?php
 ...
 $html=ob_start();
    ...
    $discount=\App\Http\Controllers\MainController::get_revenue_by_col($value->email,$month,'discount',$year);
      ...
      <td><input type="checkbox" class="checkboxes" value="<?= $value->id;?>" /></td>
        ...
        <td>
            <?php if($bill_amount > 0){
                 echo '<a class="revenue_month" id="'.$month.'revenue_month'.$value->email.'" style="">'.$bill_amount.'</a>';
                }
                else{
               echo $bill_amount;
                }
        ...
        <td>
            <?php if($discount > 0){
                 echo '<a class="revenue_month" id="'.$month.'revenue_month'.$value->email.'" style="">'.$discount.'</a>';
                }
                else{
               echo $discount;
                }
        ...
        <td>
            <?php if($tax_amount > 0){
                 echo '<a class="revenue_month" id="'.$month.'revenue_month'.$value->email.'" style="">'.$tax_amount.'</a>';
                }
                else{
               echo $tax_amount;
                }
        ...
        <td>
              <?php if($shipping_amount > 0){
                 echo '<a class="revenue_month" id="'.$month.'revenue_month'.$value->email.'" style="">'.$shipping_amount.'</a>';
                }
                else{
        ...
        <td>
              <?php if($total_amount > 0){
                 echo '<a class="revenue_month" id="'.$month.'revenue_month'.$value->email.'" style="">'.$total_amount.'</a>';
                }
                else{
               echo $total_amount;
                }
        ...
        <td>
              <?php if($paid_amount > 0){
                 echo '<a class="revenue_month" id="'.$month.'revenue_month'.$value->email.'" style="">'.$paid_amount.'</a>';
                }
                else{
               echo $paid_amount;
                }
 ...
 public function get_revenue_by_quarter(Request $request)
    {
       ...
       $temp6 = 0;
        foreach($clients as $value){
            ...
            $discount=\App\Http\Controllers\MainController::get_quarter_paymentbalance_info($value->email,$month,'discount',$year);
                ...
                if($paid_amount > 0){
                 ...
                 ?>
                    <tr class="odd gradeX">
                        ...
                        <td>
                            <?php if($bill_amount > 0){
                                echo '<a class="revenue_quarter" id="'.$month.'revenue_quarter'.$value->email.'" style="">'.$bill_amount.'</a>';
                                }
                                else{
                            echo $bill_amount;
                                }
                        ...
                        <td>
                            <?php if($discount > 0){
                                echo '<a class="revenue_quarter" id="'.$month.'revenue_quarter'.$value->email.'" style="">'.$discount.'</a>';
                                }
                                else{
                            echo $discount;
                                }
                        ...
                        <td>
                            <?php if($tax_amount > 0){
                                echo '<a class="revenue_quarter" id="'.$month.'revenue_quarter'.$value->email.'" style="">'.$tax_amount.'</a>';
                                }
                                else{
                            echo $tax_amount;
                                }
                        ...
                        <td>
                            <?php if($shipping_amount > 0){
                                echo '<a class="revenue_quarter" id="'.$month.'revenue_quarter'.$value->email.'" style="">'.$shipping_amount.'</a>';
                                }
                                else{
                            echo $shipping_amount;
                                }
                        ...
                        <td>
                            <?php if($total_amount > 0){
                                echo '<a class="revenue_quarter" id="'.$month.'revenue_quarter'.$value->email.'" style="">'.$total_amount.'</a>';
                                }
                                else{
                            echo $total_amount;
                                }
                        ...
                        <td>
                            <?php if($paid_amount > 0){
                                echo '<a class="revenue_quarter" id="'.$month.'revenue_quarter'.$value->email.'" style="">'.$paid_amount.'</a>';
                                }
                                else{
                            echo $paid_amount;
                                }
...
$getcount3 = DB::table('revenue_record')->where('client_email', $email)->whereYear('transaction_date', $current_year)->whereMonth('transaction_date', $month3)->where('uid', $uid)->sum($col);
    ...
    public function projection_setup()
    {
        if(Auth::id() == NULL){
            return redirect('/home')->with('status',"Please login or register to access this page.");
        }
        ...
        // print_r($data['years']);die();
        return view('main.projection_setup')->with($data);
    }
        ...
        echo '<thead >
            <thead>
                <tr class="top-tr">
                    ...
                    <th>Dec</th>
                    <th>Total</th>
                    <th style="background:purple">Graph</th>
                </tr>
            </thead>
        </thead>
        <tbody id="myTable">
                ...
                foreach($revenue as $value){
                    ...
                    <tr id="revenue_count_'.$temp.'" class="odd gradeX">
                        ...
                        if($actual_jan!= 0){ echo '
                            <td data-count="revenuejan"><a class="actual_monthly_revenue" id="01revactual">'.number_format($actual_jan).'</a></td>
                        '; }else{ echo '
                            <td data-count="revenuejan">'.number_format($actual_jan).'</td>
                        '; }
                        ...
                        if($actual_feb != 0){ echo '
                            <td data-count="revenuefeb"><a class="actual_monthly_revenue" id="02revactual">'.number_format($actual_feb).'</a></td>
                        '; }else{ echo '
                            <td data-count="revenuefeb">'.number_format($actual_feb).'</td>
                        '; }
                        ...
                        if($actual_mar != 0){ echo '
                            <td data-count="revenuemar"><a class="actual_monthly_revenue" id="03revactual">'.number_format($actual_mar).'</a></td>
                        '; }else{ echo '
                            <td data-count="revenuemar">'.number_format($actual_mar).'</td>
                        '; }
                        ...
                        if($actual_apr != 0){ echo '
                            <td data-count="revenueapr"><a class="actual_monthly_revenue" id="04revactual">'.number_format($actual_apr).'</a></td>
                        '; }else{ echo '
                            <td data-count="revenueapr">'.number_format($actual_apr).'</td>
                        '; }
                        ...
                        if($actual_may != 0){ echo '
                            <td data-count="revenuemay"><a class="actual_monthly_revenue" id="05revactual">'.number_format($actual_may).'</a></td>
                        '; }else{ echo '
                            <td data-count="revenuemay">'.number_format($actual_may).'</td>
                        '; }
                        ...
                        if($actual_jun != 0){ echo '
                            <td data-count="revenuejun"><a class="actual_monthly_revenue" id="06revactual">'.number_format($actual_jun).'</a></td>
                        '; }else{ echo '
                            <td data-count="revenuejun">'.number_format($actual_jun).'</td>
                        '; }
                        ...
                        if($actual_jul != 0){ echo '
                            <td data-count="revenuejul"><a class="actual_monthly_revenue" id="07revactual">'.number_format($actual_jul).'</a></td>
                        '; }else{ echo '
                            <td data-count="revenuejul">'.number_format($actual_jul).'</td>
                        '; }
                        ...
                        if($actual_aug != 0){ echo '
                            <td data-count="revenueaug" class="actual_monthly_expense_aug"><a class="actual_monthly_revenue " id="08revactual">'.number_format($actual_aug).'</a></td>
                        '; }else{ echo '
                            <td data-count="revenueaug">'.number_format($actual_aug).'</td>
                        '; }
                        ...
                        if($actual_sep != 0){ echo '
                            <td data-count="revenuesep"><a class="actual_monthly_revenue" id="09revactual">'.number_format($actual_sep).'</a></td>
                        '; }else{ echo '
                            <td data-count="revenuesep">'.number_format($actual_sep).'</td>
                        '; }
                        ...
                        if($actual_oct != 0){ echo '
                            <td data-count="revenueoct"><a class="actual_monthly_revenue" id="10revactual">'.number_format($actual_oct).'</a></td>
                        '; }else{ echo '
                            <td data-count="revenueoct">'.number_format($actual_oct).'</td>
                        '; }
                        ...
                        if($actual_nov != 0){ echo '
                            <td data-count="revenuenov"><a class="actual_monthly_revenue" id="11revactual">'.number_format($actual_nov).'</a></td>
                        '; }else{ echo '
                            <td data-count="revenuenov">'.number_format($actual_nov).'</td>
                        '; }
                        ...
                        if($actual_decem != 0){ echo '
                            <td data-count="revenuedec"><a class="actual_monthly_revenue" id="12revactual">'.number_format($actual_decem).'</a></td>
                        '; }else{ echo '
                            <td data-count="revenuedec">'.number_format($actual_decem).'</td>
                        '; }
                        ...
                        if($actual_total2 != 0){ echo '
                            <td class="total-clr" data-count="revenuemon"><a class="total_actual_monthly_revenue" ><b>'.number_format($actual_total2).'</b></a></td>
                        '; }else{ echo '
                            <td class="total-clr" data-count="revenuemon"><b>'.number_format($actual_total2).'</b></td>
                        '; }
                        echo'
                            <td>
...
public function monthlylistfinance1(Request $request)
{
    $uid = "";
    if((Auth::user()->role) == "affiliate"){
        $uid = Auth::id();
    ...
    <tr>
        ...
        if($value== 1){
            ...
            foreach($revenue as $value){
                ...
                <tr id="revenue_count_'.$temp.'" class="odd gradeX">
                    <td   class="fixed-side"><b style="color:#da291c">'.$value->account_description.'</b><input type="checkbox" class="form-gorup" checked onClick="onClickRemove(this)"></td>
                    ';
                    $actual_jan = DB::table('revenue_record')->whereMonth('transaction_date', '01')->whereYear('transaction_date', $year)->where('account_description', $value->account_description)->where('uid', $uid)->sum('amount_paid');
                    if($actual_jan!= 0){ echo '
                        <td data-count="revenuejan"><a class="actual_monthly_revenue" id="0revactual1'.$temp.'">'.number_format($actual_jan).'</a></td>
                    '; }else{ echo '
                        <td data-count="revenuejan">'.$actual_jan.'</td>
                    '; }
                    $actual_feb = DB::table('revenue_record')->whereMonth('transaction_date', '02')->whereYear('transaction_date', $year)->where('account_description', $value->account_description)->where('uid', $uid)->sum('amount_paid');
                    if($actual_feb != 0){ echo '
                        <td data-count="revenuefeb"><a class="actual_monthly_revenue" id="0revactual2'.$temp.'">'.number_format($actual_feb).'</a></td>
                    '; }else{ echo '
                        <td data-count="revenuefeb">'.$actual_feb.'</td>
                    '; }
                    $actual_mar = DB::table('revenue_record')->whereMonth('transaction_date', '03')->whereYear('transaction_date', $year)->where('account_description', $value->account_description)->where('uid', $uid)->sum('amount_paid');
                    if($actual_mar != 0){ echo '
                        <td data-count="revenuemar"><a class="actual_monthly_revenue" id="0revactual3'.$temp.'">'.number_format($actual_mar).'</a></td>
                    '; }else{ echo '
                        <td data-count="revenuemar">'.$actual_mar.'</td>
                    '; }
                    $actual_apr = DB::table('revenue_record')->whereMonth('transaction_date', '04')->whereYear('transaction_date', $year)->where('account_description', $value->account_description)->where('uid', $uid)->sum('amount_paid');
                    if($actual_apr != 0){ echo '
                        <td data-count="revenueapr"><a class="actual_monthly_revenue" id="0revactual4'.$temp.'">'.number_format($actual_apr).'</a></td>
                    '; }else{ echo '
                        <td data-count="revenueapr">'.$actual_apr.'</td>
                    '; }
                    $actual_may = DB::table('revenue_record')->whereMonth('transaction_date', '05')->whereYear('transaction_date', $year)->where('account_description', $value->account_description)->where('uid', $uid)->sum('amount_paid');
                    if($actual_may != 0){ echo '
                        <td data-count="revenuemay"><a class="actual_monthly_revenue" id="0revactual5'.$temp.'">'.number_format($actual_may).'</a></td>
                    '; }else{ echo '
                    ...
                    $actual_jun = DB::table('revenue_record')->whereMonth('transaction_date', '06')->whereYear('transaction_date', $year)->where('account_description', $value->account_description)->where('uid', $uid)->sum('amount_paid');
                    if($actual_jun != 0){ echo '
                        <td data-count="revenuejun"><a class="actual_monthly_revenue" id="0revactual6'.$temp.'">'.number_format($actual_jun).'</a></td>
                    '; }else{ echo '
                        <td data-count="revenuejun">'.$actual_jun.'</td>
                    '; }
                    $actual_jul = DB::table('revenue_record')->whereMonth('transaction_date', '07')->whereYear('transaction_date', $year)->where('account_description', $value->account_description)->where('uid', $uid)->sum('amount_paid');
                    if($actual_jul != 0){ echo '
                        <td data-count="revenuejul"><a class="actual_monthly_revenue" id="0revactual7'.$temp.'">'.number_format($actual_jul).'</a></td>
                    '; }else{ echo '
                        <td data-count="revenuejul">'.$actual_jul.'</td>
                    '; }
                    $actual_aug = DB::table('revenue_record')->whereMonth('transaction_date', '08')->whereYear('transaction_date', $year)->where('account_description', $value->account_description)->where('uid', $uid)->sum('amount_paid');
                    if($actual_aug != 0){ echo '
                        <td data-count="revenueaug" class="actual_monthly_expense_aug"><a class="actual_monthly_revenue " id="0revactual8'.$temp.'">'.number_format($actual_aug).'</a></td>
                    '; }else{ echo '
                        <td data-count="revenueaug">'.$actual_aug.'</td>
                    '; }
                    $actual_sep = DB::table('revenue_record')->whereMonth('transaction_date', '09')->whereYear('transaction_date', $year)->where('account_description', $value->account_description)->where('uid', $uid)->sum('amount_paid');
                    if($actual_sep != 0){ echo '
                        <td data-count="revenuesep"><a class="actual_monthly_revenue" id="0revactual9'.$temp.'">'.number_format($actual_sep).'</a></td>
                    '; }else{ echo '
                        <td data-count="revenuesep">'.$actual_sep.'</td>
                    '; }
                    $actual_oct = DB::table('revenue_record')->whereMonth('transaction_date', '10')->whereYear('transaction_date', $year)->where('account_description', $value->account_description)->where('uid', $uid)->sum('amount_paid');
                    if($actual_oct != 0){ echo '
                        <td data-count="revenueoct"><a class="actual_monthly_revenue" id="0revactual10'.$temp.'">'.number_format($actual_oct).'</a></td>
                    '; }else{ echo '
                        <td data-count="revenueoct">'.$actual_oct.'</td>
                    '; }
                    $actual_nov = DB::table('revenue_record')->whereMonth('transaction_date', '11')->whereYear('transaction_date', $year)->where('account_description', $value->account_description)->where('uid', $uid)->sum('amount_paid');
                    if($actual_nov != 0){ echo '
                        <td data-count="revenuenov"><a class="actual_monthly_revenue" id="0revactual11'.$temp.'">'.number_format($actual_nov).'</a></td>
                    '; }else{ echo '
                        <td data-count="revenuenov">'.$actual_nov.'</td>
                    '; }
                    $actual_decem = DB::table('revenue_record')->whereMonth('transaction_date', '12')->whereYear('transaction_date', $year)->where('account_description', $value->account_description)->where('uid', $uid)->sum('amount_paid');
                    if($actual_decem != 0){ echo '
                        <td data-count="revenuedec"><a class="actual_monthly_revenue" id="0revactual12'.$temp.'">'.number_format($actual_decem).'</a></td>
                    '; }else{ echo '
                        <td data-count="revenuedec">'.$actual_decem.'</td>
                    '; }
                    $actual_total2 = DB::table('revenue_record')->whereYear('transaction_date', $year)->where('account_description', $value->account_description)->where('uid', $uid)->sum('amount_paid');
                    if($actual_total2 != 0){ echo '
                        <td class="" data-count="revenuemon"><a class="total_actual_monthly_revenue" id="0revactual13'.$temp.'"><b>'.number_format($actual_total2).'</b></a></td>
                    '; }else{ echo '
                        <td class="" data-count="revenuemon"><b>'.$actual_total2.'</b></td>
                    '; }
                    echo'
                        <td>
                            <a href="'.url("revenue_variance_monthly_graph/$namm").'"><i class="fa fa-bar-chart"></i></a>
                ...
                <tr id="" class="odd gradeX abc d-none" style="background:#ff000012">
                    <td   class="fixed-side"><input onclick="faisal(this.value)" type="checkbox"  style="margin-left:0px !important; margin-top:0px !important" class="form-gorup apply_p" id="apply_p" value="'.$value->account_description.'">Projected</td>
                    ';
                    $actual_jan = DB::table('revenue_record')->whereMonth('transaction_date', '01')->whereYear('transaction_date', $year)->where('account_description', $value->account_description)->where('uid', $uid)->sum('amount_paid');
                    if($actual_jan!= 0){ echo '
                        <td data-count="revenuejan"><a class="actual_monthly_revenue" id="10revactual1'.$temp.'">'.$actual_jan.'</a></td>
                    '; }else{ echo '
                        <td data-count="revenuejan">'.$actual_jan.'</td>
                    '; }
                    $actual_feb = DB::table('revenue_record')->whereMonth('transaction_date', '02')->whereYear('transaction_date', $year)->where('account_description', $value->account_description)->where('uid', $uid)->sum('amount_paid');
                    if($actual_feb != 0){ echo '
                        <td data-count="revenuefeb"><a class="actual_monthly_revenue" id="10revactual2'.$temp.'">'.$actual_feb.'</a></td>
                    '; }else{ echo '
                        <td data-count="revenuefeb">'.$actual_feb.'</td>
                    '; }
                    $actual_mar = DB::table('revenue_record')->whereMonth('transaction_date', '03')->whereYear('transaction_date', $year)->where('account_description', $value->account_description)->where('uid', $uid)->sum('amount_paid');
                    if($actual_mar != 0){ echo '
                        <td data-count="revenuemar"><a class="actual_monthly_revenue" id="10revactual3'.$temp.'">'.$actual_mar.'</a></td>
                    '; }else{ echo '
                        <td data-count="revenuemar">'.$actual_mar.'</td>
                    '; }
                    $actual_apr = DB::table('revenue_record')->whereMonth('transaction_date', '04')->whereYear('transaction_date', $year)->where('account_description', $value->account_description)->where('uid', $uid)->sum('amount_paid');
                    if($actual_apr != 0){ echo '
                        <td data-count="revenueapr"><a class="actual_monthly_revenue" id="10revactual4'.$temp.'">'.$actual_apr.'</a></td>
                    '; }else{ echo '
                        <td data-count="revenueapr">'.$actual_apr.'</td>
                    '; }
                    $actual_may = DB::table('revenue_record')->whereMonth('transaction_date', '05')->whereYear('transaction_date', $year)->where('account_description', $value->account_description)->where('uid', $uid)->sum('amount_paid');
                    if($actual_may != 0){ echo '
                        <td data-count="revenuemay"><a class="actual_monthly_revenue" id="10revactual5'.$temp.'">'.$actual_may.'</a></td>
                    '; }else{ echo '
                        <td data-count="revenuemay">'.$actual_may.'</td>
                    '; }
                    ...
                    $actual_jun = DB::table('revenue_record')->whereMonth('transaction_date', '06')->whereYear('transaction_date', $year)->where('account_description', $value->account_description)->where('uid', $uid)->sum('amount_paid');
                    if($actual_jun != 0){ echo '
                        <td data-count="revenuejun"><a class="actual_monthly_revenue" id="10revactual6'.$temp.'">'.$actual_jun.'</a></td>
                    '; }else{ echo '
                        <td data-count="revenuejun">'.$actual_jun.'</td>
                    '; }
                    $actual_jul = DB::table('revenue_record')->whereMonth('transaction_date', '07')->whereYear('transaction_date', $year)->where('account_description', $value->account_description)->where('uid', $uid)->sum('amount_paid');
                    if($actual_jul != 0){ echo '
                        <td data-count="revenuejul"><a class="actual_monthly_revenue" id="10revactual7'.$temp.'">'.$actual_jul.'</a></td>
                    '; }else{ echo '
                        <td data-count="revenuejul">'.$actual_jul.'</td>
                    '; }
                    $actual_aug = DB::table('revenue_record')->whereMonth('transaction_date', '08')->whereYear('transaction_date', $year)->where('account_description', $value->account_description)->where('uid', $uid)->sum('amount_paid');
                    if($actual_aug != 0){ echo '
                        <td data-count="revenueaug" class="actual_monthly_expense_aug"><a class="actual_monthly_revenue " id="10revactual8'.$temp.'">'.$actual_aug.'</a></td>
                    '; }else{ echo '
                        <td data-count="revenueaug">'.$actual_aug.'</td>
                    '; }
                    $actual_sep = DB::table('revenue_record')->whereMonth('transaction_date', '09')->whereYear('transaction_date', $year)->where('account_description', $value->account_description)->where('uid', $uid)->sum('amount_paid');
                    if($actual_sep != 0){ echo '
                        <td data-count="revenuesep"><a class="actual_monthly_revenue" id="10revactual9'.$temp.'">'.$actual_sep.'</a></td>
                    '; }else{ echo '
                        <td data-count="revenuesep">'.$actual_sep.'</td>
                    '; }
                    $actual_oct = DB::table('revenue_record')->whereMonth('transaction_date', '10')->whereYear('transaction_date', $year)->where('account_description', $value->account_description)->where('uid', $uid)->sum('amount_paid');
                    if($actual_oct != 0){ echo '
                        <td data-count="revenueoct"><a class="actual_monthly_revenue" id="10revactual10'.$temp.'">'.$actual_oct.'</a></td>
                    '; }else{ echo '
                        <td data-count="revenueoct">'.$actual_oct.'</td>
                    '; }
                    $actual_nov = DB::table('revenue_record')->whereMonth('transaction_date', '11')->whereYear('transaction_date', $year)->where('account_description', $value->account_description)->where('uid', $uid)->sum('amount_paid');
                    if($actual_nov != 0){ echo '
                        <td data-count="revenuenov"><a class="actual_monthly_revenue" id="10revactual11'.$temp.'">'.$actual_nov.'</a></td>
                    '; }else{ echo '
                        <td data-count="revenuenov">'.$actual_nov.'</td>
                    '; }
                    $actual_decem = DB::table('revenue_record')->whereMonth('transaction_date', '12')->whereYear('transaction_date', $year)->where('account_description', $value->account_description)->where('uid', $uid)->sum('amount_paid');
                    if($actual_decem != 0){ echo '
                        <td data-count="revenuedec"><a class="actual_monthly_revenue" id="10revactual12'.$temp.'">'.$actual_decem.'</a></td>
                    '; }else{ echo '
                        <td data-count="revenuedec">'.$actual_decem.'</td>
                    '; }
                    $actual_total2 = DB::table('revenue_record')->whereYear('transaction_date', $year)->where('account_description', $value->account_description)->where('uid', $uid)->sum('amount_paid');
                    if($actual_total2 != 0){ echo '
                        <td class="" data-count="revenuemon"><a class="total_actual_monthly_revenue" id="10revactual13'.$temp.'"><b>'.$actual_total2.'</b></a></td>
                    '; }else{ echo '
                        <td class="" data-count="revenuemon"><b>'.$actual_total2.'</b></td>
                    '; }
                    echo'
                ...
                <tr id="" class="odd gradeX abc d-none" style="background:#00c2bc63">
                    <td   class="fixed-side">Difference</td>
                    ';
                    $actual_jan = DB::table('revenue_record')->whereMonth('transaction_date', '01')->whereYear('transaction_date', $year)->where('account_description', $value->account_description)->where('uid', $uid)->sum('amount_paid');
                    if($actual_jan!= 0){ echo '
                        <td data-count="revenuejan"><a class="actual_monthly_revenue" id="revactual1'.$temp.'">0</a></td>
                    '; }else{ echo '
                        <td data-count="revenuejan">'.$actual_jan.'</td>
                    '; }
                    $actual_feb = DB::table('revenue_record')->whereMonth('transaction_date', '02')->whereYear('transaction_date', $year)->where('account_description', $value->account_description)->where('uid', $uid)->sum('amount_paid');
                    if($actual_feb != 0){ echo '
                        <td data-count="revenuefeb"><a class="actual_monthly_revenue" id="revactual2'.$temp.'">0</a></td>
                    '; }else{ echo '
                        <td data-count="revenuefeb">'.$actual_feb.'</td>
                    '; }
                    $actual_mar = DB::table('revenue_record')->whereMonth('transaction_date', '03')->whereYear('transaction_date', $year)->where('account_description', $value->account_description)->where('uid', $uid)->sum('amount_paid');
                    if($actual_mar != 0){ echo '
                        <td data-count="revenuemar"><a class="actual_monthly_revenue" id="revactual3'.$temp.'">0</a></td>
                    '; }else{ echo '
                        <td data-count="revenuemar">'.$actual_mar.'</td>
                    '; }
                    $actual_apr = DB::table('revenue_record')->whereMonth('transaction_date', '04')->whereYear('transaction_date', $year)->where('account_description', $value->account_description)->where('uid', $uid)->sum('amount_paid');
                    if($actual_apr != 0){ echo '
                        <td data-count="revenueapr"><a class="actual_monthly_revenue" id="revactual4'.$temp.'">0</a></td>
                    '; }else{ echo '
                        <td data-count="revenueapr">'.$actual_apr.'</td>
                    '; }
                    $actual_may = DB::table('revenue_record')->whereMonth('transaction_date', '05')->whereYear('transaction_date', $year)->where('account_description', $value->account_description)->where('uid', $uid)->sum('amount_paid');
                    if($actual_may != 0){ echo '
                        <td data-count="revenuemay"><a class="actual_monthly_revenue" id="revactual5'.$temp.'">0</a></td>
                    '; }else{ echo '
                        <td data-count="revenuemay">'.$actual_may.'</td>
                    '; }
                    ...
                    $actual_jun = DB::table('revenue_record')->whereMonth('transaction_date', '06')->whereYear('transaction_date', $year)->where('account_description', $value->account_description)->where('uid', $uid)->sum('amount_paid');
                    if($actual_jun != 0){ echo '
                        <td data-count="revenuejun"><a class="actual_monthly_revenue" id="revactual6'.$temp.'">0</a></td>
                    '; }else{ echo '
                        <td data-count="revenuejun">'.$actual_jun.'</td>
                    '; }
                    $actual_jul = DB::table('revenue_record')->whereMonth('transaction_date', '07')->whereYear('transaction_date', $year)->where('account_description', $value->account_description)->where('uid', $uid)->sum('amount_paid');
                    if($actual_jul != 0){ echo '
                        <td data-count="revenuejul"><a class="actual_monthly_revenue" id="revactual7'.$temp.'">0</a></td>
                    '; }else{ echo '
                        <td data-count="revenuejul">'.$actual_jul.'</td>
                    '; }
                    $actual_aug = DB::table('revenue_record')->whereMonth('transaction_date', '08')->whereYear('transaction_date', $year)->where('account_description', $value->account_description)->where('uid', $uid)->sum('amount_paid');
                    if($actual_aug != 0){ echo '
                        <td data-count="revenueaug" class="actual_monthly_expense_aug"><a class="actual_monthly_revenue " id="revactual8'.$temp.'">0</a></td>
                    '; }else{ echo '
                        <td data-count="revenueaug">'.$actual_aug.'</td>
                    '; }
                    $actual_sep = DB::table('revenue_record')->whereMonth('transaction_date', '09')->whereYear('transaction_date', $year)->where('account_description', $value->account_description)->where('uid', $uid)->sum('amount_paid');
                    if($actual_sep != 0){ echo '
                        <td data-count="revenuesep"><a class="actual_monthly_revenue" id="revactual9'.$temp.'">0</a></td>
                    '; }else{ echo '
                        <td data-count="revenuesep">'.$actual_sep.'</td>
                    '; }
                    $actual_oct = DB::table('revenue_record')->whereMonth('transaction_date', '10')->whereYear('transaction_date', $year)->where('account_description', $value->account_description)->where('uid', $uid)->sum('amount_paid');
                    if($actual_oct != 0){ echo '
                        <td data-count="revenueoct"><a class="actual_monthly_revenue" id="revactual10'.$temp.'">0</a></td>
                    '; }else{ echo '
                        <td data-count="revenueoct">'.$actual_oct.'</td>
                    '; }
                    $actual_nov = DB::table('revenue_record')->whereMonth('transaction_date', '11')->whereYear('transaction_date', $year)->where('account_description', $value->account_description)->where('uid', $uid)->sum('amount_paid');
                    if($actual_nov != 0){ echo '
                        <td data-count="revenuenov"><a class="actual_monthly_revenue" id="revactual11'.$temp.'">0</a></td>
                    '; }else{ echo '
                        <td data-count="revenuenov">'.$actual_nov.'</td>
                    '; }
                    $actual_decem = DB::table('revenue_record')->whereMonth('transaction_date', '12')->whereYear('transaction_date', $year)->where('account_description', $value->account_description)->where('uid', $uid)->sum('amount_paid');
                    if($actual_decem != 0){ echo '
                        <td data-count="revenuedec"><a class="actual_monthly_revenue" id="revactual12'.$temp.'">0</a></td>
                    '; }else{ echo '
                        <td data-count="revenuedec">'.$actual_decem.'</td>
                    '; }
                    $actual_total2 = DB::table('revenue_record')->whereYear('transaction_date', $year)->where('account_description', $value->account_description)->where('uid', $uid)->sum('amount_paid');
                    if($actual_total2 != 0){ echo '
                        <td class="" data-count="revenuemon"><a class="total_actual_monthly_revenue" id="revactual13'.$temp.'"><b>0</b></a></td>
                    '; }else{ echo '
                        <td class="" data-count="revenuemon"><b>'.$actual_total2.'</b></td>
                    '; }
                    echo'
        ...
        <tr class="odd gradeX chang" id="grevenue">
            ...
            echo '
            <tbody class="d-none"  id="client_blnc">
                <tr id="" class="total-tr">
                    <td class="fixed-side" style=""><b>Clients with Balance</b></td>
                    <td ><a style="font-weight:600" id="123-jan1" class="revenue_by_month revenue_by_jan tot_1231"></a></td>
                    <td ><a style="font-weight:600" id="123-feb2" class="revenue_by_month revenue_by_feb tot_1232"></a></td>
                    <td ><a style="font-weight:600" id="123-mar3" class="revenue_by_month revenue_by_mar tot_1233"></a></td>
                    <td ><a style="font-weight:600" id="123-apr4" class="revenue_by_month revenue_by_apr tot_1234"></a></td>
                    <td ><a style="font-weight:600" id="123-may5" class="revenue_by_month revenue_by_may tot_1235"></a></td>
                    <td ><a style="font-weight:600" id="123-jun6" class="revenue_by_month revenue_by_jun tot_1236"></a></td>
                    <td ><a style="font-weight:600" id="123-jul7" class="revenue_by_month revenue_by_jul tot_1237"></a></td>
                    <td ><a style="font-weight:600" id="123-aug8" class="revenue_by_month revenue_by_aug tot_1238"></a></td>
                    <td ><a style="font-weight:600" id="123-sep9" class="revenue_by_month revenue_by_sep tot_1239"></a></td>
                    <td ><a style="font-weight:600" id="123-oct10" class="revenue_by_month revenue_by_oct tot_12310"></a></td>
                    <td ><a style="font-weight:600" id="123-nov11" class="revenue_by_month revenue_by_nov tot_12311"></a></td>
                    <td ><a style="font-weight:600" id="123-dec12" class="revenue_by_month revenue_by_dec tot_12312"></a></td>
                    <td class="total-clr"><a style="font-weight:600" id="123-total13" class="total_yearly_revenue tot_12313" ></a></td>
                    <td>
                        <a href="'.url("all_revenue_chart").'"><i class="fa fa-bar-chart"></i></a>
                    </td>
                </tr>
            ...
            <tbody  id="first_row">
                ...
                <tr id="total_r1" class="total-tr">
                    <td class="fixed-side" style=""><b>Total Revenue </b></td>
                    <td ><a style="font-weight:600" id="jan1" class="revenue_by_month revenue_by_jan tot_1"></a></td>
                    <td ><a style="font-weight:600" id="feb2" class="revenue_by_month revenue_by_feb tot_2"></a></td>
                    <td ><a style="font-weight:600" id="mar3" class="revenue_by_month revenue_by_mar tot_3"></a></td>
                    <td ><a style="font-weight:600" id="apr4" class="revenue_by_month revenue_by_apr tot_4"></a></td>
                    <td ><a style="font-weight:600" id="may5" class="revenue_by_month revenue_by_may tot_5"></a></td>
                    <td ><a style="font-weight:600" id="jun6" class="revenue_by_month revenue_by_jun tot_6"></a></td>
                    <td ><a style="font-weight:600" id="jul7" class="revenue_by_month revenue_by_jul tot_7"></a></td>
                    <td ><a style="font-weight:600" id="aug8" class="revenue_by_month revenue_by_aug tot_8"></a></td>
                    <td ><a style="font-weight:600" id="sep9" class="revenue_by_month revenue_by_sep tot_9"></a></td>
                    <td ><a style="font-weight:600" id="oct10" class="revenue_by_month revenue_by_oct tot_10"></a></td>
                    <td ><a style="font-weight:600" id="nov11" class="revenue_by_month revenue_by_nov tot_11"></a></td>
                    <td ><a style="font-weight:600" id="dec12" class="revenue_by_month revenue_by_dec tot_12"></a></td>
                    <td class="total-clr"><a style="font-weight:600" id="total13" class="total_yearly_revenue tot_13" ></a></td>
                    <td>
                        <a href="'.url("all_revenue_chart").'"><i class="fa fa-bar-chart"></i></a>
                    </td>
                </tr>

                <tr id="" class="total-tr total_pr_d d-none">
                    <td class="fixed-side" style=""><b>Total Projected </b></td>
                    <td ><a style="font-weight:600" id="tot_pro_1" class="revenue_by_month revenue_by_jan">0</a></td>
                    <td ><a style="font-weight:600" id="tot_pro_2" class="revenue_by_month revenue_by_feb">0</a></td>
                    <td ><a style="font-weight:600" id="tot_pro_3" class="revenue_by_month revenue_by_mar">0</a></td>
                    <td ><a style="font-weight:600" id="tot_pro_4" class="revenue_by_month revenue_by_apr">0</a></td>
                    <td ><a style="font-weight:600" id="tot_pro_5" class="revenue_by_month revenue_by_may">0</a></td>
                    <td ><a style="font-weight:600" id="tot_pro_6" class="revenue_by_month revenue_by_jun">0</a></td>
                    <td ><a style="font-weight:600" id="tot_pro_7" class="revenue_by_month revenue_by_jul">0</a></td>
                    <td ><a style="font-weight:600" id="tot_pro_8" class="revenue_by_month revenue_by_aug">0</a></td>
                    <td ><a style="font-weight:600" id="tot_pro_9" class="revenue_by_month revenue_by_sep">0</a></td>
                    <td ><a style="font-weight:600" id="tot_pro_10" class="revenue_by_month revenue_by_oct">0</a></td>
                    <td ><a style="font-weight:600" id="tot_pro_11" class="revenue_by_month revenue_by_nov">0</a></td>
                    <td ><a style="font-weight:600" id="tot_pro_12" class="revenue_by_month revenue_by_dec">0</a></td>
                    <td class="total-clr"><a style="font-weight:600" id="tot_pro_13" class="total_yearly_revenue" >0</a></td>
                    <td>
                        <a href="'.url("all_revenue_chart").'"><i class="fa fa-bar-chart"></i></a>
                    </td>
                </tr>
                ...
                <tr id="" class="total-tr total_pr_d d-none">
                    <td class="fixed-side" style=""><b>Total (Difference) </b></td>
                    <td ><a style="font-weight:600" id="" class="revenue_by_month revenue_by_jan tot_dif_1">0</a></td>
                    <td ><a style="font-weight:600" id="" class="revenue_by_month revenue_by_feb tot_dif_2">0</a></td>
                    <td ><a style="font-weight:600" id="" class="revenue_by_month revenue_by_mar tot_dif_3">0</a></td>
                    <td ><a style="font-weight:600" id="" class="revenue_by_month revenue_by_apr tot_dif_4">0</a></td>
                    <td ><a style="font-weight:600" id="" class="revenue_by_month revenue_by_may tot_dif_5">0</a></td>
                    <td ><a style="font-weight:600" id="" class="revenue_by_month revenue_by_jun tot_dif_6">0</a></td>
                    <td ><a style="font-weight:600" id="" class="revenue_by_month revenue_by_jul tot_dif_7">0</a></td>
                    <td ><a style="font-weight:600" id="" class="revenue_by_month revenue_by_aug tot_dif_8">0</a></td>
                    <td ><a style="font-weight:600" id="" class="revenue_by_month revenue_by_sep tot_dif_9">0</a></td>
                    <td ><a style="font-weight:600" id="" class="revenue_by_month revenue_by_oct tot_dif_10">0</a></td>
                    <td ><a style="font-weight:600" id="" class="revenue_by_month revenue_by_nov tot_dif_11">0</a></td>
                    <td ><a style="font-weight:600" id="" class="revenue_by_month revenue_by_dec tot_dif_12">0</a></td>
                    <td class="total-clr"><a style="font-weight:600" id="" class="total_yearly_revenue tot_dif_13" >0</a></td>
                    <td>
                        <a href="'.url("all_revenue_chart").'"><i class="fa fa-bar-chart"></i></a>
                    </td>
                </tr>
    ...
    <tfoot>
        ...
        <tr class="" id="tot_est">
            ...
            <td>
                <a href="'.url("est_chart").'"><i class="fa fa-bar-chart"></i></a>
            </td>
...
public static function account_revenue_exits($account)
    ...
    public static function account_price($account)
    {
        ...
        $exist1 = DB::table('revenue_account')->where('uid', $uid)->where('account_name', $account)->first();
        $exist = DB::table('revenue_account')->where('account_name', $account)->first();
        $val = '';
        if(!empty($exist1)){
            $val=$exist1->amount;
        }else if(!empty($exist)){
    ...
    public static function account_price2($account)
    {
        ...
        $exist1 = DB::table('expenses_account')->where('uid', $uid)->where('account_name', $account)->first();
        $exist = DB::table('expenses_account')->where('account_name', $account)->first();
        $val = '';
        if(!empty($exist1)){
            $val=$exist1->amount;
        }else if(!empty($exist)){
       ...
       //print_r($amount_arr);die;
        ...
        foreach ($array as $value) {
            ...
            if($exist == ""){
                ...
                $inst1 = DB::table('expenses_account')->insert($values);
                if($inst1){
                    $values123 = array(
                     'uid'  => $uid,
                    'name'  => $expenses_account->account_name,
                    'jan'        => 0,
                    'feb'        => 0,
                    'mar'          =>0,
                    'apr'           => 0,
                ...
                $ins1 = DB::table('expense_budget')->insert($values123);
            }
 ...
 public function balancesheet_new_account_submit(Request $request)
    ...
    public function revenue_new_account_submit(Request $request)
    {
        ...
        if((Auth::user()->role) == "affiliate"){
            ...
            $temp_uid = Auth::user()->affiliate_user_id;
        }
    ...
    public function expense_new_account_submit(Request $request)
   {
    ...
    public function free_affiliate_entry(Request $request)
    {
        ...
        if(empty($request->plan_id)) {
         ...
         elseif(empty($request->birth_state)) {
          return redirect()->back()->with('status',"Please select any state first");
                exit;
        }
         ...
         elseif(empty($request->country)) {
          return redirect()->back()->with('status',"Please select any country of residence first");
                exit;
         }
        ...
        elseif($u1>0) {
          return redirect()->back()->with('status',"Email already exists.");
            ...
            if($request->birth_country == "HT"){
                if(empty($request->birth_commune)){
                    return redirect()->back()->with('status',"Please select any commune first.");
                    exit;
                }
            }
    ...
    $user = $data['user'] = DB::table('temp_affiliate_registrations')->where('id',$user_id)->first();
     $data['fees'] = Setting::general_setting()->registration_fee;
      $data['status'] = DB::table('affiliatebtn')->where('id', 1)->get();
        ...
        $data['business_category_title'] = BusinessCategory::find($data['user']->business_category)->category;
        ...
        //  dd($data['birth_commune'], $data['commune']);
 ...
 public function get_revenue_by_month_page(Request $request)
    {
        ...
        if ($email != null || $email != "") {
            ...
            $revenue_records = DB::table('revenue_record')->where('uid', $uid)->whereMonth('transaction_date',$month)->whereYear('transaction_date',date('Y'))->get();
        }
