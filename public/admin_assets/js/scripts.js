...
!(function (r, u) {
    ...
    (r.ClassBody = function () {
        ...
        (r.Toast = function (t, e, n) {
            var i,
                a,
                o = "info" === (e = e || "info") ? "ni ni-info-fill" : "success" === e ? "ni ni-check-circle-fill" : "error" === e ? "ni ni-cross-circle-fill" : "warning" === e ? "ni ni-alert-fill" : "",
                s = { position: "bottom-right", ui: "", icon: "auto", clear: !1 },
                r = n ? h(s, n) : s;
            (r.position = r.position ? "toast-" + r.position : "toast-bottom-right"),
                (r.icon = "auto" === r.icon ? o : r.icon ? r.icon : ""),
                (r.ui = r.ui ? " " + r.ui : ""),
                (i = "" !== r.icon ? '<span class="toastr-icon"><em class="icon ' + r.icon + '"></em></span>' : ""),
                "" !== (t = "" !== t ? i + '<div class="toastr-text">' + t + "</div>" : "") &&
                    (!0 === r.clear && toastr.clear(),
                    (a = {
                        closeButton: !0,
                        debug: !1,
                        newestOnTop: !1,
        ...
        (r.TGL.showmenu = function (t, e) {
            var n = u(t || ".nk-nav-toggle"),
                ...
                o = { active: "toggle-active", content: g + "-active", body: "nav-shown", overlay: "nk-sidebar-overlay", break: a, close: { profile: !0, menu: !1 } },
                s = e ? h(o, e) : o;
            n.on("click", function (t) {
        ...
        (r.DataTable.init = function () {
            r.DataTable(".datatable-init", { responsive: { details: !0 },"order":[]  }), (u.fn.DataTable.ext.pager.numbers_length = 7);
        }),
