					...
					@csrf
                        <div class="" style="padding-bottom: 20px;">
                            ...
                            <div style="display: flex; align-items: center; justify-content: center; margin-top: 10px; margin-bottom: 20px;">
                             ...
                             <div style="background-color: white; box-shadow: 0px 60px 100px -10px rgba(35, 47, 70, 0.06); border-radius: 10px; padding: 10px; padding-left: 30px; padding-right: 30px; display: flex; flex-direction: column; align-items: center; justify-content: center;">
                                 ...
                                 <div class="" style="display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 10px;">
								   ...
								   <div class="row gy-4" style="padding-bottom: 10px; margin-top: 10px;">
		  ...
		  $icon='';
		   ...
		   ?>
            <div class="col-md-{{ $grid }} col-md-offset-{{ $offset }}">
                ...
                <div class="pricingTable {{ $class }}" style="width: 30rem; height: 35rem; margin-top: 10px;">
                    <div class="pricingTable-header">
                        <i class="fa {{ $icon }}"></i>
                        <div class="price-value" style="font-size: 25px;"> ${{ $plan->monthly_fee }} <span class="month">per month</span> </div>
                    </div>
                    <br>
