        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12">
                ...
                <div class="col-md-12">
                    ...
                    <hr />
                    <form action="{{ url('member_appointment_step4_details') }}" method="POST" enctype="multipart/form-data">   
                        @csrf
...
$data=array();
$i=1;
// foreach ($appointment_settings_day as $value) {
//     $data[$i++]=$value;
// }

// print_r($data[<?php echo "dayy"]);
                            ...
                            <div class="col-12 mb-20" style="padding-left:20px;padding-right:20px;padding-bottom:10px;padding-top:20px;">
                                <div class="row margin-bottom-20">
                                    <div class="col-md-12" style="border: 2px solid #ddd; border-radius: 4px;">
                                        ...
                                        <ul class="timingul time-table" style="padding: 0; list-style-type: none; width: 100%;"></ul>
                                    </div>
                                </div>
        ...
        for (let j = 0; j < 7; j++) {
            if (i === 0 && j < firstDay) {  
               ...
               break;
                ...
                // let main_day = "";
                var url = "<?php echo url('/'); ?>/member_appointmentstepdet";
                $.ajax({
                      url: url,
                      data: 'date=' + currentdate + '&currentmonth=' + currentmonth + '&currentyear=' + currentyear + '&_token={{ csrf_token() }}',
                      type: "POST",
    ...
    $(function(){
        ...
        $(document).on('click', '.showEvent', function(){
            if($(this).hasClass("prev_day")){
                ...
                var url = "<?php echo url('/'); ?>/member_appointment_date_availabilityy";
                $.ajax({
                      url: url,
                      beforeSend: function(){
                        $("#loading").show();
