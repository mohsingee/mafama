                            ...
                            <table class="table table-striped table-bordered table-hover" id="datatable_sample">
                                ...
                                <tbody>
                                    ...
                                    foreach ($appointments as $value) {
                                        ...
                                        $today = date('Y-m-d');
                                        $nowtime = date('H:i');
                                        if(($value->appointment_date > $today)){
                                    ?>
                                    <?php 
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    ?>
                                                        <a href="{{ url('member_change_appointment_step') }}/<?= $value->aid ?>" class="btn btn-xs btn-success">Change</a>
                                                        <a href="{{ url('member_change_appointment_view') }}/<?= $value->aid ?>" class="btn btn-xs btn-danger">View</a>
                                                    <?php }else{ ?>
                                            ...
                                            ?>
                                    <?php
                                    }elseif(($value->appointment_date == $today) && ($value->appointment_time >= $nowtime)){
                                    ?>
                                    <?php 
                                            if($change_details->change_unit == "day"){
                                            ?>
