                    ...
                    <div class="row text-center">
                     ...
                     <div class="row bg-white" style="border: 1px solid #da291c !important; ">
                         ...
                         <div class="col-md-2 bg-white text-center">
                             ...
                             @if(!empty($middle))
                             <div class="margin-top-20 text-left f_blue margin-bottom-10">{!! $middle->description !!}</div>
                             @endif
                                     ...
                                     <tbody>
                                         ...
                                         <tr>
                                             ...
                                             <td>
                                                  ...
                                                  @if( isset($value->birth_state) )
                                                   <span class="bfh-states " style="color: #666"  data-country="{{ $value->birth_country }}" data-state="{{ $value->birth_state }}"></span>
                                                   @elseif( isset($value->birth_commune) )
                                                   {{ showcommuneName($value->birth_commune) }}
                                                   @endif
                                               </td>
