                ...
                <div class="tab-content margin-top-10" style="border: 1px solid #da291c !important; border-radius: 10px; padding: 10px;">
                    ...
                    <input type="checkbox" class="group-checkable" data-set="#datatable_sample checkboxes" />
                                    ...
                                    // dd($client);
                                        ...
                                        <tr class="" style="background: #afedff">
                                            <td><input type="checkbox" class="checkboxes" value="1000000" /></td>
                                            <td class="fixed-side" style="color: #666!important;">Total</td>
                                            <td class="fixed-side">{{$temp}}</td>
                                            <td class="fixed-side">{{$temp2}}</td>
                                            <td class="fixed-side">{{$temp3}}</td>
                                            <td class="fixed-side">{{$temp4}}</td>
                                            <td class="fixed-side">{{$temp5}}</td>
                                            <td class="fixed-side">{{$temp6}}</td>
                                        </tr>
