            ...
            <div class="col-md-12 col-sm-12">
                    ...
                    <div class="col-md-12">
                        <div class="comparisontabs">
                            <div class="tab-content margin-top-10" style="border: 1px solid #da291c !important; border-radius: 10px; padding: 10px;">
                                <div class="row">
                                    <div class="col-md-6">
                                        <label>Choose a base year</label>
                                    ...
                                    <div class="col-md-6">
                                        <label>Choose a base month</label>
                                        <select class="form-control">
                                            <option>Jan</option>
                                            <option>Feb</option>
                                            <option>Mar</option>
                ...
                <!-- <div class="col-md-12">
                    <ul class="nav nav-tabs nav-button-tabs nav-justified">
                        <li class="active"><a href="#tab1" data-toggle="tab">Revenue Comparison</a></li>
                        <li><a href="#tab2" data-toggle="tab">Expenses Comparison</a></li>
                        <li><a href="#tab3" data-toggle="tab">Assets Comparison</a></li>
                    </ul>

                    <div class="tab-content margin-top-10" style="border: 1px solid #da291c !important; border-radius: 10px; padding: 10px;">
                            <div class="tab-pane fade in active" id="tab1">
                                <div class="col-md-12" style="border-radius: 10px; padding: 20px;">
                                    <div class="col-md-4 col-md-offset-4 margin-bottom-20" style="display: none">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        $(".addcomprsntab").on("click", function(){
            var html = '<div class="tab-content margin-top-10" style="border: 1px solid #da291c !important; border-radius: 10px; padding: 10px;"> <div class="row"> <div class="col-md-6"> <label>Choose a year to compare</label> <select class="form-control"> <option>2021</option> <option>2020</option> <option>2019</option> <option>2018</option> </select> </div><div class="col-md-6"> <label>Choose a month to compare</label> <select class="form-control"> <option>Jan</option> <option>Feb</option> <option>Mar</option> <option>Apr</option> <option>May</option> <option>Jun</option> <option>Jul</option> <option>Aug</option> <option>Sep</option> <option>Oct</option> <option>Nov</option> <option>Dec</option> </select> </div></div><div class="clearfix"></div></div>';
