                        ...
                        <div class="col-md-6 col-md-offset-3 margin-bottom-20">
                            <div class="col-md-12 shadow-boxx">
                                ...
                                <div class="col-md-12 text-center padding-0">
                                    <a href="{{ url('user_final_appointment') }}" class="btn btn-xs btn-info" style="margin-right: 10px; width: 150px;">Confirm Appointment</a>
                                    <a href="{{ url('user_appointment_step1') }}" class="btn btn-xs btn-info" style="margin-right: 10px; width: 140px;">Change</a>
