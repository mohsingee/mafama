                            ...
                            ?>
                                <tr>
                                    ...
                                    <td width="20%">
                                        ...
                                        <a href="javascript:void(0)" class="btn btn-xs btn-success view-survey-result" data-id="{{$value->id}}" >View Result</a><br>
