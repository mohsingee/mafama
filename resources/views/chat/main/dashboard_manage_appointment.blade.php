                        ...
                        <table class="table table-striped table-bordered table-hover" id="datatable_sample">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    ?>
                                    <td>
                                        <a class="btn btn-xs btn-info" data-toggle="modal" data-target="#modalAppointment<?= $value->aid ?>">Canceled</a>
                                        <div id="modalAppointment<?= $value->aid ?>" class="modal fade" role="dialog">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="col-md-12 shadow-boxx">
                                                            <div class="col-md-12 margin-bottom-20" style="background-color: #da291c; padding: 0px; border-radius: 10px;">
                                                                ...
                                                                <table class="profile-info margin-bottom-10" style="width: 100%">
                                                                    <tbody>
                                                                        <tr>
                                                                            ...
                                                                            <td style="width: 70%"><b><?= date('d F Y', strtotime($value->appointment_date)) ?>, <?= Carbon::parse($value->appointment_date)->format('l') ?></b></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td style="width: 30%"><b>Time : </b></td>
                                                                            <td style="width: 70%"><b><?= date('h:i A', strtotime($value->appointment_time)) ?></b></td>
                                                                        </tr>
                                                                        <tr>
                                                                        ...
                                                                        <tr>
                                                                            <td><b>Company: </b></td>
                                                                            <td>&nbsp;<?= $value->affiliate_company ?></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td style="vertical-align: baseline;"><b>Address: </b></td>
                                                                            <td>&nbsp;<?= $value->affiliate_address ?>,<br> State- <?= $value->affiliate_state ?>, Country- <?= $value->affiliate_country ?>, <?= $value->affiliate_city ?>-<?= $value->affiliate_zip ?></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td><b>Phone: </b></td>
                                                                            <td>&nbsp;<?= $value->affiliate_phone ?></td>
                                                                        </tr>
                                                                        <tr>
                                    ...
                                    ?>
                                    <td>
                                        <a class="btn btn-xs btn-info" data-toggle="modal" data-target="#modalAppointmentt<?= $value->aid ?>">Active</a>
                                        <div id="modalAppointmentt<?= $value->aid ?>" class="modal fade" role="dialog">
                                            <div class="modal-dialog">
                                                <!-- Modal content-->
                                                <div class="modal-content">
