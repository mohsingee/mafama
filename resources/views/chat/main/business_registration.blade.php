		  ...
		  $icon='';
		   ...
		   ?>
            <div class="col-md-{{ $grid }} col-md-offset-{{ $offset }} ">
                ...
                <div class="pricingTable {{ $class }} selectedplan" data-id="{{ $plan->id }}" data-fees="{{ $plan->monthly_fee }}" style="width: 380px">
									...
									<div class="row" style="display: flex; align-items: center; flex-wrap: wrap;" >
										...
										<div class="col-md-4 birth_state" style="display:none">
											<div class="form-group">
												...
												<select class="form-control bfh-states birth-state-focus" data-country="birth_countries_states1" name="birth_state" required></select>
										...
										<div class="col-md-4">
											<div class="form-group">
												...
												<input class="form-control"  placeholder="" name="cellphone" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" type = "tel" maxlength = "10" value="{{old('cellphone')}}" required>
											</div>
										</div>
										<div class="col-md-4">
											<div class="form-group">
												<label class="form-label" for="">Business Telephone</label>
												<input type="tel" class="form-control"  placeholder="" name="business_telephone" value="{{old('business_telephone')}}" required>
											</div>
										</div>
										...
										<div class="col-md-4 select_state" style="display:none">
											<div class="form-group">
												<label class="form-label" for="">State/Province</label>
												<select class="form-control bfh-states state-focus" data-country="countries_states1" name="state" required></select>
										...
										<div class="col-md-4 zip_code" style="display:none">
											<div class="form-group">
										...
										<div class="col-md-4" id="otherbusiness" style="display:none">
											<div class="form-group"> 
												<label class="form-label" for="">Other Profession/Study</label>
                                       	...
                                       	<div class="col-md-4">
											<div class="form-group">
												<label class="form-label" for=""> Profession/Study (Type)</label>
