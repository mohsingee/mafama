                ...
                <div class="col-md-12 margin-top-40 padding-0">
                    ...
                    <div class="tab-content margin-top-10" style="border: 1px solid #da291c !important; border-radius: 10px; padding: 20px;">
                        <div class="tab-pane fade in active" id="tab4">
                            <ul class="nav nav-tabs nav-button-tabs nav-justified">
                                <li><a href="{{ url('tab4') }}">Monthly</a></li>
                                <li class="active"><a href="{{ url('tab42') }}">Quarterly</a></li>
                            </ul>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                            <tr class="odd gradeX">
                                                                ...
                                                                <td>
                                                                    <a href="{{ url('revenue_variance_quarterly_graph') }}/<?= $value->name ?>"><i class="fa fa-bar-chart"></i></a>
                                                                </td>
                                                            </tr>
                                                        <?php } ?>
                                                        <tr class="total-tr">
                                                            ...
                                                            <td><?= ($tott - $tott2) ?></td>
                                                            <td>
                                                                <a href="{{ url('revenue_quarterly_vary_chart') }}"><i class="fa fa-bar-chart"></i></a>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
...
<script>
   $(document).on("click","#quaterly_yearly",function(){
       ...
       $.ajax({
         url: "<?php echo url('/'); ?>/tab4_quaterly_year",
         data: 'year=' + year,
         type: "GET",
