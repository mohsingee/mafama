		...
		<div class="nk-content-inner">
			<div class="nk-content-body">
				<div class="nk-block-head-content" style="margin-bottom:20px;">
					<h3 class="nk-block-title page-title">Setting Tutorials</h3>
					...
					<div class="card card-bordered card-stretch">
                        <div class="card-aside-wrap">
							<div class="card-inner card-inner-lg">
								@if(permission_access('settings_tut_add')==1)
								<form id="" action="{{ url('setting_tutorials_entry') }}" method="POST" enctype="multipart/form-data">	
									@csrf
									<div class="row gy-4">
										<div class="col-md-6">
									...
									<tbody>
										...
										<tr class="nk-tb-item">
											...
											<td class="nk-tb-col tb-col-md">
												...
												<a href="<?php echo url('editsetting_tutorial') ?>/<?= $video->id ?>" class="btn btn-sm btn-primary">Edit</a>
												@endif
												@if(permission_access('settings_tut_delete')==1)
												<a href="<?php echo url('deletesetting_tutorial') ?>/<?= $video->id ?>" class="btn btn-sm btn-danger">Delete</a>
												@endif
											</td>
										</tr>
										<?php 
