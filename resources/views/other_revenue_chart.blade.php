        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12">
                <div class="heading-title heading-dotted col-md-12 margin-bottom-20 text-center">
                    <h4>Financial Management & Analysis / Budget</h4>
                </div>
                ...
                <div class="col-md-12 margin-top-10 padding-0">
                    ...
                    <div style="padding: 30px 0px;">
                        ...
                        @php
                            $mon = array($janotherrevenue,$febotherrevenue,$marotherrevenue,$aprotherrevenue,$mayotherrevenue,$junotherrevenue,$julotherrevenue,$augotherrevenue,$sepotherrevenue,$octotherrevenue, $novotherrevenue, $decotherrevenue);
                        ...
                        <!-- <script type="text/javascript">
                              $(function () {
                                    ...
                                    var bar = new Morris.Bar({
                                      ...
                                      resize: true,
                                      data: [
                                        {y: 'Jan', a: <?= $janothrevenue ?>, b: <?= $janotherrevenue ?>},
                                        {y: 'Feb', a: <?= $febothrevenue ?>, b: <?= $febotherrevenue ?>},
                                        {y: 'Mar', a: <?= $marothrevenue ?>, b: <?= $marotherrevenue ?>},
                                        {y: 'Apr', a: <?= $aprothrevenue ?>, b: <?= $aprotherrevenue ?>},
                                        {y: 'May', a: <?= $mayothrevenue ?>, b: <?= $mayotherrevenue ?>},
                                        {y: 'Jun', a: <?= $junothrevenue ?>, b: <?= $junotherrevenue ?>},
                                        {y: 'Jul', a: <?= $julothrevenue ?>, b: <?= $julotherrevenue ?>},
                                        {y: 'Aug', a: <?= $augothrevenue ?>, b: <?= $augotherrevenue ?>},
                                        {y: 'Sep', a: <?= $sepothrevenue ?>, b: <?= $sepotherrevenue ?>},
                                        {y: 'Oct', a: <?= $octothrevenue ?>, b: <?= $octotherrevenue ?>},
                                        {y: 'Nov', a: <?= $novothrevenue ?>, b: <?= $novotherrevenue ?>},
                                        {y: 'Dec', a: <?= $decothrevenue ?>, b: <?= $decotherrevenue ?>}
                                      ],
