        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12">
                ...
                <ul class="nav nav-tabs nav-button-tabs nav-justified  margin-top-10">
                    <li class="active"><a href="{{ url('comparison-tab3') }}">Monthly</a></li>
...
<script type="text/javascript">
    ...
    $(document).on("change", ".year_check4", function(){
        ...
        if($(this).prop('checked') == true){
            ...
            var year = $(this).attr("id");
            $("#months4").html('<div class="col-md-12" style="margin-bottom: 20px"><div class="row"><div class="col-md-2"><b>Choose a base month</b></div><div class="col-md-10"><table style="width: 100%"><tr><td><input type="checkbox" name="month" value="01" style="float: left;"><b></b>Jan</td><td><input type="checkbox" name="month" value="02" style="float: left;"><b></b>Feb</td><td><input type="checkbox" name="month" value="03" style="float: left;"><b></b>Mar</td><td><input type="checkbox" name="month" value="04" style="float: left;"><b></b>Apr</td><td><input type="checkbox" name="month" value="05" style="float: left;"><b></b>May</td><td><input type="checkbox" name="month" value="06" style="float: left;"><b></b>Jun</td><td><input type="checkbox" name="month" value="07" style="float: left;"><b></b>Jul</td><td><input type="checkbox" name="month" value="08" style="float: left;"><b></b>Aug</td><td><input type="checkbox" name="month" value="09" style="float: left;"><b></b>Sep</td><td><input type="checkbox" name="month" value="10" style="float: left;"><b></b>Oct</td><td><input type="checkbox" name="month" value="11" style="float: left;"><b></b>Nov</td><td><input type="checkbox" name="month" value="12" style="float: left;"><b></b>Dec</td></tr></table></div></div></div>');
        }
        else{
            $("#months4").html("");
            var val = $(this).val();
...
<script type="text/javascript">
    ...
    $(document).on("change", ".year_check5", function(){
        ...
        if($(this).prop('checked') == true){
            ...
            var year = $(this).attr("id");
            $("#months5").html('<div class="col-md-12" style="margin-bottom: 50px"><div class="row"><div class="col-md-2"><b>Choose a base month</b></div><div class="col-md-10"><table style="width: 100%"><tr><td><input type="checkbox" name="month" value="01" style="float: left;"><b></b>Jan</td><td><input type="checkbox" name="month" value="02" style="float: left;"><b></b>Feb</td><td><input type="checkbox" name="month" value="03" style="float: left;"><b></b>Mar</td><td><input type="checkbox" name="month" value="05" style="float: left;"><b></b>Apr</td><td><input type="checkbox" name="month" value="05" style="float: left;"><b></b>May</td><td><input type="checkbox" name="month" value="06" style="float: left;"><b></b>Jun</td><td><input type="checkbox" name="month" value="07" style="float: left;"><b></b>Jul</td><td><input type="checkbox" name="month" value="08" style="float: left;"><b></b>Aug</td><td><input type="checkbox" name="month" value="09" style="float: left;"><b></b>Sep</td><td><input type="checkbox" name="month" value="10" style="float: left;"><b></b>Oct</td><td><input type="checkbox" name="month" value="11" style="float: left;"><b></b>Nov</td><td><input type="checkbox" name="month" value="12" style="float: left;"><b></b>Dec</td></tr></table></div></div></div>');
        }
        else{
            $("#months5").html("");
            var val = $(this).val();
    ...
    $(document).on("change", ".comparison_year_check5", function(){
        ...
        if($(this).prop('checked') == true){
            ...
            $(this).prop('checked', true);
                ...
                $("#"+id).closest(".comparisonyears5").next(".comparison_month5x").html('<div class="col-md-12" style="margin-bottom: 50px"><div class="row"><div class="col-md-2"><b>Choose a base month</b></div><div class="col-md-10"><table style="width: 100%"><tr><td><input type="checkbox" name="month" value="01" style="float: left;"><b></b>Jan</td><td><input type="checkbox" name="month" value="02" style="float: left;"><b></b>Feb</td><td><input type="checkbox" name="month" value="03" style="float: left;"><b></b>Mar</td><td><input type="checkbox" name="month" value="05" style="float: left;"><b></b>Apr</td><td><input type="checkbox" name="month" value="05" style="float: left;"><b></b>May</td><td><input type="checkbox" name="month" value="06" style="float: left;"><b></b>Jun</td><td><input type="checkbox" name="month" value="07" style="float: left;"><b></b>Jul</td><td><input type="checkbox" name="month" value="08" style="float: left;"><b></b>Aug</td><td><input type="checkbox" name="month" value="09" style="float: left;"><b></b>Sep</td><td><input type="checkbox" name="month" value="10" style="float: left;"><b></b>Oct</td><td><input type="checkbox" name="month" value="11" style="float: left;"><b></b>Nov</td><td><input type="checkbox" name="month" value="12" style="float: left;"><b></b>Dec</td></tr></table></div></div></div>')
        }
        else{
