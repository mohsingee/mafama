      ...
      <div class="row">
         ...
         <div class="col-md-12 col-sm-12">
            ...
            <ul class="nav nav-tabs nav-button-tabs nav-justified margin-bottom-20">
               ...
               <li class="active"><a href="{{ url('paymentbalance_report') }}">Clients With Balance</a></li>
            </ul>
                     ...
                     <div class="tab-pane fade in active" id="monthly">
                        <div class="row"  style="margin: 10px 0;">
                           ...
                           <div class="col-md-9">
                              ...
                              <a href="javascript:void(0)" data-id="<?php echo $value; ?>" id="monthlyyearlist">
                                <span class="act activespan-<?= $value ?>"  style="margin-right: 12px;background-color: #da291c;
                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_editable_1">
                           <thead>
                              <?php
                                 ...
                                 foreach($client as $value){
                                    ...
                                    $balance_amount123 = \App\Http\Controllers\MainController::get_revenue_by_col1($value->email,$month,'balance');

                                    if($balance_amount123 != 0){
                                        $bill_amount1 +=\App\Http\Controllers\MainController::get_revenue_by_col1($value->email,$month,'bill');
                                        $discount1 +=\App\Http\Controllers\MainController::get_revenue_by_col1($value->email,$month,'discount');
                                        $tax_amount1 +=\App\Http\Controllers\MainController::get_revenue_by_col1($value->email,$month,'tax');
                                        $shipping_amount1 +=\App\Http\Controllers\MainController::get_revenue_by_col1($value->email,$month,'shipping');
                                        $total_amount1 +=\App\Http\Controllers\MainController::get_revenue_by_col1($value->email,$month,'total');
                                        $paid_amount1 +=\App\Http\Controllers\MainController::get_revenue_by_col1($value->email,$month,'amount_paid');
                                        $balance_amount1 +=\App\Http\Controllers\MainController::get_revenue_by_col1($value->email,$month,'balance');
                                        }
                           ...
                           <tbody id="revenue_records">
                              <?php
                                 foreach($client as $value){
                                 $month=date('m');
                                 $bill_amount=\App\Http\Controllers\MainController::get_revenue_by_col1($value->email,$month,'bill');
                                 $discount=\App\Http\Controllers\MainController::get_revenue_by_col1($value->email,$month,'discount');
                                 $tax_amount=\App\Http\Controllers\MainController::get_revenue_by_col1($value->email,$month,'tax');
                                 $shipping_amount=\App\Http\Controllers\MainController::get_revenue_by_col1($value->email,$month,'shipping');
                                 $total_amount=\App\Http\Controllers\MainController::get_revenue_by_col1($value->email,$month,'total');
                                 $paid_amount=\App\Http\Controllers\MainController::get_revenue_by_col1($value->email,$month,'amount_paid');
                                 $balance_amount=\App\Http\Controllers\MainController::get_revenue_by_col1($value->email,$month,'balance');
                              ...
                              <tr class="odd gradeX">
                                 ...
                                 <td>
                                    <?php if($bill_amount > 0){
                                       echo '<a class="revenue_month" id="'.$month.'revenue_month'.$value->email.'"">'.$bill_amount.'</a>';
                                       }
                                       else{
                                       echo $bill_amount;
                                       }
                                 ...
                                 <td>
                                    <?php if($discount > 0){
                                       echo '<a class="revenue_month" id="'.$month.'revenue_month'.$value->email.'"">'.$discount.'</a>';
                                       }
                                       else{
                                       echo $discount;
                                       }
                                 ...
                                 <td>
                                    <?php if($tax_amount > 0){
                                       echo '<a class="revenue_month" id="'.$month.'revenue_month'.$value->email.'"">'.$tax_amount.'</a>';
                                       }
                                       else{
                                       echo $tax_amount;
                                       }
                                 ...
                                 <td>
                                    <?php if($shipping_amount > 0){
                                       echo '<a class="revenue_month" id="'.$month.'revenue_month'.$value->email.'"">'.$shipping_amount.'</a>';
                                       }
                                       else{
                                 ...
                                 <td>
                                    <?php if($total_amount > 0){
                                       echo '<a class="revenue_month" id="'.$month.'revenue_month'.$value->email.'"">'.$total_amount.'</a>';
                                       }
                                       else{
                                       echo $total_amount;
                                       }
                                 ...
                                 <td>
                                    <?php if($paid_amount > 0){
                                       echo '<a class="revenue_month" id="'.$month.'revenue_month'.$value->email.'"">'.$paid_amount.'</a>';
                                       }
                                       else{
                                       echo $paid_amount;
                                       }
                              ...
                              <?php
                                 ...
                                 ?>
                                <tr class="" style="background: #800080">
                                    <td><input type="checkbox" class="checkboxes" value="1000000" /></td>
                                    <td class="fixed-side" style="color: white; font-weight:bold">Total</td>
                                    <td class="fixed-side" style="color:white !important; font-weight:bold">{{$bill_amount1}}</td>
                                    <td class="fixed-side" style="color:white !important; font-weight:bold">{{$discount1}}</td>
                                    <td class="fixed-side" style="color:white !important; font-weight:bold">{{$tax_amount1}}</td>
                                    <td class="fixed-side" style="color:white !important; font-weight:bold">{{$shipping_amount1}}</td>
                                    <td class="fixed-side" style="color:white !important; font-weight:bold">{{$total_amount1}}</td>
                                    <td class="fixed-side" style="color:white !important; font-weight:bold">{{$paid_amount1}}</td>
                                    <td style="color:white; font-weight:bold" class="fixed-side">{{-1*$balance_amount1}}</td>
                                </tr>
                           </tbody>
                        </table>
                        <div class="row">
...
//         year=$('#monthlyyearlist').attr("data-id");
//         if (year == "2022") {
//             alert(year);
//         }
//    });
   ...
   $(document).on('click','#monthlyyearlist', function(){
    ...
    $('.act').css("background","#da291c");
    year=$(this).attr("data-id");
    // alert(year);
    $(this).children().css("background","#800080");
    // $("#month_record").attr('class','active1');
    $(document).on('click','#month_record',function(){
        $("#monthly_details").html("");
        $("#month_record").removeClass('active1');
        $('.active1').removeClass('active1');
