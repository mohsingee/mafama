					...
					<div class="card card-bordered card-stretch">
                        <div class="card-aside-wrap">
							<div class="card-inner card-inner-lg">
								@if(permission_access('upload_scripts_add')==1)
								<form id="" action="{{ url('uploadscript_entry') }}" method="POST" enctype="multipart/form-data">	
								@csrf	
									<div class="row gy-4">
										<!-- <div class="col-md-6">
								...
								<table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
									<thead>
										<tr class="nk-tb-item nk-tb-head">
											...
											<th class="nk-tb-col"><span class="sub-text">Category Script</span></th>
											<th class="nk-tb-col"><span class="sub-text">Category Script Desc</span></th>
									...
									<tbody>
										...
										<tr class="nk-tb-item">
											...
											<td class="nk-tb-col tb-col-md">
												...
												<a href="<?php echo url('edituploadscript') ?>/<?= $popup->id ?>" class="btn btn-sm btn-primary">Edit</a>
                                                 @endif
												@if(permission_access('upload_scripts_delete')==1)
												<a href="<?php echo url('deleteuploadscript') ?>/<?= $popup->id ?>" class="btn btn-sm btn-danger">Delete</a>
												@endif
											</td>
										</tr>
										<?php 
