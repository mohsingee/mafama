        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12">
                <div class="col-md-12 text-right">
                    <a href="{{ url('appointment_step2') }}" class="btn btn-md btn-info">Back</a>
                </div>
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-12 margin-bottom-40 margin-top-20">
                        ...
                        <div class="col-md-12 text-center margin-top-20">
                            ...
                            <a href="{{ url('appointment_step4') }}" class="btn btn-sm btn-info" style="margin-right: 10px; width: 200px;">Next</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        for (let j = 0; j < 7; j++) {
            if (i === 0 && j < firstDay) {  
               ...
               break;
                ...
                document.cookie = "var1="+dayyy+"; path=/";
                // $.cookie("var1", dayyy);
                // console.log(document.cookie('var1'));
                <?php $phpVar =  $_COOKIE['var1']; ?>
                console.log("<?php echo $phpVar; ?>");
                document.cookie = "var1=; expires=Thu, 01 Jan 1970 00:00:00 UTC; path=/;";
                <?php // $phpVar =  ''; ?>
                // if(('<?php //echo $appointment_settings_day->$phpVar ?>') == "block"){console.log(dayyy);}
