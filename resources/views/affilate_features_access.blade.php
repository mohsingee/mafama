		...
		<div class="nk-content-inner">
			<div class="nk-content-body">
				<div class="nk-block-head-content" style="margin-bottom:20px;">
					<h3 class="nk-block-title page-title">Affilates Features Access</h3>
									...
									<div class="row gy-4">
											...
											<table class="table">
												<thead class="thead-light">
													<tr>
													  ...
													  <th  class="text-center" scope="col">Affilates</th>
													  <th  class="text-center" scope="col">Free Affilates</th>
												...
												<tbody>
													<tr>
														...
														<td class="text-center">
															<div class="custom-control custom-control-sm custom-checkbox">
																<input type="checkbox" class="custom-control-input" id="customChec3">
													...
													<tr>
														...
														<td class="text-center">
															<div class="custom-control custom-control-sm custom-checkbox">
																<input type="checkbox" class="custom-control-input" id="customChec8">
													...
													<tr>
														<th scope="row">Import Contact</th>
														<td class="text-center">
															<div class="custom-control custom-control-sm custom-checkbox">
																<input type="checkbox" class="custom-control-input" id="customCheck6">
																<label class="custom-control-label" for="customCheck6"></label>
													...
													<tr>
														<th scope="row">User Access Right</th>
														<td class="text-center">
															<div class="custom-control custom-control-sm custom-checkbox">
														...
														<td class="text-center">
															<div class="custom-control custom-control-sm custom-checkbox">
																<input type="checkbox" class="custom-control-input" id="customChec18">
													...
													<tr>
														<th scope="row">Appointment Setting</th>
														<td class="text-center">
															<div class="custom-control custom-control-sm custom-checkbox">
														...
														<td class="text-center">
															<div class="custom-control custom-control-sm custom-checkbox">
																<input type="checkbox" class="custom-control-input" id="customChec23">
													...
													<tr>
														<th scope="row">Manage Date Settings</th>
														<td class="text-center">
															<div class="custom-control custom-control-sm custom-checkbox">
														...
														<td class="text-center">
															<div class="custom-control custom-control-sm custom-checkbox">
																<input type="checkbox" class="custom-control-input" id="customChec28">
														...
														<td class="text-center">
															<div class="custom-control custom-control-sm custom-checkbox">
																<input type="checkbox" class="custom-control-input" id="customChec30">
																<label class="custom-control-label" for="customCheck30"></label>
															</div>
													    </td>
													</tr>
													<tr>
														<th scope="row">Create Revenue Account</th>
														<td class="text-center">
															<div class="custom-control custom-control-sm custom-checkbox">
														...
														<td class="text-center">
															<div class="custom-control custom-control-sm custom-checkbox">
																<input type="checkbox" class="custom-control-input" id="customChec33">
													...
													<tr>
														<th scope="row">Create Expense Account</th>
														<td class="text-center">
															<div class="custom-control custom-control-sm custom-checkbox">
														...
														<td class="text-center">
															<div class="custom-control custom-control-sm custom-checkbox">
																<input type="checkbox" class="custom-control-input" id="customChec38">
														...
														<td class="text-center">
															<div class="custom-control custom-control-sm custom-checkbox">
																<input type="checkbox" class="custom-control-input" id="customChec40">
																<label class="custom-control-label" for="customCheck40"></label>
															</div>
													    </td>
													</tr>
													<tr>
														<th scope="row">Chart of Accounts</th>
														<td class="text-center">
															<div class="custom-control custom-control-sm custom-checkbox">
													...
													<tr>
														...
														<td class="text-center">
															<div class="custom-control custom-control-sm custom-checkbox">
																<input type="checkbox" class="custom-control-input" id="customChec48">
														...
														<td class="text-center">
															<div class="custom-control custom-control-sm custom-checkbox">
																<input type="checkbox" class="custom-control-input" id="customChec50">
																<label class="custom-control-label" for="customCheck50"></label>
															</div>
													    </td>
													</tr>
													<tr>
														<th scope="row">Upload From Library(Form)</th>
														<td class="text-center">
															<div class="custom-control custom-control-sm custom-checkbox">
																<input type="checkbox" class="custom-control-input" id="customCheck46">
																<label class="custom-control-label" for="customCheck46"></label>
										...
										<div class="col-md-12">
											<table class="table">
												...
												<tbody>
													<tr>
													    <th scope="row">Make Appointment</th>
													    <td class="text-center">
															<div class="custom-control custom-control-sm custom-checkbox">
																<input type="checkbox" class="custom-control-input" id="customCheck1">
																<label class="custom-control-label" for="customCheck1"></label>
													...
													<tr>
														<th scope="row">Change Appointment</th>
														<td class="text-center">
															<div class="custom-control custom-control-sm custom-checkbox">
																<input type="checkbox" class="custom-control-input" id="customCheck6">
																<label class="custom-control-label" for="customCheck6"></label>
													...
													<tr>
														<th scope="row">Manage My Appointment</th>
														<td class="text-center">
															<div class="custom-control custom-control-sm custom-checkbox">
																<input type="checkbox" class="custom-control-input" id="customCheck16">
																<label class="custom-control-label" for="customCheck16"></label>
										...
										<div class="col-md-12">
											<table class="table">
												<thead class="thead-light">
													<tr>
													  <th scope="col">Client Management</th>
													  <th  class="text-center" scope="col">Affilates</th>
													  <th  class="text-center" scope="col">Free Affilates</th>
													  <th  class="text-center" scope="col">Gold</th>
													  <th  class="text-center" scope="col">Silver</th>
												...
												<tbody>
													...
													<tr>
														<th scope="row">Manage Client Profile</th>
														<td class="text-center">
															<div class="custom-control custom-control-sm custom-checkbox">
																<input type="checkbox" class="custom-control-input" id="customCheck6">
																<label class="custom-control-label" for="customCheck6"></label>
													...
													<tr>
														<th scope="row">Schedule Birthdays</th>
														<td class="text-center">
															<div class="custom-control custom-control-sm custom-checkbox">
																<input type="checkbox" class="custom-control-input" id="customCheck11">
																<label class="custom-control-label" for="customCheck11"></label>
													...
													<tr>
														<th scope="row">Schedule Holidays</th>
														<td class="text-center">
															<div class="custom-control custom-control-sm custom-checkbox">
																<input type="checkbox" class="custom-control-input" id="customCheck16">
																<label class="custom-control-label" for="customCheck16"></label>
										...
										<div class="col-md-12">
											<table class="table">
												<thead class="thead-light">
													<tr>
													  <th scope="col">Email Management</th>
													  <th  class="text-center" scope="col">Affilates</th>
													  <th  class="text-center" scope="col">Free Affilates</th>
													  <th  class="text-center" scope="col">Gold</th>
													  <th  class="text-center" scope="col">Silver</th>
												...
												<tbody>
													...
													<tr>
														<th scope="row">Manage Folders</th>
														<td class="text-center">
															<div class="custom-control custom-control-sm custom-checkbox">
																<input type="checkbox" class="custom-control-input" id="customCheck31">
																<label class="custom-control-label" for="customCheck31"></label>
													...
													<tr>
														<th scope="row">Add search emails & my mailbox</th>
														<td class="text-center">
															<div class="custom-control custom-control-sm custom-checkbox">
																<input type="checkbox" class="custom-control-input" id="customCheck51">
																<label class="custom-control-label" for="customCheck51"></label>
													...
													<tr>
														<th scope="row">Interface chat</th>
														<td class="text-center">
															<div class="custom-control custom-control-sm custom-checkbox">
										...
										<div class="col-md-12">
											<table class="table">
												<thead class="thead-light">
													<tr>
													  <th scope="col">Financial Management</th>
													  <th  class="text-center" scope="col">Affilates</th>
													  <th  class="text-center" scope="col">Free Affilates</th>
													  <th  class="text-center" scope="col">Gold</th>
													  <th  class="text-center" scope="col">Silver</th>
												...
												<tbody>
													<tr>
													    <th scope="row">Record Revenues</th>
													    <td class="text-center">
															<div class="custom-control custom-control-sm custom-checkbox">
																<input type="checkbox" class="custom-control-input" id="customCheck1">
																<label class="custom-control-label" for="customCheck1"></label>
													...
													<tr>
														<th scope="row">Record Expenses</th>
														<td class="text-center">
															<div class="custom-control custom-control-sm custom-checkbox">
																<input type="checkbox" class="custom-control-input" id="customCheck6">
																<label class="custom-control-label" for="customCheck6"></label>
													...
													<tr>
														<th scope="row">Group Recordings</th>
														<td class="text-center">
															<div class="custom-control custom-control-sm custom-checkbox">
																<input type="checkbox" class="custom-control-input" id="customCheck11">
																<label class="custom-control-label" for="customCheck11"></label>
													...
													<tr>
														<th scope="row">Create Invoice</th>
														<td class="text-center">
															<div class="custom-control custom-control-sm custom-checkbox">
																<input type="checkbox" class="custom-control-input" id="customCheck21">
																<label class="custom-control-label" for="customCheck21"></label>
													...
													<tr>
														<th scope="row">Profit / Loss Statement</th>
														<td class="text-center">
															<div class="custom-control custom-control-sm custom-checkbox">
																<input type="checkbox" class="custom-control-input" id="customCheck31">
																<label class="custom-control-label" for="customCheck31"></label>
													...
													<tr>
														<th scope="row">Revenue Report</th>
														<td class="text-center">
															<div class="custom-control custom-control-sm custom-checkbox">
																<input type="checkbox" class="custom-control-input" id="customCheck36">
																<label class="custom-control-label" for="customCheck36"></label>
													...
													<tr>
														<th scope="row">Expense Report</th>
														<td class="text-center">
															<div class="custom-control custom-control-sm custom-checkbox">
																<input type="checkbox" class="custom-control-input" id="customCheck41">
																<label class="custom-control-label" for="customCheck41"></label>
													...
													<tr>
														<th scope="row">Performance Report</th>
														<td class="text-center">
															<div class="custom-control custom-control-sm custom-checkbox">
																<input type="checkbox" class="custom-control-input" id="customCheck46">
																<label class="custom-control-label" for="customCheck46"></label>
													...
													<tr>
														<th scope="row">Comparison Mode</th>
														<td class="text-center">
															<div class="custom-control custom-control-sm custom-checkbox">
																<input type="checkbox" class="custom-control-input" id="customCheck51">
																<label class="custom-control-label" for="customCheck51"></label>
													...
													<tr>
														<th scope="row">Payment / Balance</th>
														<td class="text-center">
															<div class="custom-control custom-control-sm custom-checkbox">
																<input type="checkbox" class="custom-control-input" id="customCheck56">
																<label class="custom-control-label" for="customCheck56"></label>
										...
										<div class="col-md-12">
											<table class="table">
												...
												<tbody>
													...
													<tr>
														<th scope="row">Mthly / Qtrly Apptmt</th>
														<td class="text-center">
															<div class="custom-control custom-control-sm custom-checkbox">
																<input type="checkbox" class="custom-control-input" id="customCheck16">
																<label class="custom-control-label" for="customCheck16"></label>
													...
													<tr>
														<th scope="row">Mthly / Qtrly Clients</th>
														<td class="text-center">
															<div class="custom-control custom-control-sm custom-checkbox">
																<input type="checkbox" class="custom-control-input" id="customCheck26">
																<label class="custom-control-label" for="customCheck26"></label>
													...
													<tr>
														<th scope="row">Mthly / Qtrly Emails</th>
														<td class="text-center">
															<div class="custom-control custom-control-sm custom-checkbox">
																<input type="checkbox" class="custom-control-input" id="customCheck31">
																<label class="custom-control-label" for="customCheck31"></label>
													...
													<tr>
														<th scope="row">Mthly / Qtrly Finance</th>
														<td class="text-center">
															<div class="custom-control custom-control-sm custom-checkbox">
																<input type="checkbox" class="custom-control-input" id="customCheck36">
																<label class="custom-control-label" for="customCheck36"></label>
