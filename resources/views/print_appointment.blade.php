            ...
            <div style="border: 2px solid red; padding: 10px;">
                ...
                <div class="row" style="">
                    ...
                    <div class="col-md-3" style="text-align: center">
                        ...
                        <img src="{{ asset('public/images/affiliates') }}/<?= $user->image ?>" style="border: 1px solid #da291c73 !important; border-radius: 5px; padding: 5px; margin: 0 auto;" width="140" height="140" alt="featured item" />
