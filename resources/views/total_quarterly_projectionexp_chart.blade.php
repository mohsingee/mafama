                ...
                <div class="col-md-12 margin-top-10 padding-0">
                    ...
                    <div style="padding: 30px 0px;">
                        ...
                        <div class="text-center">
                            <h4>Quarterly Expense Projection</h4>
                        </div>
                        <script type="text/javascript">
                              $(function () {
                                    ...
                                    var bar = new Morris.Bar({
                                      ...
                                      resize: true,
                                      data: [
                                        {y: 'Jan-Mar', a: <?= $janmartotal ?>},
                                        {y: 'Apr-Jun', a: <?= $aprjuntotal ?>},
                                        {y: 'Jul-Sep', a: <?= $julseptotal ?>},
                                        {y: 'Oct-Dec', a: <?= $octdectotal ?>}
                                      ],
                                      barColors: ['#da291c'],
                                      xkey: 'y',
                                      ykeys: ['a'],
                                      labels: ['Expense Projection'],
                                      hideHover: 'auto',
                                      xLabelMargin: 10,
                                      padding: 30,
                                    });
