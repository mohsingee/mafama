            ...
            <div class="col-md-12 col-sm-12">
                ...
                <div class="col-md-12 margin-top-40 padding-0">
                    <ul class="nav nav-tabs nav-button-tabs nav-justified">
                        ...
                        <li class="active"><a href="{{ url('tab4') }}">Revenue Budget</a></li>
                    ...
                    <div class="tab-content margin-top-10" style="border: 1px solid #da291c !important; border-radius: 10px; padding: 20px;">
                        <div class="tab-pane fade in active" id="tab4">
                            <ul class="nav nav-tabs nav-button-tabs nav-justified">
                                <li class="active"><a href="{{ url('tab4') }}">Monthly</a></li>
                                <li><a href="{{ url('tab42') }}">Quaterly</a></li>
                            </ul>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                            <tr class="odd gradeX">
                                                                ...
                                                                <td><?= $value->jan ?></td>
                                                                <td><?php echo $actual_jan = App\Http\Controllers\HomeController::getjanactual($value->name); ?></td>
                                                                <td><?= ($value->jan - $actual_jan) ?></td>
                                                                <td><?= $value->feb ?></td>
                                                                <td><?php echo $actual_feb = App\Http\Controllers\HomeController::getfebactual($value->name); ?></td>
                                                                <td><?= ($value->feb - $actual_feb) ?></td>
                                                                <td><?= $value->mar ?></td>
                                                                <td><?php echo $actual_mar = App\Http\Controllers\HomeController::getmaractual($value->name); ?></td>
                                                                <td><?= ($value->mar - $actual_mar) ?></td>
                                                                <td><?= $value->apr ?></td>
                                                                <td><?php echo $actual_apr = App\Http\Controllers\HomeController::getapractual($value->name); ?></td>
                                                                <td><?= ($value->apr - $actual_apr) ?></td>
                                                                <td><?= $value->may ?></td>
                                                                <td><?php echo $actual_may = App\Http\Controllers\HomeController::getmayactual($value->name); ?></td>
                                                                <td><?= ($value->may - $actual_may) ?></td>
                                                                <td><?= $value->jun ?></td>
                                                                <td><?php echo $actual_jun = App\Http\Controllers\HomeController::getjunactual($value->name); ?></td>
                                                                <td><?= ($value->jun - $actual_jun) ?></td>
                                                                <td><?= $value->jul ?></td>
                                                                <td><?php echo $actual_jul = App\Http\Controllers\HomeController::getjulactual($value->name); ?></td>
                                                                <td><?= ($value->jul - $actual_jul) ?></td>
                                                                <td><?= $value->aug ?></td>
                                                                <td><?php echo $actual_aug = App\Http\Controllers\HomeController::getaugactual($value->name); ?></td>
                                                                <td><?= ($value->aug - $actual_aug) ?></td>
                                                                <td><?= $value->sep ?></td>
                                                                <td><?php echo $actual_sep = App\Http\Controllers\HomeController::getsepactual($value->name); ?></td>
                                                                <td><?= ($value->sep - $actual_sep) ?></td>
                                                                <td><?= $value->oct ?></td>
                                                                <td><?php echo $actual_oct = App\Http\Controllers\HomeController::getoctactual($value->name); ?></td>
                                                                <td><?= ($value->oct - $actual_oct) ?></td>
                                                                <td><?= $value->nov ?></td>
                                                                <td><?php echo $actual_nov = App\Http\Controllers\HomeController::getnovactual($value->name); ?></td>
                                                                <td><?= ($value->nov - $actual_nov) ?></td>
                                                                <td><?= $value->decem ?></td>
                                                                <td><?php echo $actual_decem = App\Http\Controllers\HomeController::getdecemactual($value->name); ?></td>
                                                                ...
                                                                <td>
                                                                    <a href="{{ url('revenue_variance_monthly_graph') }}/<?= $value->name ?>"><i class="fa fa-bar-chart"></i></a>
                                                                </td>
                                                            </tr>
                                                        <?php } ?>
                                                        <tr class="total-tr">
                                                            ...
                                                            <td><?= ($tott - $tott2) ?></td>
                                                            <td>
                                                                <a href="{{ url('revenue_monthly_vary_chart') }}"><i class="fa fa-bar-chart"></i></a>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            ...
                                            <div class="table-wrap">
                                                <table class="table table-striped table-bordered table-hover" id="">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <!-- .nk-tb-item  -->
                                                        <tr class="odd gradeX">
                                                            <td class="fixed-side">Consultation</td>
                                                            <td>0</td>
                                                            <td>0</td>
                                                            <td>0</td>
                                                            <td>0</td>
                                                        ...
                                                        <!-- .nk-tb-item  -->
                                                        <tr class="odd gradeX">
                                                            <td class="fixed-side">Hair Braiding</td>
                                                            <td>0</td>
                                                            <td>0</td>
                                                            <td>0</td>
                                                            <td>0</td>
