                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-12 padding-0">
                                            <ul class="nav nav-tabs nav-bottom-border category-ul">
                                                ...
                                                ?>
                                <li class="<?php if($c == 0){echo 'active';} ?>"><a href="#card_<?= $value->category ?>" data-toggle="tab"><?= $value->category ?></a></li>
                                                <?php
                                                $c++;
                                                    }
                                                ?>
                                                 <li ><a href="#card_<?=get_business_category();?>" data-toggle="tab"><?=get_business_category();?></a></li>
                                            ...
                                            <div class="tab-content">
                                                ...
                                                $m = 0;
                                                    foreach($category as $value){
                                                        ...
                                                        // print_r($imgs);
                                                ?>
                                                <div class="tab-pane fade in <?php if($m == 0){echo 'active';} ?>" id="card_<?= $value->category ?>">
                                                    <div class="col-md-12 padding-0 ">
                                                        <?php 
                                                ...
                                                ?>
                                                <div class="tab-pane fade in " id="card_<?=get_business_category();?>">
                                                    <div class="col-md-12 padding-0 ">
        ...
        $(".prvbtn").click(function(){
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    var preview = '<div style="padding:10px; background-color:'+bakg+'"><div style="padding: 5px">'+user_banner+'</div><p style="margin-top: 10px;">'+greeting+'</p><p style="margin-bottom: 0;">'+message+'</p><div>'+imggg+'</div></div>';
