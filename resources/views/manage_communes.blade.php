	...
	<div class="container-fluid">
		<div class="nk-content-inner">
			<div class="nk-content-body">
				...
				@if(permission_access('create_communess_add')==1)
				<div class="nk-block">
					<div class="card card-bordered card-stretch">
                        <div class="card-aside-wrap">
							<div class="card-inner card-inner-lg">
								<form action="{{ url('communes_entry') }}" method="POST" id="" enctype="multipart/form-data">	
									@csrf
									<div class="row gy-4">
										<div class="col-md-6">
											<div class="form-group">
												<label class="form-label">Commune Name	</label>
												<input type="text" class="form-control" placeholder="Commune Name" name="commune" required>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
										...
										<div class="col-md-6">
											<div class="form-group">
												<label class="form-label" for="phone-no">Arrondissement</label>
				...
				<div class="nk-block" id="myGroup">
					<div class="card card-bordered card-stretch">
							...
							<div class="card-inner  " >
								<table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
									...
									<tbody>
										...
										?>
												<tr class="nk-tb-item collapser " data-toggle="collapse" data-id="<?= $value->id ?>" data-target="#colse<?= $value->id ?>" data-parent="#myGroup">
													<td class="nk-tb-col">
						...
						foreach ($arrondissements as $value) {
						?>
							<div class="card-inner collapse " id="colse<?= $value->id ?>">
								<table class="datatable-init nk-tb-list nk-tb-ulist " data-auto-responsive="false">
									<thead>
										<tr class="nk-tb-item nk-tb-head">
									...
									<tbody>
										<?php
										$i = 1;
										$comunes=comunes_by_arrondissements($value->id);
										...
										?>
												<tr class="nk-tb-item">
													...
													<td class="nk-tb-col tb-col-md">
														...
														<a href="{{ url('manage_communes_edit') }}/<?= $value->id ?>" class="btn btn-sm btn-success">Edit</a>
														@endif
														@if(permission_access('create_communes_delete')==1)
														<a href="{{ url('manage_communes_delete') }}/<?= $value->id ?>" class="btn btn-sm btn-danger">Delete</a>
														@endif
													</td>
												</tr>
										<?php
