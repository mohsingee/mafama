        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12">
                ...
                <ul class="nav nav-tabs nav-button-tabs nav-justified  margin-top-10">
                    ...
                    <li class="active"><a href="{{ url('comparison_finance2') }}">Quarterly</a></li>
                    <li><a href="{{ url('comparison_finance3') }}">Yearly</a></li>
                </ul>
...
<script type="text/javascript">
    ...
    $(document).on("click", ".compare_btn", function(){
        ...
        var mmonth = $("#monthlylist1 li.cmonth").text();
        mmonth = mmonth.split('-');
        fmonth = mmonth[0];
        if((fyear != "") && (fmonth != "")){
...
<script type="text/javascript">
    ...
    $(document).on("click", ".compare_btnq", function(){
        ...
        var mmonth = $("#monthlylist1q li.cmonth").text();
        mmonth = mmonth.split('-');
        fmonth = mmonth[0];
        if((fyear != "") && (fmonth != "")){
            allyearmonth.push(fyear+"nqd"+fmonth); 
        ...
        if(allyearmonth != ""){
            $.ajax({
                  ...
                  //   $("#wrapper").hide();
                  // },
                  url: "quarterlyyearlycomexpenses",
                  data:  'allyearmonth=' + allyearmonth + '&_token={{ csrf_token() }}',
                  success: function(html) {
                    // alert(html);
...
<script type="text/javascript">
    ...
    $(document).on("click", ".compare_btny", function(){
        ...
        var mmonth = $("#monthlylist1y li.cmonth").text();
        mmonth = mmonth.split('-');
        fmonth = mmonth[0];
        if((fyear != "") && (fmonth != "")){
            allyearmonth.push(fyear+"nqd"+fmonth); 
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $(".addcomprsntabv").on("click", function(){
            ...
            var html = '<div class="margin-top-10 commallq" style="border: 1px solid #da291c !important; border-radius: 10px; padding: 5px;"> <div class="row"> <div class="col-md-3"> <label style="margin: 12px 0;">Choose a year to compare</label> </div><div class="col-md-9"> <div class=""> <ul class="monthlylistv"> '+ yearlist +' </ul> </div></div></div><div class="row"> <div class="col-md-3"> <label style="margin: 12px 0;">Choose a month to compare</label> </div><div class="col-md-9"> <div class=""> <ul class="monthlylist1v"> <li class="act">Jan-Mar</li><li class="act">Apr-Jun</li><li class="act">Jul-Sep</li><li class="act">Oct-Dec</li></ul> </div></div></div><div class="clearfix"></div></div>';
    ...
    $(document).on("click", ".compare_btnv", function(){
        ...
        var mmonth = $("#monthlylist1v li.cmonth").text();
        mmonth = mmonth.split('-');
        fmonth = mmonth[0];
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $(".addcomprsntabz").on("click", function(){
            ...
            var html = '<div class="margin-top-10 commallq" style="border: 1px solid #da291c !important; border-radius: 10px; padding: 5px;"> <div class="row"> <div class="col-md-3"> <label style="margin: 12px 0;">Choose a year to compare</label> </div><div class="col-md-9"> <div class=""> <ul class="monthlylistz"> '+ yearlist +' </ul> </div></div></div><div class="row"> <div class="col-md-3"> <label style="margin: 12px 0;">Choose a month to compare</label> </div><div class="col-md-9"> <div class=""> <ul class="monthlylist1z"> <li class="act">Jan-Mar</li><li class="act">Apr-Jun</li><li class="act">Jul-Sep</li><li class="act">Oct-Dec</li></ul> </div></div></div><div class="clearfix"></div></div>';
    ...
    $(document).on("click", ".compare_btnz", function(){
        ...
        var mmonth = $("#monthlylist1z li.cmonth").text();
        mmonth = mmonth.split('-');
        fmonth = mmonth[0];
        if((fyear != "") && (fmonth != "")){
            allyearmonth.push(fyear+"nqd"+fmonth); 
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $(".addcomprsntabk").on("click", function(){
            ...
            var html = '<div class="margin-top-10 commallq" style="border: 1px solid #da291c !important; border-radius: 10px; padding: 5px;"> <div class="row"> <div class="col-md-3"> <label style="margin: 12px 0;">Choose a year to compare</label> </div><div class="col-md-9"> <div class=""> <ul class="monthlylistk"> '+ yearlist +' </ul> </div></div></div><div class="row"> <div class="col-md-3"> <label style="margin: 12px 0;">Choose a month to compare</label> </div><div class="col-md-9"> <div class=""> <ul class="monthlylist1k"> <li class="act">Jan-Mar</li><li class="act">Apr-Jun</li><li class="act">Jul-Sep</li><li class="act">Oct-Dec</li></ul> </div></div></div><div class="clearfix"></div></div>';
        ...
        $(document).on("click", ".monthlylist1k li.act", function(){
            $(this).parent("ul").children("li").css("text-decoration", "none");
            $(this).parent("ul").children("li").removeClass("cmonth");
            $(this).css("text-decoration", "underline");
            $(this).addClass("cmonth");
    ...
    $(document).on("click", ".compare_btnk", function(){
        ...
        var mmonth = $("#monthlylist1k li.cmonth").text();
        mmonth = mmonth.split('-');
        fmonth = mmonth[0];
        if((fyear != "") && (fmonth != "")){
            allyearmonth.push(fyear+"nqd"+fmonth); 
        ...
        $(".commallq").each(function(){
            ...
            $(this).find(".monthlylist1k li.cmonth", this).each(function() { 
                var month = $(this).text();
                month = month.split('-');
                lmonth = month[0];
            });
        ...
        if(allyearmonth != ""){
            $.ajax({
                  ...
                  //   $("#wrapper").hide();
                  // },
                  url: "quarterlyyearlycomprofitloss",
                  data:  'allyearmonth=' + allyearmonth + '&_token={{ csrf_token() }}',
                  success: function(html) {
                    // alert(html);
