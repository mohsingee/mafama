        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12">
                ...
                <div class="col-md-12">
                    ...
                    <hr />
                    <form action="{{ url('appointment_step4_details') }}" method="POST" enctype="multipart/form-data">   
                        @csrf
            ...
            for (let j = 0; j < 7; j++) {
                if (i === 0 && j < firstDay) {  
                   ...
                   break;
                    ...
                    // let main_day = "";
                    var url = "<?php echo url('/'); ?>/appointmentstepdet";
                    $.ajax({
                          url: url,
        ...
        $(function(){
            ...
            $(document).on('click', '.showEvent', function(){
                if($(this).hasClass("prev_day")){
                    ...
                    var url = "<?php echo url('/'); ?>/appointment_date_availabilityy";
                    $.ajax({
                          url: url,
                          beforeSend: function(){
                            $("#loading").show();
