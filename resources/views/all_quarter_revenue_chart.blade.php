                        ...
                        <script type="text/javascript">
                              $(function () {
                                    ...
                                    var bar = new Morris.Bar({
                                      ...
                                      resize: true,
                                      data: [
                                        {y: 'Jan-Mar', a: <?= $janmartotal ?>, b: <?= $janmartotalactual ?>},
                                        {y: 'Apr-Jun', a: <?= $aprjuntotal ?>, b: <?= $aprjuntotalactual ?>},
                                        {y: 'Jul-Sep', a: <?= $julseptotal ?>, b: <?= $julseptotalactual ?>},
                                        {y: 'Oct-Dec', a: <?= $octdectotal ?>, b: <?= $octdectotalactual ?>}
                                      ],
