            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12">
                    <div class="heading-title heading-dotted col-md-12 margin-bottom-20 text-center">
                        <h4>Email Management / Send Cards</h4>
                    </div>
                                            ...
                                            <div class="col-md-12 padding-0">
                                                ...
                                                ?>
                                                    <li class="<?php if ($c == 0) {
                                                        echo 'active';
                                                            ...
                                                            href="#card_<?= $value->category ?>"
                                                            data-toggle="tab"><?= $value->category ?></a></li>
                                                    <?php
                                                $c++;
                                                    }
                                                ?>
                                                    <li><a href="#card_<?= get_business_category() ?>"
                                                            data-toggle="tab"><?= get_business_category() ?></a></li>
                                                ...
                                                $m = 0;
                                                    foreach($category as $value){
                                                        ...
                                                        // print_r($imgs);
                                                ?>
                                                    <div class="tab-pane fade in <?php if ($m == 0) {
                                                        echo 'active';
                                                    } ?>"
                                                        id="card_<?= $value->category ?>">
                                                        <div class="col-md-12 padding-0 ">
                                                            <?php 
                                                ...
                                                ?>
                                                    <div class="tab-pane fade in "
                                                        id="card_<?= get_business_category() ?>">
                                                        <div class="col-md-12 padding-0 ">
                                                            <?= get_business_category_cards() ?>
                                                        </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $(".card_img").click(function() {
                ...
                $(".cardimgg img").attr('src', img_path);
                $(".cardimgg").show();
                $(this).css({
                        ...
                        if (submit_value == "Send Now") {
                            ...
                            if ($("#reminderdate").val() == "") {
                                ...
                                $.ajax({
                                    ...
                                    url: "send_cards_send_with_reminder",
                                    data: formData,
                                    contentType: false,
                                    cache: false,
                                    processData: false,
