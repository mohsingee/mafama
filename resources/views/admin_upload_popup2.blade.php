                        ...
                        <div class="card-aside-wrap">
							<div class="card-inner card-inner-lg">
								<!-- <form id="" action="{{ url('uploadbusiness_entry') }}" method="POST" enctype="multipart/form-data">	 -->
								 @if(permission_access('uploadstwo_popup_add')==1)		
										...
										<tr class="nk-tb-item">
											...
											<td class="nk-tb-col tb-col-md">
											   @if(permission_access('uploadstwo_popup_edit')==1)
												<a href="<?php echo url('edituploadpopup2') ?>/<?= $popup->aid ?>" class="btn btn-sm btn-primary">Edit</a>
												@endif
												@if(permission_access('uploadstwo_popup_delete')==1)
												<a href="<?php echo url('deleteuploadpopup2') ?>/<?= $popup->aid ?>" class="btn btn-sm btn-danger">Delete</a>
												@endif
...
<div class="appndbanner" style="display: none;"><div class="user_banner"><div style="text-align: center;"><img class="popimg" src="" style="width: auto; height: 200px; max-width: 100%"></div><div class="description"></div></div></div>
