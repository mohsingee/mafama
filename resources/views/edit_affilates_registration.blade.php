                        ...
                        <div class="card-aside-wrap">
							<div class="card-inner card-inner-lg">
								<form action="{{ url('affiliate_update') }}" method="POST" id="" enctype="multipart/form-data">	
                                            ...
                                            <div class="col-md-4" style="padding-left:35px">
                                                <div class="form-group">
                                                    <input class="form-check-input" name="enable_diaspo_connection" value="1"
                                                        ...
                                                        {{ $details[0]->enable_diaspo_connection == 1 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-4" style="padding-left:35px">
                                                ...
                                                <div class="form-group">
                                                    <input class="form-check-input" name="enable_gallery_of_leaders" value="1"
                                                        ...
                                                        {{ $details[0]->enable_gallery_of_leaders == 1 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-4" style="padding-left:35px">
                                                ...
                                                <div class="form-group">
                                                    <input class="form-check-input" name="enable_arts_culture" value="1"
                                                        ...
                                                        {{ $details[0]->enable_arts_culture == 1 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-4" style="padding-left:35px">
                                                <div class="form-group">
                                                    <input class="form-check-input" name="enable_shopping" value="1"
                                                        ...
                                                        {{ $details[0]->enable_shopping == 1 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-4" style="padding-left:35px">
                                                ...
                                                <div class="form-group">
                                                    <input class="form-check-input" name="enable_top_city_news" value="1"
                                                        ...
                                                        {{ $details[0]->enable_top_city_news == 1 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-4" style="padding-left:35px">
                                                ...
                                                <div class="form-group">
                                                    <input class="form-check-input" name="enable_city_guide" value="1"
                                                        ...
                                                        {{ $details[0]->enable_city_guide == 1 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-4" style="padding-left:35px">
                                                <div class="form-group">
                                                    <input class="form-check-input" name="enable_city_management" value="1"
                                                        ...
                                                        {{ $details[0]->enable_city_management == 1 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-4" style="padding-left:35px">
                                                <div class="form-group">
                                                    <input class="form-check-input" name="enable_setting_xchange" value="1"
                                                        ...
                                                        {{ $details[0]->enable_setting_xchange == 1 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-4" style="padding-left:35px">
                                                <div class="form-group">
                                                    <input class="form-check-input" name="enable_setting_birthplace_city_project" value="1"
                                                        ...
                                                        {{ $details[0]->enable_setting_birthplace_city_project == 1 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-4" style="padding-left:35px">
                                                <div class="form-group">
                                                    <input class="form-check-input" name="enable_setting_art_and_culture" value="1"
                                                        ...
                                                        {{ $details[0]->enable_setting_art_and_culture == 1 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-4" style="padding-left:35px">
                                                <div class="form-group">
                                                    <input class="form-check-input" name="enable_setting_diaspo_connection" value="1"
                                                        ...
                                                        {{ $details[0]->enable_setting_diaspo_connection == 1 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-4" style="padding-left:35px">
                                                <div class="form-group">
                                                    <input class="form-check-input" name="enable_setting_top_city_news" value="1"
                                                        ...
                                                        {{ $details[0]->enable_setting_top_city_news == 1 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-4" style="padding-left:35px">
                                                <div class="form-group">
                                                    <input class="form-check-input" name="enable_setting_faith_connection" value="1"
                                                        ...
                                                        {{ $details[0]->enable_setting_faith_connection == 1 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-4" style="padding-left:35px">
                                                <div class="form-group">
                                                    <input class="form-check-input" name="enable_setting_board_of_leaders" value="1"
                                                        ...
                                                        {{ $details[0]->enable_setting_board_of_leaders == 1 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-4" style="padding-left:35px">
                                                <div class="form-group">
                                                    <input class="form-check-input" name="enable_setting_city_management" value="1"
                                                        ...
                                                        {{ $details[0]->enable_setting_city_management == 1 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-4" style="padding-left:35px">
                                                <div class="form-group">
                                                    <input class="form-check-input" name="enable_setting_shopping" value="1"
                                                        ...
                                                        {{ $details[0]->enable_setting_shopping == 1 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-4" style="padding-left:35px">
                                                <div class="form-group">
                                                    <input class="form-check-input" name="enable_setting_city_guide" value="1"
                                                        ...
                                                        {{ $details[0]->enable_setting_city_guide == 1 ? 'checked' : '' }}>
                                        ...
                                        <div class="row gy-4">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control"  placeholder="0" name="number" id="number" value="{{ isset($user_birthplace_number->description) ? $user_birthplace_number->description : 0 }}" >
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control"  placeholder="0" name="diaspo_connection_number" id="diaspo_connection_number" value="{{ isset($diaspo_connection_number->description) ? $diaspo_connection_number->description : 0 }}" >
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control"  placeholder="0" name="arts_and_culture_number" id="arts_and_culture_number" value="{{ isset($arts_and_culture_number->description) ? $arts_and_culture_number->description : 0 }}" >
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control"  placeholder="0" name="my_faith_number" id="my_faith_number" value="{{ isset($my_faith_number->description) ? $my_faith_number->description : 0 }}" >
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control"  placeholder="0" name="top_city_news_number" id="top_city_news_number" value="{{ isset($top_city_news_number->description) ? $top_city_news_number->description : 0 }}" >
                                                </div>
                                            </div>
                                        </div>
                                        <div class="clearfix"></div>
									...
									@if($details[0]->code != null || $sponsor_email != null)
									<div class="clearfix"></div>	
								...
								<div class="form-group">
									...
									<input style="width: 18rem" class="form-control" placeholder="" onchange="getPhoneNo()" id="cellphone" name="format-cellphone" value="<?= $details[0]->cellphone ?>" type="tel" value="{{old('cellphone')}}" required>
