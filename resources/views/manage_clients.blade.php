            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12">
                    <div class="heading-title heading-dotted col-md-12 margin-bottom-20 text-center">
                        <h4>Client Management / Manage Client Profile</h4>
                    </div>
                    ...
                    <div class="col-md-12">
                        <ul class="nav nav-tabs nav-button-tabs nav-justified">
                            <li class="active"><a href="{{ url('manage_clients') }}">Client List</a></li>
                            <li><a href="{{ url('view_client_profiles') }}">Profile Details</a></li>
                        </ul>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="datatable_sample">
                                    ...
                                    ?>
                                        <tr class="odd gradeX">
                                            ...
                                            <td><?= $value->status ?></td>
                                            <td>
                                                <form action="{{ url('edit_clientf') }}" method="post"
                                                    style="padding: 0; float: left;">
                                                    @csrf
                                                    <input type="hidden" name="id" value="<?= $value->id ?>">
                                                    <input type="submit" class="btn btn-xs btn-success" value="Edit">
                                                </form>
                                                <a href="{{ url('delete_clientf') }}/<?= $value->id ?>"
                                                    class="btn btn-xs btn-danger" style="float: left;">Delete</a>
                                                <a href="{{ url('appointment_step3') }}/{{ $value->id }}"
                                                    class="btn btn-xs btn-info" style="float: left;">Make Appointment</a>
                                            </td>
                                        </tr>
                                        <?php
                                        }
