        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12">
                ...
                <ul class="nav nav-tabs nav-button-tabs nav-justified" style="">
                    <li class="active"><a href="#tab1" data-toggle="tab">Revenue Deletion</a></li>
                    <li><a href="#tab2" data-toggle="tab">Expense Deletion</a></li>
                    <li><a href="#tab3" data-toggle="tab">Assets Deletion</a></li>
                </ul>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#monthlyrevenuelist").change(function(){
            // alert($(this).val());
            var year = $(this).val();
            var url = "<?php echo url('/'); ?>/monthlyrevenuelistappointmentt";
        ...
        $("#monthlyexpenseslist").change(function(){
            // alert($(this).val());
            var year = $(this).val();
            var url = "<?php echo url('/'); ?>/monthlyexpenseslistappointmentt";
        ...
        $("#monthlyassetlist").change(function(){
            // alert($(this).val());
            var year = $(this).val();
            var url = "<?php echo url('/'); ?>/monthlyassetlistappointmentt";
