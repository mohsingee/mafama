        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12">
                <div class="heading-title heading-dotted col-md-12 margin-bottom-20 text-center">
                    <h4>Financial Managemnet / Profir-Loss</h4>
                </div>
                        ...
                        <script type="text/javascript">
                              $(function () {
                                    ...
                                    var bar = new Morris.Bar({
                                      ...
                                      resize: true,
                                      data: [
                                        {y: 'Jan-Mar', a: <?= $janmarothrevenue ?>, b: <?= $janmarotherrevenue ?>},
                                        {y: 'Apr-Jun', a: <?= $aprjunothrevenue ?>, b: <?= $aprjunotherrevenue ?>},
                                        {y: 'Jul-Sep', a: <?= $julsepothrevenue ?>, b: <?= $julsepotherrevenue ?>},
                                        {y: 'Oct-Dec', a: <?= $octdecothrevenue ?>, b: <?= $octdecotherrevenue ?>}
                                      ],
