		...
		<div class="nk-content-inner">
			<div class="nk-content-body">
				<div class="nk-block-head-content" style="margin-bottom:20px;">
					<h3 class="nk-block-title page-title">Archives Banner</h3>
					...
					<div class="card card-bordered card-stretch">
                        <div class="card-aside-wrap">
							<div class="card-inner card-inner-lg">
								@if(permission_access('archives_mgmt_add')==1)
								<form id="" action="{{ url('archives_banner_entry') }}" method="POST" enctype="multipart/form-data">	
									@csrf
									<div class="row gy-4">
										<div class="col-md-1">
									...
									<tbody>
										...
										<tr class="nk-tb-item">
											...
											<td class="nk-tb-col tb-col-md">
												...
												<a href="<?php echo url('editarchives_banner') ?>/<?= $banner->id ?>" class="btn btn-sm btn-primary">Edit</a>
												@endif
												@if(permission_access('archives_mgmt_delete')==1)
												<a href="<?php echo url('deletearchives_banner') ?>/<?= $banner->id ?>" class="btn btn-sm btn-danger">Delete</a>
												@endif
											</td>
										</tr>
										<?php 
