...
$(document).ready(function(){
    ...
    $("#register").submit(function(e) {
        ...
        .then( function( data ) {
            ...
            $.ajax({
                url: 'banner_submit',
                data: 'preview=' + preview + '&background=' + bgcolor + '&message=' + message + '&fontcolor=' + fncolor + '&img=' + img + '&business_name=' + business_name + '&address=' + address + '&phone_no=' + phone_no + '&web_address=' + web_address + '&_token={{ csrf_token() }}',
                type: "POST",
                success: function (response) {
                    location.reload();
