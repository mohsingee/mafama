                ...
                <div class="row margin-top-10 margin-bottom-10">
                    <div class="col-md-3" style="padding-right: 0px;">
                        <div style="">
                            <div style="margin: auto;">
                                 ...
                                 <source src="<?php if(!empty($top_videos[0]->video)){ echo asset("public/videos") ?>/<?= $top_videos[0]->video ?><?php } ?>" type="video/mp4">
                                </video>
                            </div>
                    ...
                    <div class="col-md-3" style="padding-left: 0px;">
                        <div style="">
                            <div style="margin: auto;">
                                <video width="100%" controls>
                                  <source src="<?php if(!empty($top_videos[0]->video)){ echo asset("public/videos") ?>/<?= $top_videos[1]->video ?><?php } ?>" type="video/mp4">
                                </video>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <li>
                                             ...
                                             <li>
                                                <?php
                                                    if($links[35]->status == "on"){
                                                ?>
                                                        <a href="{{ url('get_genealogy_report') }}"><i class="fa fa-caret-square-o-right"></i> Genealogy Report</a>
                                                <?php
                                                    }
                                                ?>
                                            </li>
