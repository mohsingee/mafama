            ...
            <div id="topBar">
                <div class="container">
                                <nav class="nav-main" style="text-align: center;">
                                    <ul id="" class="nav nav-pills text-danger nav-main text-center" style="display: inline-block;">
                                            <li class="margin-right-10"><input name="en" value="en" class="language_check mr-4" type="checkbox" {{ ($lang_code == "en") ? "checked" : "" }} /> <img class="flag-lang language_flags" src="{{ asset('assets/images/flags/us.png') }}" alt="lang" /> English</a></li>
                                            <li class="margin-right-10"><input name="es" value="es" class="language_check mr-4" type="checkbox" {{ ($lang_code == "es") ? "checked" : "" }} /> <img class="flag-lang language_flags" src="{{ asset('assets/images/flags/es.png') }}" alt="lang" /> Espagnol</a></li>
                                            <li class="margin-right-10"><input name="fr" value="fr" class="language_check mr-4" type="checkbox" {{ ($lang_code == "fr") ? "checked" : "" }} /> <img class="flag-lang language_flags" src="{{ asset('assets/images/flags/fr.png') }}" alt="lang" /> Francais</a></li>
                                            <li class="margin-right-10"><input name="ht" value="ht" class="language_check mr-4" type="checkbox" {{ ($lang_code == "ht") ? "checked" : "" }} /> <img class="flag-lang language_flags" src="{{ asset('assets/images/flags/ht.png') }}" alt="lang" /> Kreyol Haiten</a></li>
                                            <li class="margin-right-10"><input name="ar" value="ar" class="language_check mr-4" type="checkbox" {{ ($lang_code == "ar") ? "checked" : "" }} /> <img class="flag-lang language_flags" src="{{ asset('assets/images/flags/sa.png') }}" alt="lang" /> Arabic</a></li>
                                            <li class="margin-right-10"><input name="pt" value="pt" class="language_check mr-4" type="checkbox" {{ ($lang_code == "pt") ? "checked" : "" }} /> <img class="flag-lang language_flags" src="{{ asset('assets/images/flags/pt.png') }}" alt="lang" /> Portuguese</a></li>
                                            <li class="margin-right-10"><input name="ko" value="ko" class="language_check mr-4" type="checkbox" {{ ($lang_code == "ko") ? "checked" : "" }} /> <img class="flag-lang language_flags" src="{{ asset('assets/images/flags/kr.png') }}" alt="lang" /> Korean</a></li>
                                            <li class="margin-right-10"><input name="sw" value="sw" class="language_check mr-4" type="checkbox" {{ ($lang_code == "sw") ? "checked" : "" }} /> <img class="flag-lang language_flags" src="{{ asset('assets/images/flags/tz.png') }}" alt="lang" /> Swahili</a></li>
                                            <li class="margin-right-10"><input name="de" value="de" class="language_check mr-4" type="checkbox" {{ ($lang_code == "de") ? "checked" : "" }} /> <img class="flag-lang language_flags" src="{{ asset('assets/images/flags/de.png') }}" alt="lang" /> German</a></li>
                                    </ul>
                                </nav>
                    <div class="row">
