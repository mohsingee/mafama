									...
									<tbody>
										...
										?>
												<tr class="nk-tb-item">
													...
													<td class="nk-tb-col tb-col-md">
														<a href="{{ url('view_affilates_registration') }}/<?= $value->id ?>" class="btn btn-sm btn-primary">View</a>
														<a href="{{ url('edit_affilates_registration') }}/<?= $value->id ?>" class="btn btn-sm btn-primary">Edit</a>
														<a  data-email="<?= $value->email ?>" href="javascript:void(0)" class="btn btn-sm btn-danger deleteaffiliate" data-list="affiliate_registrations">Delete</a>
													</td>
