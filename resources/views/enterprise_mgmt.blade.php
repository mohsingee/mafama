                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title"  style="width:980px;">Enterprise Management
								<a href="add_enterprise_mgmt.php" class="btn btn-sm btn-primary" style="float:right;">Add New</a>
							</h3>
								...
								<table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
									...
									<tbody>
										<tr class="nk-tb-item">
											...
											<td class="nk-tb-col tb-col-md">
												<a href="view_enterprise_mgmt.php" class="btn btn-xs btn-primary">View</a>
												<a href="add_enterprise_mgmt.php" class="btn btn-xs btn-primary">Edit</a>
