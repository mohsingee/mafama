							...
							<div class="card-inner card-inner-xl">
								...
								<table class="table">
									...
									<tbody>
										...
										<tr>
											<td style="border:0px!important;padding-left:0px;">Country Of Birth
												<span class="bfh-countries form-control" data-country="<?= $details[0]->birth_country ?>" style="background: aliceblue;text-align: left;"></span>
											</td>
																									
											<td style="border:0px!important; @if($details[0]->birth_country != "HT") display:none @endif">Commune<input type="text" class="form-control" value="{{(isset($details[0]->birth_commune)) ? showcommuneName($details[0]->birth_commune) : ''}}" disabled></td>
																									
											<td style="border:0px!important; @if($details[0]->birth_country == "HT") display:nonel @endif">State
												<span class="bfh-states form-control" data-country="<?= $details[0]->birth_country ?>" data-state="<?= $details[0]->birth_state ?>" style="background: aliceblue;text-align: left;"></span>
											</td>
										...
										<tr>
											...
											<td style="border:0px!important;padding-right:0px;">Country Of Residense
												<span class="bfh-countries form-control" data-country="<?= $details[0]->country ?>" style="background: aliceblue;text-align: left;"></span>
											</td>
																									
										</tr>
										 @if($details[0]->commune!=NULL && $details[0]->department!=NULL  && $details[0]->arrondissement!=NULL)
										<tr>
										...
										<tr>
											...
											<td style="border:0px!important;padding-right:0px;">Religious Faith<input type="text" class="form-control" value="@if($details[0]->religion!="Other")<?= $details[0]->religion ?>@else {{ $details[0]->otherreligion }} @endif" disabled></td>														
										</tr>
