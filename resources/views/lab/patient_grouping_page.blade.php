                        ...
                        <div class="tab-pane fade in active" id="tab1">
                           <!--  <form id="" class="" method="POST" role="form" enctype="multipart/form-data">
                             ...
                             <div class="col-md-12 padding-0 text-center margin-bottom-0" style="margin-bottom: 0px;padding-bottom: 0px">
                                        <h4 style="margin-bottom: 0px;">Patient Grouping</h4>
                            </div>
                            ...
                            <div class="col-md-12">
                                <table class="table table-striped table-bordered table-hover" id="sample_editable_0001">
                                    <thead>
                                        <tr>
                                            <th class="text-center">Grouping by condition</th>
                                            <th> Patient</th>
