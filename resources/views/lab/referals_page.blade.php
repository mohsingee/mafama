                        ...
                        <div class="tab-pane fade in active" id="tab1">
                            <form id="" class="" method="POST" role="form" enctype="multipart/form-data">
                                ...
                                <div class="col-md-12" style="border-radius: 10px; padding: 0px; padding-top: 10px; padding-bottom: 20px;">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                           ...
                                           <input type="text" class="form-control" name="reason" required="" placeholder="Reason"  />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-label">Primary Concerns</label>
                                            <input type="text" class="form-control" name="primary_concern" required="" placeholder="Primary Concern"  />
                                        </div>
                                    </div>
                                   </div>
                             ...
                             <div class="col-md-12 padding-0 text-center margin-bottom-0" style="margin-bottom: 0px;padding-bottom: 0px">
                                        <h4 style="margin-bottom: 0px;">Referrals</h4>
                            </div>
