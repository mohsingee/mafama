                        ...
                        <script type="text/javascript">
                              $(function () {
                                    ...
                                    var bar = new Morris.Bar({
                                      ...
                                      data: [
                                      <?php
                                        foreach ($chart_months as $rec) {
                                         $current_value=$total = \App\TestComparision::get_test_coparision_current_value($component_id,$client_id, $rec->created_at);
                                         ?>
                                        {y: "<?=date('M d - Y',strtotime($rec->created_at));?>", a:'<?=$standard_value;?>' , b: '<?=$current_value;?>'},
                                       <?php } ?>
                                      ...
                                      xkey: 'y',
                                      ykeys: ['a', 'b'],
                                      labels: ['Standard Value','Current Value'],
                                      hideHover: 'auto',
                                      xLabelMargin: 10,
                                      padding: 30,
                                    });
