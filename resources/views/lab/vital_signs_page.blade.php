                            ...
                            <form action="{{ url('vital_signs_add_edit_post') }}" class="" method="POST" role="form" enctype="multipart/form-data">
                                ...
                                <div class="col-md-12" style="border-radius: 10px; padding: 0px; padding-top: 10px; padding-bottom: 20px;">
                                          ...
                                          <tbody>
                                              <tr>
                                                  ...
                                                  <td width="30%">
                                                    ...
                                                    <span class="input_field">                 
                                                    <input type="text" class="form-control txt1" name="weight_unit"  placeholder="Ex.kg" value="{{$form ? $form->weight_unit:''}}" style="width: 130px;height:28px!important;margin-top: -20px;font-size: 10px" >
                                                    </span>
                                                   </td>
                                                    <td width="40%">
                                    ...
                                    <div class="col-md-12 text-center" style="margin-top: 25px;">
                                        ...
                                        <button type="submit" class="btn btn-sm btn-info" >{{$form ?'Update':'Submit'}}</button>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="sample_editable_1">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$lab->name}}</td>
                                            <td>{{$lab->weight}} {{$lab->weight_unit}}</td>
                                            <td>{{$lab->height}}</td>
                                            ...
                                            <td>{{$lab->spo2}}</td>
                                             ...
                                             <td>
                                            <a href="{{ url('lab/vital-signs-edit/'.$lab->id.'/'.$uid) }}" class="btn btn-xs btn-success" style="padding-top: 5px">Edit</a>
