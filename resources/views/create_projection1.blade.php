                                                        ...
                                                        ?>
                                                                <tr class="odd gradeX monthly" id="row<?= $value->id ?>">
                                                                    ...
                                                                    <td class="showgraph" id="showgraph<?= $value->id ?>">
                                                                        <a href="{{ url('monthly_projection_chart') }}/<?= $value->id ?>"><div id="bar-chart<?= $value->id ?>" style="height: 20px; width: 50px"></div></a>
                                                    ...
                                                    <tbody class="sectbody" <?= $style ?>>
                                                        <tr class="odd gradeX">
                                                            ...
                                                            <td class="chart_monthly">
                                                                <a href="{{ url('total_monthly_projection_chart') }}"><div id="bar-chart_total" style="height: 20px; width: 50px"></div></a>
                                                                        <script type="text/javascript">
                                                                          $(function () {
                                                                                "use strict";
                                                ...
                                                ?>
                                                        <tr class="odd gradeX quarterly" id="roww<?= $value->id ?>">
                                                            ...
                                                            <td class="showgraphq" id="showgraphq<?= $value->id ?>">
                                                                <a href="{{ url('quarterly_projection_chart') }}/<?= $value->id ?>"><div id="bar-chartq<?= $value->id ?>" style="height: 20px; width: 30px"></div></a>
                                                                <script type="text/javascript">
                                                                  $(function () {
                                                                        "use strict";
                                            ...
                                            <tbody class="sectbody2" <?= $style2 ?>>
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td class="chart_quarterly">
                                                        <a href="{{ url('total_quarterly_projection_chart') }}"><div id="bar-chart_totalq" style="height: 20px; width: 30px"></div></a>
                                                        <script type="text/javascript">
                                                          $(function () {
                                                                "use strict";
