                     ...
                     <div class="col-md-12">
                         ...
                         <div class="col-md-12"
                             ...
                             <div class="col-md-6">
                                 ...
                                 <form action="{{ url('add_user_birthplace_details') }}" method="POST" id=""
                                     ...
                                     <tr>
                                         ...
                                         <td width="20%">
                                             <a class="btn btn-xs btn-success"
                                                 href="{{ url('edit_user_birthplace_details') . '/' . $value->id }}">Edit</a>
                                             <form action="{{ url('delete_user_birthplace_details') }}" method="POST"
