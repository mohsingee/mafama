                        ...
                        <script type="text/javascript">
                              $(function () {
                                    ...
                                    var bar = new Morris.Bar({
                                      ...
                                      resize: true,
                                      data: [
                                        {y: 'Jan', a: <?= $jantotal - $jantotall ?>},
                                        {y: 'Feb', a: <?= $febtotal - $febtotall ?>},
                                        {y: 'Mar', a: <?= $martotal - $martotall ?>},
                                        {y: 'Apr', a: <?= $aprtotal - $aprtotall ?>},
                                        {y: 'May', a: <?= $maytotal - $maytotall ?>},
                                        {y: 'Jun', a: <?= $juntotal - $juntotall ?>},
                                        {y: 'Jul', a: <?= $jultotal - $jultotall ?>},
                                        {y: 'Aug', a: <?= $augtotal - $augtotall ?>},
                                        {y: 'Sep', a: <?= $septotal - $septotall ?>},
                                        {y: 'Oct', a: <?= $octtotal - $octtotall ?>},
                                        {y: 'Nov', a: <?= $novtotal - $novtotall ?>},
                                        {y: 'Dec', a: <?= $dectotal - $dectotall ?>}
                                      ],
                                      barColors: ['#da291c'],
                                      xkey: 'y',
                                      ykeys: ['a'],
