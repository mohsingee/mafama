            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12">
                    <div class="heading-title heading-dotted col-md-12 margin-bottom-20 text-center">
                        <h4>Email Management / Send Videos</h4>
                    </div>
                    ...
                    <div class="col-md-12">
                        <!--<ul class="nav nav-tabs nav-button-tabs nav-justified">
                                        <li><a href="email_campaign.php" >Email Campaigns</a></li>
                                        <li><a href="send_cards.php" >Send Card</a></li>
                                        <li><a href="send_video.php" >Send Videos</a></li>
                                        <li><a href="{{ url('chat') }}">Chat</a></li>
                                        <li class="active"><a href="send_sms.php" >Send SMS</a></li>
                                            ...
                                            <div class="col-md-10 padding-0">
                                                <div class="fancy-file-upload fancy-file-danger">
                                                    ...
                                                    <input type="file" class="form-control" name="img_path"
                                                        ...
                                                        id="img_path" accept="video/*" required />
                        ...
                        if (submit_value == "Send Now") {
                            ...
                            if ($("#reminderdate").val() == "") {
                                ...
                                $.ajax({
                                    ...
                                    url: "send_video_send_with_reminder",
                                    data: formData,
                                    contentType: false,
                                    cache: false,
                                    processData: false,
