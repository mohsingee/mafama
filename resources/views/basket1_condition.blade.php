		...
		<div class="nk-content-inner">
			<div class="nk-content-body">
				<div class="nk-block-head-content" style="margin-bottom:20px;display:flex;">
					<h3 class="nk-block-title page-title"   style="width:900px;">Move Leads to Basket1</h3>
					...
					<div class="card card-bordered card-stretch">
						<div class="card-inner-group">
							...
							<div class="card-inner">
							    	<!--<a class="btn btn-sm btn-success pull-right" href="{{ route('basket-condition',['basket'=>1,'id'=>''])}}">Add New </a>-->
								<div class="">
								    ...
								    @if(!empty($baskets))	
								      @foreach($baskets as $basket)	
										<tr class="nk-tb-item">
											...
											<td class="nk-tb-col">
												@if(permission_access('move_leads_basketone_edit')==1)
												<a href="
												{{ route('basket-condition',['basket'=>1,'id'=>$basket->id])}}" class="btn btn-xs btn-success">Edit</a>
												@endif
											</td>
