                                ...
                                <div class=" card-inner-lg" style="background-color:#fff">
                                    ...
                                    <div class="row" style="border: 1px solid #da291c !important; padding-top:30px;margin-bottom:30px; ">
                                        <div class="col-md-12">
                                            ...
                                            <form action="{{ url('update_admin_birthplace_details_headings') }}" method="POST"
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="primary"
                                                                @if (isset($primary_heading) && $primary_heading->upload_type == 'heading') value="{{ $primary_heading->description ?? '' }}" @endif>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="secondary"
                                                                @if (isset($secondary_heading) && $secondary_heading->upload_type == 'heading') value="{{ $secondary_heading->description ?? '' }}" @endif>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="footer"
                                                                @if (isset($footer_heading) && $footer_heading->upload_type == 'heading') value="{{ $footer_heading->description ?? '' }}" @endif>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control editor1 description" id="description" name="description" style="height: 70px;">
                                                                @if (isset($description_heading) && $description_heading->upload_type == 'heading'){{ $description_heading->description ?? '' }}@endif
                                                            </textarea>
                                                        </div>
                                                    </div>
                                                    @if (isset($primary_heading) && $primary_heading->upload_type == 'heading')
                                                        <input type="hidden" class="form-control" name="actions"
                                                            value="update">
                                                        <input type="hidden" class="form-control" name="primary_heading"
                                                            value="{{ isset($primary_heading) ? $primary_heading->id : '' }}">
                                                        <input type="hidden" class="form-control" name="secondary_heading"
                                                            value="@if (isset($secondary_heading) && $secondary_heading->upload_type == 'heading'){{ $secondary_heading->id ?? '' }}@endif">
                                                        <input type="hidden" class="form-control" name="footer_heading"
                                                            value="@if (isset($footer_heading) && $footer_heading->upload_type == 'heading'){{ $footer_heading->id ?? '' }}@endif">
                                                        <input type="hidden" class="form-control"  name="description_heading"
                                                            value="@if (isset($description_heading) && $description_heading->upload_type == 'heading'){{ $description_heading->id ?? '' }}@endif">
                                                    @endif
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <form action="{{ url('add_admin_birthplace_details') }}" method="POST"
                                                id="" enctype="multipart/form-data">
                                                @csrf
                                                <div class="col-md-12"
                                                    style="border-radius: 10px; padding: 0px; padding-top: 10px; padding-bottom: 20px;">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="20%">
                                                        ...
                                                        <form action="{{ url('delete_admin_birthplace_details') }}"
                                                            method="POST" id="" enctype="multipart/form-data"
                                                            style="display: inline-flex;">
                                                            @csrf
                                                            <a class="btn btn-xs btn-info"
                                                                href="{{ url('edit_admin_birthplace_details') . '/' . $value->id }}">Edit</a>
                                                            &nbsp;
