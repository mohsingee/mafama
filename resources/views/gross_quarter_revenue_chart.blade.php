        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12">
                <div class="heading-title heading-dotted col-md-12 margin-bottom-20 text-center">
                    <h4>Financial Managemnet / Profit-Loss</h4>
                </div>
                        ...
                        <script type="text/javascript">
                              $(function () {
                                    ...
                                    var bar = new Morris.Bar({
                                      ...
                                      resize: true,
                                      data: [
                                        {y: 'Jan-Mar', a: <?= $janmargrosstotal2 ?>, b: <?= $janmargrossactual ?>},
                                        {y: 'Apr-Jun', a: <?= $aprjungrosstotal2 ?>, b: <?= $aprjungrossactual ?>},
                                        {y: 'Jul-Sep', a: <?= $julsepgrosstotal2 ?>, b: <?= $julsepgrossactual ?>},
                                        {y: 'Oct-Dec', a: <?= $octdecgrosstotal2 ?>, b: <?= $octdecgrossactual ?>}
                                      ],
