...
<div class="container">
  ...
  <div class="row">
    <div class="col-sm-12">
       <div class="shadow1">
<div class="row">
    <h3 class="text-center"> {{$video->heading}}</h3>
<p> {{$video->sub_heading}}</p>
  ...
  <div class="row button-wrap mt">
        ...
        <a href="{{$video->register_link}}" class="btn-green elButton" id="on-pageload" data-micromodal-trigger="checkout"   >
          <span class="top"><i class="fas fa-angle-double-right"></i> {{$video->link_text}} <i class="fas fa-angle-double-left"></i></span>
    ...
    <div class="row watch">
     ...
     <div class="row button-wrap mt">
        ...
        <a href="{{!empty($link)?url('affiliate_registration/'.$link):$video->register_link}}" class="btn-pink elButton" id="on-pageload" data-micromodal-trigger="checkout"   >
          <span class="top"><i class="fas fa-angle-double-right"></i> {{$video->title_bar}} <i class="fas fa-angle-double-left"></i></span>
...
var timer2 = "{{$video->clock_duration}}";
