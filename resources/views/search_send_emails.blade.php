	...
	<div class="container-fluid">
        ...
        <a class="right carousel-control next" href="javascript:void(0)" ><i class="glyphicon glyphicon-chevron-right"></i></a> -->
                        ...
                        <ul class="nav nav-tabs activetab" style="">
                           <li class="nav-item">
                              <a class="btn-xs nav-link active" data-id="sendEmail" data-toggle="tab" href="#sendEmail">Send Email</a>
                           </li>
                           <li class="nav-item">
                           ...
                           <div class="col-md-12 padding-0  parent-<?= $value->category ?>">
                             ...
                             foreach ($imgs as $img) { ?>
                                 <div class="col-md-12 hide-child  child-<?= $value->category ?>" style="margin-bottom: 10px;border: 1px solid #da291c; border-radius: 3px; padding: 5px 10px;">
                                      <img src="<?php echo asset('public/images')?>/<?= $img->image ?>" alt="" class="script_img" style="width: 50px; height: 50px" />
   ...
   <div class="col-md-12">
      ...
      <ul class="nav nav-tabs nav-tabs-s2">
       <?php
         ...
         ?>
          <li class="nav-item ">
      <a class="nav-link <?php if($c == 0){echo 'active';} ?>"  href="#card_<?= $value->category ?>" data-toggle="tab"><?= $value->category ?></a></li>
      <?php
      $c++;
          }
      ?>
         ...
         <div class="row gy-4">
            <div class="col-md-12">
               <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="Subject" id="subject3" name="subject" required />
               </div>
            </div>
            <div class="col-md-12">
 ...
 <div class="row">
     ...
     <div class="col-md-12 reminderon1" style="margin-top: 10px; display: none;">
         <div class="row">
             ...
             <div class="col-md-4" style="padding: 0; ">
                 <a class="btn btn-xs btn-info subbtn1" style="height: 40px; width: 100%; padding: 8px; font-size: 14px;">Save</a>
             </div>
         </div>
     </div>
 </div>
...
<div class="col-md-12 text-center" style="padding: 15px">
 <span style="color: green; font-size: 15px; font-weight: 600;" id="success_card1"></span>
   ...
   <div class="tab-pane" id="sendVideos" style="border-top:1px solid #cecece;padding-top:10px;">
      ...
      <div class="col-md-12">
      <form id="admin_manage_client_video_submit" method="post" enctype="multipart/form-data">
      	@csrf
         <div class="row gy-4">
   <input type="hidden" class="form-control malto" placeholder="To" name="malto" value="" />
            <div class="col-md-12">
   ...
   $("#client_manage_submit").submit(function(e) {
      ...
      if(submit_value == "Send Now") {
         $.ajax({
            ...
            url: "<?php echo url('/'); ?>/admin_manage_client_submit",
            data: formData,
            contentType: false,
            cache: false,
            processData: false,
               ...
               $("#wrapper").show();
                        ...
                        if($("#sendon").val() == "")
                        {
                            ...
                            $.ajax({
                              ...
                              url: "<?php echo url('/'); ?>/admin_manage_client_send_on",
                              data:  formData,
                                contentType: false,
                                cache: false,
                                processData:false,
                        ...
                        else if($("#remindertime").val() == "")
                        {
                            ...
                            $.ajax({
                              ...
                              url: "<?php echo url('/'); ?>/admin_manage_client_send_with_reminder",
                              data:  formData,
                                contentType: false,
                                cache: false,
                                processData:false,
