					...
					<div class="card card-bordered card-stretch">
                        <div class="card-aside-wrap">
							<div class="card-inner card-inner-lg">
								<form id="" action="{{ url('popup2_entry') }}" method="POST" enctype="multipart/form-data">	
								@csrf
									<div class="row gy-4">
										<div class="col-md-6">
									...
									<tbody>
										...
										<tr class="nk-tb-item">
											...
											<td class="nk-tb-col tb-col-md">
												<a href="<?php echo url('editpopup2') ?>/<?= $popup->id ?>" class="btn btn-sm btn-primary">Edit</a>
												<a href="<?php echo url('deletepopup2') ?>/<?= $popup->id ?>" class="btn btn-sm btn-danger">Delete</a>
											</td>
