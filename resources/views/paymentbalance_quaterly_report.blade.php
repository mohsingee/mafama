...
<style type="text/css">
    ...
    input#reminderdate2::-webkit-calendar-picker-indicator {
       ...
       .active1 {
    background: rgb(154, 19, 9)!important;
}
th#qty_record {
    cursor: pointer;
}
                ...
                <div class="tab-content margin-top-10" style="border: 1px solid #da291c !important; border-radius: 10px; padding: 10px;">
                    <div class="col-md-12">
                        <ul class="nav nav-tabs nav-button-tabs nav-justified">
                            <li ><a href="{{url('paymentbalance_report')}}" >Monthly</a></li>
                            <li class="active"><a href="#quarterly" data-toggle="tab">Quarterly</a></li>
                     ...
                     <div class="col-md-12">
                        <div class="tab-content margin-top-10" style="border: 1px solid #da291c !important; border-radius: 10px; padding: 20px;">
                            ...
                            <div class="tab-pane fade in active" id="quarterly">
                                <table class="table table-striped table-bordered table-hover">
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <th id="qty_record" data-id="01" @if($cmonth >=1 && $cmonth < 4) class="active1"  @endif>Jan-Mar</th>
                                            <th id="qty_record" data-id="04"  @if($cmonth >=4 && $cmonth < 7) class="active1"  @endif>Apr-Jun</th>
                                            <th id="qty_record" data-id="07"  @if($cmonth >=7 && $cmonth < 10) class="active1"  @endif>Jul-Sep</th>
                                            <th id="qty_record" data-id="10"  @if($cmonth >=10 && $cmonth <= 12) class="active1"  @endif>Oct-Dec</th>
                    ...
                    <input type="checkbox" class="group-checkable" data-set="#datatable_sample checkboxes" />
                                    ...
                                    // dd($client);
                                        foreach($client as $value){
                                           $month = date('m');
                                            $bill_amount=\App\Http\Controllers\MainController::get_quarter_paymentbalance_info($value->email,$month,'bill');
                                            $discount=\App\Http\Controllers\MainController::get_quarter_paymentbalance_info($value->email,$month,'discount');
                                            $tax_amount=\App\Http\Controllers\MainController::get_quarter_paymentbalance_info($value->email,$month,'tax');
                                            $shipping_amount=\App\Http\Controllers\MainController::get_quarter_paymentbalance_info($value->email,$month,'shipping');
                                            $total_amount=\App\Http\Controllers\MainController::get_quarter_paymentbalance_info($value->email,$month,'total');
                                            $paid_amount=\App\Http\Controllers\MainController::get_quarter_paymentbalance_info($value->email,$month,'amount_paid');
                                            $balance_amount=\App\Http\Controllers\MainController::get_quarter_paymentbalance_info($value->email,$month,'balance');
                                                $total = 0;
                                                  if($paid_amount > 0){
                                                  if($balance_amount != 0){
                                                 ?>
                                        ...
                                        <tr class="" style="background: #800080">
                                            ...
                                            <td class="fixed-side" style="color:white !important; font-weight:bold">Total</td>
                                            <td class="fixed-side" style="color:white !important; font-weight:bold">{{$temp}}</td>
                                            <td class="fixed-side" style="color:white !important; font-weight:bold">{{$temp_d}}</td>
                                            <td class="fixed-side" style="color:white !important; font-weight:bold">{{$temp2}}</td>
                                            <td class="fixed-side" style="color:white !important; font-weight:bold">{{$temp3}}</td>
                                            <td class="fixed-side" style="color:white !important; font-weight:bold">{{$temp4}}</td>
                                            <td class="fixed-side" style="color:white !important; font-weight:bold">{{$temp5}}</td>
                                            <td class="fixed-side" style="color:white !important; font-weight:bold">{{$temp6}}</td>
                                        </tr>
                                            ...
                                            <tr class="odd gradeX">
                                                ...
                                                $tot = 0;
                                                    foreach ($months_arr as $valuee) {
                                                        $balance = \App\Http\Controllers\MainController::get_quarter_paymentbalance($valuee, $value->email);

                                                        $tot += $balance;


                                                        if($balance > 0){
                                                            echo '<td><a class="revenue_quarter" id="'.$valuee.'revenue_quarter'.$value->email.'" style="color:red">'.$balance.'</a></td>';
                                                        }
                                                        else{
                                                            echo '<td>'.$balance.'</td>';
                                                        }
...
<script type="text/javascript">
    ...
    $(document).on('click','.revenue_quarter',function(){
        ...
        if($(this).html() != 0){
            ...
            var url = "<?php echo url('/'); ?>/paymentbalancequaterlyrevenuequarterdetails";
...
$(document).on('click','#qty_record',function(){
    $("#monthly_details2").html("");
   $("#qty_record").removeClass('active1');
   $('.active1').removeClass('active1');
   var month =$(this).attr("data-id");
              $(this).addClass("active1");
      $("#revenue_records").html("");
        if($(this).html() != 0){
            var url = "<?php echo url('/'); ?>/get_revenue_by_quarter";
            $.ajax({
                  url: url,
                  beforeSend: function(){
                     //   $("#loading").show();
