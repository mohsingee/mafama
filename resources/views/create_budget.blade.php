...
@section('content')
    ...
    <style>
       ...
       color:transparent !important;
        ...
        .modal_chart .morris-hover-point {
            display: block
        }
                ...
                <div class="col-md-12 col-sm-12">
                    ...
                    <div class="col-md-12 margin-top-40 padding-0">
                        <ul class="nav nav-tabs nav-button-tabs nav-justified">
                            <li class="active"><a href="{{ url('create_budget') }}">Create Budget Revenues</a></li>
                                ...
                                <div class="tab-content margin-top-10">
                                            ...
                                            <div id="table-scroll" class="table-scroll fw1">
                                                 ...
                                                 ?>
                                                       ...
                                                       <p style="color: red; text-align: left; margin-bottom: 2px; display: none">*required</p> -->
                                                                    <b style="padding: 0 10px"
                                                                        class="bname"><?= $value->name ?></b>
                                                                </td>
                                                                <td class="jan">
                                                                    <input type="number" class="form-control"
                                                                        value="<?= $value->jan ?>" id="jan<?= $value->id ?>"
                                                                        <?php if($currmon >= "01"){ ?> readonly <?php } ?>>
                                                                </td>
                                                                <td class="feb">
                                                                    <input type="number" class="form-control"
                                                                        value="<?= $value->feb ?>" id="feb<?= $value->id ?>"
                                                                        <?php if($currmon >= "02"){ ?> readonly <?php } ?>>
                                                                </td>
                                                                <td class="mar">
                                                                    <input type="number" class="form-control"
                                                                        value="<?= $value->mar ?>"
                                                                        id="mar<?= $value->id ?>" <?php if($currmon >= "03"){ ?>
                                                                        readonly <?php } ?>>
                                                                </td>
                                                                <td class="apr">
                                                                    <input type="number" class="form-control"
                                                                        value="<?= $value->apr ?>"
                                                                        id="apr<?= $value->id ?>" <?php if($currmon >= "04"){ ?>
                                                                        readonly <?php } ?>>
                                                                </td>
                                                                <td class="may">
                                                                    <input type="number" class="form-control"
                                                                        value="<?= $value->may ?>"
                                                                        id="may<?= $value->id ?>" <?php if($currmon >= "05"){ ?>
                                                                        readonly <?php } ?>>
                                                                </td>
                                                                <td class="jun">
                                                                    <input type="number" class="form-control"
                                                                        value="<?= $value->jun ?>"
                                                                        id="jun<?= $value->id ?>" <?php if($currmon >= "06"){ ?>
                                                                        readonly <?php } ?>>
                                                                </td>
                                                                <td class="jul">
                                                                    <input type="number" class="form-control"
                                                                        value="<?= $value->jul ?>"
                                                                        id="jul<?= $value->id ?>" <?php if($currmon >= "07"){ ?>
                                                                        readonly <?php } ?>>
                                                                </td>
                                                                <td class="aug">
                                                                    <input type="number" class="form-control"
                                                                        value="<?= $value->aug ?>"
                                                                        id="aug<?= $value->id ?>" <?php if($currmon >= "08"){ ?>
                                                                        readonly <?php } ?>>
                                                                </td>
                                                                <td class="sep">
                                                                    <input type="number" class="form-control"
                                                                        value="<?= $value->sep ?>"
                                                                        id="sep<?= $value->id ?>" <?php if($currmon >= "09"){ ?>
                                                                        readonly <?php } ?>>
                                                                </td>
                                                                <td class="oct">
                                                                    <input type="number" class="form-control"
                                                                        value="<?= $value->oct ?>"
                                                                        id="oct<?= $value->id ?>" <?php if($currmon >= "10"){ ?>
                                                                        readonly <?php } ?>>
                                                                </td>
                                                                <td class="nov">
                                                                    <input type="number" class="form-control"
                                                                        value="<?= $value->nov ?>"
                                                                        id="nov<?= $value->id ?>" <?php if($currmon >= "11"){ ?>
                                                                        readonly <?php } ?>>
                                                                </td>
                                                                <td class="dec">
                                                                    <input type="number" class="form-control"
                                                                        value="<?= $value->decem ?>"
                                                                        id="dec<?= $value->id ?>" <?php if($currmon >= "12"){ ?>
                                                                        readonly <?php } ?>>
                                                                </td>
                                                                <td class="budg_total">
                                                                ...
                                                                <td class="showgraph" id="showgraph<?= $value->id ?>">
                                                                    <a
                                                                        href="{{ url('monthly_budget_chart') }}/<?= $value->id ?>">
                                                                        <div id="bar-chart<?= $value->id ?>"
                                                                            style="height: 20px; width: 50px"></div>
                                                                    </a>
                                             ...
                                             ?>
                                                        ...
                                                        <tbody class="sectbody" <?= $style ?>>
                                                            <tr class="odd gradeX">
                                                                <td
                                                                    style="text-align:left; color:#da291c; padding: 10px; font-weight: bold">
                                                                    Total</td>
                                                                ...
                                                                <td class="chart_monthly">
                                                                    <a href="{{ url('total_monthly_budget_chart') }}">
                                                                        <div id="bar-chart_total"
                                                                            style="height: 20px; width: 50px"></div>
                                                                    </a>
                                                                    <script type="text/javascript">
                                                                        $(function() {
                                                            ...
                                                            <tr class="odd gradeX">
                                                                ...
                                                                <td>
                                                                    <a id="jansave"
                                                                        class="btn btn-info btn-xs savebtnmonth"
                                                                        style="width:60px;" <?php if($currmon >= "01"){ ?> disabled
                                                                        <?php } ?>>Save</a><br>
                                                                ...
                                                                <td>
                                                                    <a id="febsave"
                                                                        class="btn btn-info btn-xs savebtnmonth"
                                                                        style="width:60px;" <?php if($currmon >= "02"){ ?> disabled
                                                                        <?php } ?>>Save</a><br>
                                                                    <!-- <a href="#" class="btn btn-info btn-xs" style="margin-top:5px;width:60px;">Edit</a> -->
                                                                </td>
                                                                <td>
                                                                    <a id="marsave"
                                                                        class="btn btn-info btn-xs savebtnmonth"
                                                                        style="width:60px;" <?php if($currmon >= "03"){ ?> disabled
                                                                        <?php } ?>>Save</a><br>
                                                                    <!-- <a href="#" class="btn btn-info btn-xs" style="margin-top:5px;width:60px;">Edit</a> -->
                                                                </td>
                                                                <td>
                                                                    <a id="aprsave"
                                                                        class="btn btn-info btn-xs savebtnmonth"
                                                                        style="width:60px;" <?php if($currmon >= "04"){ ?> disabled
                                                                        <?php } ?>>Save</a><br>
                                                                    <!-- <a href="#" class="btn btn-info btn-xs" style="margin-top:5px;width:60px;">Edit</a> -->
                                                                </td>
                                                                <td>
                                                                    <a id="maysave"
                                                                        class="btn btn-info btn-xs savebtnmonth"
                                                                        style="width:60px;" <?php if($currmon >= "05"){ ?> disabled
                                                                        <?php } ?>>Save</a><br>
                                                                    <!-- <a href="#" class="btn btn-info btn-xs" style="margin-top:5px;width:60px;">Edit</a> -->
                                                                </td>
                                                                <td>
                                                                    <a id="junsave"
                                                                        class="btn btn-info btn-xs savebtnmonth"
                                                                        style="width:60px;" <?php if($currmon >= "06"){ ?> disabled
                                                                        <?php } ?>>Save</a><br>
                                                                    <!-- <a href="#" class="btn btn-info btn-xs" style="margin-top:5px;width:60px;">Edit</a> -->
                                                                </td>
                                                                <td>
                                                                    <a id="julsave"
                                                                        class="btn btn-info btn-xs savebtnmonth"
                                                                        style="width:60px;" <?php if($currmon >= "07"){ ?> disabled
                                                                        <?php } ?>>Save</a><br>
                                                                    <!-- <a href="#" class="btn btn-info btn-xs" style="margin-top:5px;width:60px;">Edit</a> -->
                                                                </td>
                                                                <td>
                                                                    <a id="augsave"
                                                                        class="btn btn-info btn-xs savebtnmonth"
                                                                        style="width:60px;" <?php if($currmon >= "08"){ ?> disabled
                                                                        <?php } ?>>Save</a><br>
                                                                    <!-- <a href="#" class="btn btn-info btn-xs" style="margin-top:5px;width:60px;">Edit</a> -->
                                                                </td>
                                                                <td>
                                                                    <a id="sepsave"
                                                                        class="btn btn-info btn-xs savebtnmonth"
                                                                        style="width:60px;" <?php if($currmon >= "09"){ ?> disabled
                                                                        <?php } ?>>Save</a><br>
                                                                    <!-- <a href="#" class="btn btn-info btn-xs" style="margin-top:5px;width:60px;">Edit</a> -->
                                                                </td>
                                                                <td>
                                                                    <a id="octsave"
                                                                        class="btn btn-info btn-xs savebtnmonth"
                                                                        style="width:60px;" <?php if($currmon >= "10"){ ?> disabled
                                                                        <?php } ?>>Save</a><br>
                                                                    <!-- <a href="#" class="btn btn-info btn-xs" style="margin-top:5px;width:60px;">Edit</a> -->
                                                                </td>
                                                                <td>
                                                                    <a id="novsave"
                                                                        class="btn btn-info btn-xs savebtnmonth"
                                                                        style="width:60px;" <?php if($currmon >= "11"){ ?> disabled
                                                                        <?php } ?>>Save</a><br>
                                                                    <!-- <a href="#" class="btn btn-info btn-xs" style="margin-top:5px;width:60px;">Edit</a> -->
                                                                </td>
                                                                <td>
                                                                    <a id="decsave"
                                                                        class="btn btn-info btn-xs savebtnmonth"
                                                                        style="width:60px;" <?php if($currmon >= "12"){ ?> disabled
                                                                        <?php } ?>>Save</a><br>
                                                                    <!-- <a href="#" class="btn btn-info btn-xs" style="margin-top:5px;width:60px;">Edit</a> -->
                                                                </td>
                                                                <td></td>
                                    ...
                                    <div class="tab-pane fade" id="tab12">
                                        <div class="row" style="margin: 10px 0;">
                                            ...
                                            <div class="col-md-9">
                                                <?php foreach($years as $value){ ?>
                                                <a href="javascript:void(0)" id="quaterly_yearly"
                                                    data-id="<?php echo $value; ?>"><span class="act"
                                                        style="margin-right: 12px;background-color: #da291c;
                                    border-color: #da291c; color: #fff; padding: 1%; border-radius: 5%">{{ $value }}</span></a>
                                                <?php } ?>
                                            </div>
                                        ...
                                        <div class="table-responsive fw2">
                                       ...
                                       foreach ($revenue_quaterly as $value) {
                                           ?>
                                                 ...
                                                 <p style="color: red; text-align: left; margin-bottom: 2px; display: none">*required</p> -->
                                                        ...
                                                        <td class="janmar">
                                                            <input type="number" class="form-control"
                                                                value="<?= $value->janmar ?>" id="janmar<?= $value->id ?>"
                                                                readonly>
                                                        </td>
                                                        <td class="aprjun">
                                                            <input type="number" class="form-control"
                                                                value="<?= $value->aprjun ?>" id="aprjun<?= $value->id ?>"
                                                                readonly>
                                                        </td>
                                                        <td class="julsep">
                                                            <input type="number" class="form-control"
                                                                value="<?= $value->julsep ?>" id="julsep<?= $value->id ?>"
                                                                readonly>
                                                        </td>
                                                        <td class="octdec">
                                                            <input type="number" class="form-control"
                                                                value="<?= $value->octdec ?>" id="octdec<?= $value->id ?>"
                                                                readonly>
                                                        </td>
                                                        ...
                                                        <td class="showgraphq" id="showgraphq<?= $value->id ?>">
                                                            <a
                                                                href="{{ url('quarterly_budget_chart') }}/<?= $value->id ?>">
                                                                <div id="bar-chartq<?= $value->id ?>"
                                                                    style="height: 20px; width: 30px"></div>
                                                            </a>
                                                            <script type="text/javascript">
                                                                $(function() {
                                                                    "use strict";
                                       ...
                                       ?>
                                                ...
                                                <?php if ($revenue_quaterly_count == 0) {
                                                    $style2 = "style='display:none'";
                                                } else {
                                                    $style2 = "style=''";
                                                } ?>
                                                <tbody class="sectbody2 fw2" <?= $style2 ?>>
                                                    <tr class="odd gradeX">
                                                        <!-- <td></td> -->
                                                        <td
                                                            style="text-align:left; color:#da291c;  padding: 10px; font-weight: bold">
                                                        ...
                                                        <td class="chart_quarterly">
                                                            <a href="{{ url('total_quarterly_budget_chart') }}">
                                                                <div id="bar-chart_totalq"
                                                                    style="height: 20px; width: 30px"></div>
                                                            </a>
                                                            <script type="text/javascript">
                                                                $(function() {
    ...
    <script>
        ...
        jQuery(document).ready(function() {
            ...
            jQuery(".main-table1").clone(true).appendTo(".table-scroll").addClass("clone");
        });
    </script>
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(addButton).click(function() {
                var fldhtml = "";
                $.ajax({
                    url: "<?php echo url('/'); ?>/create_budget_names",
                    data: 'x=' + x + '&_token={{ csrf_token() }}',
                    type: "POST",
                    success: function(response) {
                        // alert(response);
                        fldhtml = response;
                        var fieldHTML = '<tr class="odd gradeX monthly" id="row' + x +
                            '"><td><a href="javascript:void(0);" class="remove_button"> <span class="glyphicon glyphicon-minus" style="text-align: center;font-size: 20px; font-weight: bold"></span></a></td><td class="budget_name">' +
                            response +
                            '<p style="color: red; text-align: left; margin-bottom: 2px; display: none">*required</p></td><td class="jan"><input type="number" class="form-control" value="0" id="jan' +
                            x +
                            '"></td><td class="feb"><input type="number" class="form-control" value="0" id="feb' +
                            x +
                            '"></td><td class="mar"><input type="number" class="form-control" value="0"  id="mar' +
                            x +
                            '"></td><td class="apr"><input type="number" class="form-control" value="0"  id="apr' +
                            x +
                            '"></td><td class="may"><input type="number" class="form-control" value="0" id="may' +
                            x +
                            '"></td><td class="jun"><input type="number" class="form-control" value="0" id="jun' +
                            x +
                            '"></td><td class="jul"><input type="number" class="form-control" value="0" id="jul' +
                            x +
                            '"></td><td class="aug"><input type="number" class="form-control" value="0" id="aug' +
                            x +
                            '"></td><td class="sep"><input type="number" class="form-control" value="0" id="sep' +
                            x +
                            '"></td><td class="oct"><input type="number" class="form-control" value="0" id="oct' +
                            x +
                            '"></td><td class="nov"><input type="number" class="form-control" value="0" id="nov' +
                            x +
                            '"></td><td class="dec"><input type="number" class="form-control" value="0" id="dec' +
                            x +
                            '"></td><td class="budg_total">0</td><td class="showgraph" id="showgraph' +
                            x + '"></td></tr>';
                        // var fieldHTML = fldhtml;
                        if (x < maxField) {
                            x++;
            ...
            $(wrapper).on('click', '.remove_button', function(e) {
                ...
                x--;
                var month_array = ['jan', 'feb', 'mar', 'apr', 'may', 'jun', 'jul', 'aug', 'sep', 'oct',
                    'nov', 'dec'
                ];
                var i;
                var totv = 0
                ...
                $.ajax({
                    ...
                    data: 'jantotal=' + jantotal + '&febtotal=' + febtotal + '&martotal=' +
                        martotal + '&aprtotal=' + aprtotal + '&maytotal=' + maytotal +
                        '&juntotal=' + juntotal + '&jultotal=' + jultotal + '&augtotal=' +
                        augtotal + '&septotal=' + septotal + '&octtotal=' + octtotal +
                        '&novtotal=' + novtotal + '&dectotal=' + dectotal +
                        '&_token={{ csrf_token() }}',
                    type: "POST",
                    success: function(response) {
            ...
            $(addButton2).click(function() {
                $.ajax({
                    url: "<?php echo url('/'); ?>/create_quarterlybudget_names",
                    data: 'x=' + x + '&_token={{ csrf_token() }}',
                    type: "POST",
                    success: function(response) {
                        // alert(response);
                        // fldhtml = response;
                        var fieldHTML2 = '<tr class="odd gradeX quarterly" id="roww' + y +
                            '"><td><a href="javascript:void(0);" class="remove_button2"> <span class="glyphicon glyphicon-minus" style="text-align: center;font-size: 20px; font-weight: bold"></span></a></td><td class="budget_name">' +
                            response +
                            '<p style="color: red; text-align: left; margin-bottom: 2px; display: none">*required</p></td><td class="janmar"><input type="number" class="form-control" value="0" id="janmar' +
                            y +
                            '"></td><td class="aprjun"><input type="number" class="form-control" value="0" id="aprjun' +
                            y +
                            '"></td><td class="julsep"><input type="number" class="form-control" value="0" id="julsep' +
                            y +
                            '"></td><td class="octdec"><input type="number" class="form-control" value="0" id="octdec' +
                            y +
                            '"></td><td class="budg_total2">0</td><td class="showgraphq" id="showgraphq' +
                            y + '"></td></tr>';
            ...
            $(wrapper2).on('click', '.remove_button2', function(e) {
                ...
                $.ajax({
                    ...
                    data: 'janmartotal=' + janmartotal + '&aprjuntotal=' + aprjuntotal +
                        '&julseptotal=' + julseptotal + '&octdectotal=' + octdectotal +
                        '&_token={{ csrf_token() }}',
                    type: "POST",
                    success: function(response) {
    ...
    <script>
        $(document).on("click", "#yearlist", function() {
            ...
            $.ajax({
                url: "<?php echo url('/'); ?>/create_budget_year",
                data: 'year=' + year,
                type: "GET",
    ...
    <script>
        $(document).on("click", "#quaterly_yearly", function() {
            ...
            $.ajax({
                url: "<?php echo url('/'); ?>/create_budget_quaterly_year",
                data: 'year=' + year,
                type: "GET",
                success: function(data) {
    ...
    <script type="text/javascript">
        $(document).on("change", ".monthly input[type=number]", function() {
            ...
            var new_total_row = parseFloat(jan) + parseFloat(feb) + parseFloat(mar) + parseFloat(apr) + parseFloat(
                    may) + parseFloat(jun) + parseFloat(jul) + parseFloat(aug) + parseFloat(sep) + parseFloat(oct) +
                parseFloat(nov) + parseFloat(dec);
            ...
            var dectotal = $("#dectotal").html();
            $.ajax({
                url: "<?php echo url('/'); ?>/getgraph",
                data: 'id=' + id + '&jan=' + jan + '&feb=' + feb + '&mar=' + mar + '&apr=' + apr + '&may=' +
                    may + '&jun=' + jun + '&jul=' + jul + '&aug=' + aug + '&sep=' + sep + '&oct=' + oct +
                    '&nov=' + nov + '&dec=' + dec + '&jantotal=' + jantotal + '&febtotal=' + febtotal +
                    '&martotal=' + martotal + '&aprtotal=' + aprtotal + '&maytotal=' + maytotal +
                    '&juntotal=' + juntotal + '&jultotal=' + jultotal + '&augtotal=' + augtotal +
                    '&septotal=' + septotal + '&octtotal=' + octtotal + '&novtotal=' + novtotal +
                    '&dectotal=' + dectotal + '&_token={{ csrf_token() }}',
                type: "POST",
                success: function(response) {
                    // alert(response);
        ...
        $(document).on('click', '.savebtnmonth', function() {
            ...
            if (disabled != "disabled") {
                ...
                if (cnt == 0) {
                    var url = "<?php echo url('/'); ?>/create_budget_monthly";
                    $.ajax({
                        url: url,
                        data: 'names=' + names + '&prices=' + prices + '&month=' + month +
                            '&_token={{ csrf_token() }}',
                        type: "POST",
                        success: function(response) {
                            // alert(response);
        ...
        $(document).on("change", ".quarterly input[type=number]", function() {
            ...
            var octdectotal = $("#octdectotal").html();
            $.ajax({
                url: "<?php echo url('/'); ?>/getquarrterlygraph",
                data: 'id=' + id + '&janmar=' + janmar + '&aprjun=' + aprjun + '&julsep=' + julsep +
                    '&octdec=' + octdec + '&janmartotal=' + janmartotal + '&aprjuntotal=' + aprjuntotal +
                    '&julseptotal=' + julseptotal + '&octdectotal=' + octdectotal +
                    '&_token={{ csrf_token() }}',
                type: "POST",
                success: function(response) {
        ...
        $(".savebtnquarter").click(function() {
            ...
            if (cnt == 0) {
                var url = "<?php echo url('/'); ?>/create_budget_quarterly";
                $.ajax({
                    url: url,
                    data: 'names=' + names + '&prices=' + prices + '&month=' + month +
                        '&_token={{ csrf_token() }}',
