        ...
        $(".prvbtn").click(function(){
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    var preview = '<div style="padding:10px; background-color:'+bakg+'"><div style="padding: 5px">'+user_banner+'</div><p style="margin-top: 10px;">'+greeting+'</p><p style="margin-bottom: 0;">'+message+'</p></div>';
