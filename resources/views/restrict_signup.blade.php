        ...
        <div class="nk-content-inner">
            <div class="nk-content-body">
                <div class="nk-block-head-content" style="margin-bottom:20px;">
					<h3 class="nk-block-title page-title">Restrict Signups</h3>
									...
									<div class="row gy-4">
										<div class="col-md-6">
											<div class="form-group">
												<label class="form-label">Affilate Name</label>
										...
										<div class="col-md-6">
											<div class="form-group">
												<label class="form-label">Allowed Signups</label>
								...
								<table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
									<thead>
										<tr class="nk-tb-item nk-tb-head">
											...
											<th class="nk-tb-col tb-col-lg"><span class="sub-text">No. of Sign-ups allowed</span></th>
									...
									<tbody>
										<tr class="nk-tb-item">
											...
											<td class="nk-tb-col tb-col-md">
												<a href="restrict_signup.php" class="btn btn-xs btn-primary">Edit</a>
