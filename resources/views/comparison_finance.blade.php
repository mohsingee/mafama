...
@section('content')
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12">
                    ...
                    <ul class="nav nav-tabs nav-button-tabs nav-justified  margin-top-10">
                        <li class="active"><a href="{{ url('comparison_finance') }}">Monthly</a></li>
                                ...
                                <div class="tab-pane fade in active" id="tab1">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <button class="btn btn-primary addcomprsntabk" id="addcompareyeark">Add
                                                Year/Month</button>
                                        </div>
                                        <div class="col-md-12 text-center">
                                            <button class="btn btn-primary compare_btnk"
    ...
    <script type="text/javascript">
        ...
        $(document).on("click", ".compare_btn", function() {
            ...
            fmonth = $("#monthlylist1 li.cmonth").text();
            if ((fyear != "") && (fmonth != "")) {
    ...
    <script type="text/javascript">
        ...
        $(document).on("click", ".compare_btnq", function() {
            ...
            fmonth = $("#monthlylist1q li.cmonth").text();
            if ((fyear != "") && (fmonth != "")) {
                allyearmonth.push(fyear + "nqd" + fmonth);
            }
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $(".addcomprsntaby").on("click", function() {
                ...
                var html =
                    '<div class="margin-top-10 commallq" style="border: 1px solid #da291c !important; border-radius: 10px; padding: 5px;"> <div class="row"> <div class="col-md-3"> <label style="margin: 12px 0;">Choose a year to compare</label> </div><div class="col-md-9"> <div class=""> <ul class="monthlylisty"> ' +
                    yearlist +
        ...
        $(document).on("click", ".compare_btny", function() {
            ...
            fmonth = $("#monthlylist1y li.cmonth").text();
            if ((fyear != "") && (fmonth != "")) {
                allyearmonth.push(fyear + "nqd" + fmonth);
            }
            $(".commallq").each(function() {
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $(".addcomprsntabv").on("click", function() {
                ...
                var html =
                    '<div class="margin-top-10 commallq" style="border: 1px solid #da291c !important; border-radius: 10px; padding: 5px;"> <div class="row"> <div class="col-md-3"> <label style="margin: 12px 0;">Choose a year to compare</label> </div><div class="col-md-9"> <div class=""> <ul class="monthlylistv"> ' +
                    yearlist +
        ...
        $(document).on("click", ".compare_btnv", function() {
            ...
            fmonth = $("#monthlylist1v li.cmonth").text();
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $(".addcomprsntabz").on("click", function() {
                ...
                var html =
                    '<div class="margin-top-10 commallq" style="border: 1px solid #da291c !important; border-radius: 10px; padding: 5px;"> <div class="row"> <div class="col-md-3"> <label style="margin: 12px 0;">Choose a year to compare</label> </div><div class="col-md-9"> <div class=""> <ul class="monthlylistz"> ' +
                    yearlist +
        ...
        $(document).on("click", ".compare_btnz", function() {
            ...
            fmonth = $("#monthlylist1z li.cmonth").text();
            if ((fyear != "") && (fmonth != "")) {
                allyearmonth.push(fyear + "nqd" + fmonth);
            }
            $(".commallq").each(function() {
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $(".addcomprsntabk").on("click", function() {
                ...
                var html =
                    '<div class="margin-top-10 commallq" style="border: 1px solid #da291c !important; border-radius: 10px; padding: 5px;"> <div class="row"> <div class="col-md-3"> <label style="margin: 12px 0;">Choose a year to compare</label> </div><div class="col-md-9"> <div class=""> <ul class="monthlylistk"> ' +
                    yearlist +
                    ' </ul> </div></div></div><div class="row"> <div class="col-md-3"> <label style="margin: 12px 0;">Choose a month to compare</label> </div><div class="col-md-9"> <div class=""> <ul class="monthlylist1k"> <li class="act">Jan</li><li class="act">Feb</li><li class="act">Mar</li><li class="act">Apr</li><li class="act">May</li><li class="act">Jun</li><li class="act">Jul</li><li class="act">Aug</li><li class="act">Sep</li><li class="act">Oct</li><li class="act">Nov</li><li class="act">Dec</li></ul> </div></div></div><div class="clearfix"></div></div>';
        ...
        $(document).on("click", ".compare_btnk", function() {
            ...
            fmonth = $("#monthlylist1k li.cmonth").text();
            if ((fyear != "") && (fmonth != "")) {
                allyearmonth.push(fyear + "nqd" + fmonth);
            }
            $(".commallq").each(function() {
            ...
            if (allyearmonth != "") {
                $.ajax({
                    ...
                    //   $("#wrapper").hide();
                    // },
                    url: "monthlyyearlycomprofitloss",
                    data: 'allyearmonth=' + allyearmonth + '&_token={{ csrf_token() }}',
                    success: function(html) {
                        // alert(html);
