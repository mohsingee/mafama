...
@section('content')
                ...
                <div class="col-md-12 col-sm-12">
                    ...
                    <div class="col-md-12 margin-top-40 padding-0">
                        <ul class="nav nav-tabs nav-button-tabs nav-justified">
                            <li class="active"><a href="{{ url('create_projection') }}">Create Projection Revenues</a></li>
                                             ...
                                             ?>
                                                       ...
                                                       <p style="color: red; text-align: left; margin-bottom: 2px; display: none">*required</p> -->
                                                                ...
                                                                <td class="showgraph" id="showgraph<?= $value->id ?>">
                                                                    <a
                                                                        href="{{ url('monthly_projection_chart') }}/<?= $value->id ?>">
                                                        ...
                                                        <tbody class="sectbody" <?= $style ?>>
                                                            <tr class="odd gradeX">
                                                                ...
                                                                <td class="chart_monthly">
                                                                    <a href="{{ url('total_monthly_projection_chart') }}">
                                    ...
                                    <div class="tab-pane fade" id="tab12">
                                        <div class="row" style="margin: 10px 0;">
                                            ...
                                            <div class="col-md-9">
                                                <?php foreach($years as $value){ ?>
                                                <a href="javascript:void(0)" data-id="<?php echo $value; ?>"
                                                    id="quaterly_yearly"><span class="act"
                                                        style="margin-right: 12px;background-color: #da291c;
                                    border-color: #da291c; color: #fff; padding: 1%; border-radius: 5%">{{ $value }}</span></a>
                                                <?php } ?>
                                            </div>
                                       ...
                                       ?>
                                                 ...
                                                 <p style="color: red; text-align: left; margin-bottom: 2px; display: none">*required</p> -->
                                                        ...
                                                        <td class="showgraphq" id="showgraphq<?= $value->id ?>">
                                                            <a
                                                                href="{{ url('quarterly_projection_chart') }}/<?= $value->id ?>">
                                                ...
                                                <tbody class="sectbody2" <?= $style2 ?>>
                                                    <tr class="odd gradeX">
                                                        ...
                                                        <td class="chart_quarterly">
                                                            <a href="{{ url('total_quarterly_projection_chart') }}">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(addButton).click(function() {
                var fldhtml = "";
                $.ajax({
                    url: "<?php echo url('/'); ?>/create_projection_names",
            ...
            $(addButton2).click(function() {
                $.ajax({
                    url: "<?php echo url('/'); ?>/create_quarterlyprojection_names",
                    data: 'x=' + x + '&_token={{ csrf_token() }}',
                    type: "POST",
                    success: function(response) {
                        // alert(response);
    ...
    <script type="text/javascript">
        ...
        $(".savebtnmonth").click(function() {
            ...
            if (disabled != "disabled") {
                ...
                if (cnt == 0) {
                    var url = "<?php echo url('/'); ?>/create_projection_monthly";
                    $.ajax({
                        url: url,
        ...
        $(document).on("change", ".quarterly input[type=number]", function() {
            ...
            var octdectotal = $("#octdectotal").html();
            $.ajax({
                url: "<?php echo url('/'); ?>/getquarrterlygraph2",
        ...
        $(".savebtnquarter").click(function() {
            ...
            if (cnt == 0) {
                var url = "<?php echo url('/'); ?>/create_projection_quarterly";
                $.ajax({
                    url: url,
                    data: 'names=' + names + '&prices=' + prices + '&month=' + month +
                        '&_token={{ csrf_token() }}',
    ...
    <script>
        $(document).on("click", "#yearlist", function() {
            ...
            $.ajax({
                url: "<?php echo url('/'); ?>/create_projection_year",
                data: 'year=' + year,
                type: "GET",
    ...
    <script>
        $(document).on("click", "#quaterly_yearly", function() {
            ...
            $.ajax({
                url: "<?php echo url('/'); ?>/create_projection_quaterly_year",
                data: 'year=' + year,
                type: "GET",
                success: function(data) {
