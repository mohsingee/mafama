                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-12"
                            ...
                            <div class="col-md-6">
                                ...
                                <form action="{{ url('add_user_top_city_news') }}" method="POST" id=""
                                    ...
                                    <tr>
                                        ...
                                        <td width="20%">
                                            <a class="btn btn-xs btn-success"
                                                href="{{ url('edit_user_top_city_news') . '/' . $value->id }}">Edit</a>
                                            <form action="{{ url('delete_user_top_city_news') }}" method="POST"
