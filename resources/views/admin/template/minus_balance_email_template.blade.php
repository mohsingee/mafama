		...
		<div class="nk-content-inner">
			<div class="nk-content-body">
				...
				<div class="nk-block-head-content" style="margin-bottom:20px;display:flex;">
						<h3 class="nk-block-title page-title"   style="width:935px;">Minus Balance Email Template</h3>
					...
					<div class="card card-bordered card-stretch">
                        <div class="card-aside-wrap">
							<div class="card-inner card-inner-lg">
								<form action="{{ url('update_minus_balance_email_template') }}" method="POST" id="" enctype="multipart/form-data">	
									@csrf
									...
									<div class="clearfix"></div>	
										...
										@if(permission_access('minus_balance_email_edit')==1)
