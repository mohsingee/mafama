                     ...
                     <div class="card-inner">
                        <div class="table-responsive1">
                           <table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false" id="sample_editable_1">
                              ...
                              <tbody> @php $i=1; @endphp @foreach($users as $bo)
                                 <tr class="nk-tb-item">
                                    <td>
                                       <input type="checkbox" class="checkboxes" value="<?= $bo->id;?>" />
                                    </td>
                                    <td class="nk-tb-col"> <span>{{ $i++ }}.</span> </td>
                                    <td class="nk-tb-col"> <span>{{ $bo->name }}</span> </td>
                                    <td class="nk-tb-col"> <span><b></b>{{ $bo->email }}</span> </td>
                                    <td class="nk-tb-col"> <span>{!! $bo->contact !!}</span> </td>
                                    <td class="nk-tb-col"> <span>{{date('m-d-Y h:i A',strtotime($bo->created_at)) }}</span> </td>
                                 </tr>
                        ...
                        <div class="row">
                           ...
                           <?php
                                       ...
                                       foreach($titles as $value){
                                          ?>
                              <div class="col-md-3 text-center " style="padding-right:5px;padding-left:0px;"> <a href="javascript:void(0)" onclick="titleClick(this.id)" id="{{ $value->subject }}" class="btn btn-xs btn-black" style="margin-top:10px;margin-bottom:10px;width:100%;">{{ $value->subject }}</a> </div>
                              <?php
                                                $cnt++;
                                                if($cnt == 5){
                                                    break;
                              ...
                              <div class="col-md-12" style="margin-top: 10px;">
                                 ...
                                 <div class="row" style="margin: 0px !important">
                                    ...
                                    <div class="col-md-10 padding-0">
                                       <ul style="list-style-type: none; padding: 0; margin: 0">@foreach($colors as $color)
                                          <li class="color-td" style="background-color: {{ $color->color }}; display: inline-block;"></li>@endforeach</ul>
