                  ...
                  <div class="card-inner-group">
                     ...
                     <div class="card-inner">
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-8" >
                              <ul class="nav nav-tabs" style="">
                                 ...
                                 <li class="nav-item">
                                    <a class="btn-xs nav-link active" data-toggle="tab" href="#email-tab">Send Email</a>
                                 </li>
                                 <li class="nav-item">
                                    <a class="btn-xs nav-link" data-toggle="tab" href="#card-tab">Send Card</a>
                                 </li>
                                 <li class="nav-item">
                                    <a class="btn-xs nav-link" data-toggle="tab" href="#video-tab">Send Videos</a>
                                 </li>
                        ...
                        <div class="tab-content" style="margin-top:10px;">
                           ...
                           <div class="tab-pane" id="card-tab" style="border-top:1px solid #cecece;padding-top:10px;">
                           ...
                           <div class="tab-pane" id="video-tab" style="border-top:1px solid #cecece;padding-top:10px;">
                              <div class="row">
                                 <div class="col-md-2"></div>
                                 <div class="col-md-8">
