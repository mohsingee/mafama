		...
		<div class="nk-content-inner">
			<div class="nk-content-body">
				<div class="nk-block-head-content" style="margin-bottom:20px;display:flex;">
					<h3 class="nk-block-title page-title"   style="width:900px;">Other Condition Table</h3>
					...
					<div class="card card-bordered card-stretch">
						<div class="card-inner-group">
							...
							<div class="card-inner">
								...
								<div class="">
								<form action="{{ url('update_pool_other_value') }}" method="POST" id="" enctype="multipart/form-data">	
									@csrf
									
									<div class="row gy-4" style="padding-bottom:20px;">	
										<div class="col-md-5">
											<div class="form-group">
												<label class="form-label">Pool Other Price</label>
										...
										<div class="col-md-5">
											<div class="form-group">
												...
												<input type="text" class="form-control"  name="other"  value="{{ isset($pool->id)?number_format($pool->other,2):''}}"  readonly="">
					...
					<div class="card card-bordered card-stretch">
						<div class="card-inner-group">
							...
							<div class="card-inner">
								...
								<a class="btn btn-sm btn-success pull-right" href="{{url('admin/other-conditions')}}">Add New  Condition</a>
								@endif
								<div class="">
										...
										<tr class="nk-tb-item">
										  ...
										  <td class="nk-tb-col">
											...
											<td class="nk-tb-col tb-col-md">
												@if(permission_access('bonus_other_table_edit')==1)
												<a href="{{url('admin/other-conditions/'.$bonus->id )}}" class="btn btn-sm btn-success">Edit</a>
												@endif
												<br>
												@if(permission_access('bonus_other_table_delete')==1)
												<a data-id="{{$bonus->id }}" data-list="other_conditions" href="javascript:void(0)" class="btn btn-sm btn-success deleterow">Delete</a>
												@endif
