		...
		<div class="nk-content-inner">
			<div class="nk-content-body">
				...
				<div class="nk-block-head-content" style="margin-bottom:20px;display:flex;">
						<h3 class="nk-block-title page-title"   style="width:935px;">Bonus Conditions</h3>
					...
					<div class="card card-bordered card-stretch">
                        <div class="card-aside-wrap">
							<div class="card-inner card-inner-lg">
								<form action="{{ url('update_bonus_conditions') }}" method="POST" id="" enctype="multipart/form-data">	
									@csrf
									...
									<div class="row gy-4" style="padding-bottom:20px;">
										...
										<div class="col-md-6">
											<div class="form-group">
												<label class="form-label">Number of direct downlline affiliates	</label>
