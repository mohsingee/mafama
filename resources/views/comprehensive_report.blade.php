		...
		<div class="nk-content-inner">
			<div class="nk-content-body">
				<div class="nk-block-head-content" style="margin-bottom:20px;display:flex;">
					<h3 class="nk-block-title page-title"   style="width:900px;">Comprehensive Report</h3>
										...
										<div class="col-md-3">
											<div class="form-group">
												<div class="custom-control  custom-checkbox">
													...
													<label class="custom-control-label" for="customCheck1">Silver Founder</label>
												</div>
											</div>
										</div>
										<div class="col-md-3">
								...
								<table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
									<thead  class="thead-light">
										<tr  class="nk-tb-item nk-tb-head">
											...
											<th class="nk-tb-col"><span class="sub-text">Email</th>
											<th class="nk-tb-col"><span class="sub-text">Contact No.</th>
											<th class="nk-tb-col"><span class="sub-text">Level </th>
											<th class="nk-tb-col"><span class="sub-text">Joining Date </th>
											<th class="nk-tb-col"><span class="sub-text">Country </th>
											<th class="nk-tb-col"><span class="sub-text">State</th>
									...
									<tbody>
										<tr class="nk-tb-item">
											<td class="nk-tb-col">
												<span>Mainchurch Joseph</span>
											</td>
											<td class="nk-tb-col">
												<span>Joseph@gmail.com</span>
											</td>
											<td class="nk-tb-col">
												<span>9898989000</span>
											</td>
											<td class="nk-tb-col">
												<span>Level 1</span>
											</td>
