            ...
            <div class="col-md-12 col-sm-12">
                <div class="row">
                    ...
                    <ul class="nav nav-tabs nav-button-tabs nav-justified margin-bottom-20">
                        <li class="active"><a href="<?php echo e(url('add_appointment_setting')); ?>">Appointment Settings</a></li>
                        <li><a href="<?php echo e(url('block_appointment_date')); ?>">Block Appointment Date</a></li>
                    </ul>
                    ...
                    <div class="tab-content margin-top-10" style="border: 1px solid #da291c !important; border-radius: 10px; padding: 10px;">
                        <div class="tab-pane fade in active" id="tab1">
                            ...
                            if($excount == 0){
                            ?>
                                <form  action="<?php echo e(url('appointment_setting_entry')); ?>" method="POST" id="" enctype="multipart/form-data"> 
                                    <?php echo csrf_field(); ?>
                            ...
                            ?>
                                <form  action="<?php echo e(url('appointment_setting_update')); ?>" method="POST" id="" enctype="multipart/form-data"> 
                                <?php echo csrf_field(); ?>
                                    <div class="col-md-12" style="border-radius: 10px; padding-top: 10px; padding-bottom: 20px;">
                                        <div class="col-md-12">
                                            <table class="table">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mafamatest/public_html/resources/views/add_appointment_setting.blade.php ENDPATH**/ ?>