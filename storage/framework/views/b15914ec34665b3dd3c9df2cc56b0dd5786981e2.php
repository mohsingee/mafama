...

	{
	 ...
	 var _token = $("meta[name='csrf-token']").attr("content"); 
		...
		$.ajax({			
			...
			url :"<?php echo e(route('getChatusers')); ?>" ,
...
$(document).on('click', '.remove_chat', function(){
		...
		//{ }
			...
			$.ajax({
				...
				url:"<?php echo e(route('DeleteChat')); ?>",
...
$(document).on('click', '.edit_chat', function(){
		...
		var _token = $("meta[name='csrf-token']").attr("content");		
			...
			$.ajax({
				...
				url:"<?php echo e(route('UpdateChat')); ?>",
...
$("#managechatform").submit(function(e)
...

		{
           ...
           var formData = new FormData(this);
			...
			$.ajax({
				...
				url : "<?php echo e(route('msg_send_write_msg')); ?>" ,
...
</script><?php /**PATH /home/mafamatest/public_html/resources/views/chat/chat_script.blade.php ENDPATH**/ ?>