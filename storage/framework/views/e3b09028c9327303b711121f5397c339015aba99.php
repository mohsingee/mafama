                     ...
                     <div class="col-md-12">
                         ...
                         <div class="col-md-12"
                             ...
                             <div class="col-md-6">
                                 ...
                                 <form action="<?php echo e(url('add_user_birthplace_details')); ?>" method="POST" id=""
                                     ...
                                     <tr>
                                         ...
                                         <td width="20%">
                                             <a class="btn btn-xs btn-success"
                                                 href="<?php echo e(url('edit_user_birthplace_details') . '/' . $value->id); ?>">Edit</a>
                                             <form action="<?php echo e(url('delete_user_birthplace_details')); ?>" method="POST"
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mafamatest/public_html/resources/views/setting_birthplace.blade.php ENDPATH**/ ?>