            ...
            <div class="col-md-12 col-sm-2">
                ...
                <div class="col-md-12">
                    <ul class="nav nav-tabs nav-button-tabs nav-justified" style="">
                        ...
                        <li class="active"><a href="<?php echo e(url('manage_appointment_client')); ?>">Manage Client</a></li>
                    </ul>
                                        ...
                                        <div class="col-md-12 shadow-boxx" style="padding: 10px;">
                                            ...
                                            <div class="col-md-12 text-center padding-0 margin-top-20">
                                                    ...
                                                    <tbody>
                                                        <tr colspan="2" style="">
                                                            <span class="text-center">
                                                                <img src="<?php echo e(asset('public/assets/images/client')); ?>/<?= $value->image ?>" style="border: 1px solid #da291c73 !important; border-radius: 5px; object-fit:cover;
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a class="record" href="<?php echo e(route('revenue_records_pos')); ?>?client=<?= $value->id ?>">
                                                        ...
                                                        <tr>
                                                            <td><b>Balance : </b></td>
                                                            <td>
                                                                <a class="record" href="<?php echo e(route('revenue_records_neg')); ?>?client=<?= $value->id ?>">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a class="record" href="<?php echo e(url('manage_appointment')); ?>?client=<?= $value->id ?>">
                                                ...
                                                <div class="col-md-12 text-center padding-0">
                                                    <a href="<?php echo e(url('appointment_step3')); ?>/<?= $value->id ?>" class="btn btn-xs btn-info custom-padding">Make Apptmt</a>
                                                    ...
                                                    <div class="modal-dialog">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <form action="<?php echo e(url('appointment_email_send')); ?>" method="POST" role="form" enctype="multipart/form-data">
                                                                        <?php echo csrf_field(); ?>
                                                                            <div class="col-md-12">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mafamatest/public_html/resources/views/main/manage_appointment_client.blade.php ENDPATH**/ ?>