<?php $__env->startSection('content'); ?>
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12">
                    ...
                    <div class="text-center">
                        ...
                        <input type="hidden" name="" id="choosenyear" value="<?php echo e(date('Y')); ?>">
                    </div>
    ...
    <script type="text/javascript">
        ...
        $(document).on("click", "#editing .total_revenue_det", function() {
            ...
            $.ajax({
                ...
                data: 'year=' + year + '&account_description=' + account_description +
                    '&_token=<?php echo e(csrf_token()); ?>',
                type: "POST",
                success: function(response) {
                    // alert(response);
        ...
        $(document).on("click", "#editing .total_asset_det", function() {
            ...
            $.ajax({
                ...
                data: 'year=' + year + '&description=' + description + '&_token=<?php echo e(csrf_token()); ?>',
                type: "POST",
                success: function(response) {
                    // alert(response);
                    $("#monthly_details").html(response);
        ...
        $(document).on("click", ".new_client_det", function() {
            ...
            $.ajax({
                ...
                data: 'year=' + year + '&month=' + month + '&_token=<?php echo e(csrf_token()); ?>',
                type: "POST",
                success: function(response) {
                    // alert(response);
                    if (response !== '') {
    ...
    <script type="text/javascript">
        ...
        $(document).on("click", ".actual_monthly_expense", function() {
            ...
            $.ajax({
                ...
                data: 'month=' + month + '&name=' + name + '&_token=<?php echo e(csrf_token()); ?>',
                type: "POST",
                success: function(response) {
                    // alert(response);
                    $("#monthly_details").html(response);
        ...
        $(document).on("click", ".total_actual_monthly_expense", function() {
            ...
            $.ajax({
                ...
                data: 'year=' + year + '&name=' + name + '&_token=<?php echo e(csrf_token()); ?>',
                type: "POST",
                success: function(response) {
                    // alert(response);
                    $("#monthly_details").html(response);
        ...
        $(document).on("click", ".quaterly_total_expense", function() {
            ...
            $.ajax({
                ...
                data: 'month=' + month + '&year=' + year + '&_token=<?php echo e(csrf_token()); ?>',
                type: "POST",
                success: function(response) {
                    // alert(response);
                    $("#monthly_details").html(response);
    ...
    <script>
        ...
        function updateSubTotal() {
            ...
            document.getElementById("jan1").innerHTML = sumVal1.toLocaleString('en', {
                minimumFractionDigits: 0,
                maximumFractionDigits: 0
            });
            document.getElementById("feb2").innerHTML = sumVal2.toLocaleString('en', {
                minimumFractionDigits: 0,
                maximumFractionDigits: 0
            });
            document.getElementById("mar3").innerHTML = sumVal3.toLocaleString('en', {
                minimumFractionDigits: 0,
                maximumFractionDigits: 0
            });
            document.getElementById("apr4").innerHTML = sumVal4.toLocaleString('en', {
                minimumFractionDigits: 0,
                maximumFractionDigits: 0
            });
            document.getElementById("may5").innerHTML = sumVal5.toLocaleString('en', {
                minimumFractionDigits: 0,
                maximumFractionDigits: 0
            });
            document.getElementById("jun6").innerHTML = sumVal6.toLocaleString('en', {
                minimumFractionDigits: 0,
                maximumFractionDigits: 0
            });
            document.getElementById("jul7").innerHTML = sumVal7.toLocaleString('en', {
                minimumFractionDigits: 0,
                maximumFractionDigits: 0
            });
            document.getElementById("aug8").innerHTML = sumVal8.toLocaleString('en', {
                minimumFractionDigits: 0,
                maximumFractionDigits: 0
            });
            document.getElementById("sep9").innerHTML = sumVal9.toLocaleString('en', {
                minimumFractionDigits: 0,
                maximumFractionDigits: 0
            });
            document.getElementById("oct10").innerHTML = sumVal10.toLocaleString('en', {
                minimumFractionDigits: 0,
                maximumFractionDigits: 0
            });
            document.getElementById("nov11").innerHTML = sumVal11.toLocaleString('en', {
                minimumFractionDigits: 0,
                maximumFractionDigits: 0
            });
            document.getElementById("dec12").innerHTML = sumVal12.toLocaleString('en', {
                minimumFractionDigits: 0,
                maximumFractionDigits: 0
            });
            document.getElementById("total13").innerHTML = sumVal13.toLocaleString('en', {
                minimumFractionDigits: 0,
                maximumFractionDigits: 0
            });

            // Here New Line of profit
            document.getElementById("jan11").innerHTML = sumVal1.toLocaleString('en', {
                minimumFractionDigits: 0,
                maximumFractionDigits: 0
            });
            document.getElementById("feb21").innerHTML = sumVal2.toLocaleString('en', {
                minimumFractionDigits: 0,
                maximumFractionDigits: 0
            });
            document.getElementById("mar31").innerHTML = sumVal3.toLocaleString('en', {
                minimumFractionDigits: 0,
                maximumFractionDigits: 0
            });
            document.getElementById("apr41").innerHTML = sumVal4.toLocaleString('en', {
                minimumFractionDigits: 0,
                maximumFractionDigits: 0
            });
            document.getElementById("may51").innerHTML = sumVal5.toLocaleString('en', {
                minimumFractionDigits: 0,
                maximumFractionDigits: 0
            });
            document.getElementById("jun61").innerHTML = sumVal6.toLocaleString('en', {
                minimumFractionDigits: 0,
                maximumFractionDigits: 0
            });
            document.getElementById("jul71").innerHTML = sumVal7.toLocaleString('en', {
                minimumFractionDigits: 0,
                maximumFractionDigits: 0
            });
            document.getElementById("aug81").innerHTML = sumVal8.toLocaleString('en', {
                minimumFractionDigits: 0,
                maximumFractionDigits: 0
            });
            document.getElementById("sep91").innerHTML = sumVal9.toLocaleString('en', {
                minimumFractionDigits: 0,
                maximumFractionDigits: 0
            });
            document.getElementById("oct101").innerHTML = sumVal10.toLocaleString('en', {
                minimumFractionDigits: 0,
                maximumFractionDigits: 0
            });
            document.getElementById("nov111").innerHTML = sumVal11.toLocaleString('en', {
                minimumFractionDigits: 0,
                maximumFractionDigits: 0
            });
            document.getElementById("dec121").innerHTML = sumVal12.toLocaleString('en', {
                minimumFractionDigits: 0,
                maximumFractionDigits: 0
            });
            document.getElementById("total131").innerHTML = sumVal13.toLocaleString('en', {
                minimumFractionDigits: 0,
                maximumFractionDigits: 0
            });
        }
    ...
    <script>
        ...
        function updateSubTotal1() {
            ...
            for (var i = 1; i < table.rows.length; i++) {
                sumVal11 = sumVal11 + parseFloat((table.rows[i].cells[1].innerText).toString().replace(/,/g, ''))
            }

            for (var i = 1; i < table.rows.length; i++) {
                sumVal21 = sumVal21 + parseFloat((table.rows[i].cells[2].innerText).toString().replace(/,/g, ''))
            }

            for (var i = 1; i < table.rows.length; i++) {
                sumVal31 = sumVal31 + parseFloat((table.rows[i].cells[3].innerText).toString().replace(/,/g, ''))
            }

            for (var i = 1; i < table.rows.length; i++) {
                sumVal41 = sumVal41 + parseFloat((table.rows[i].cells[4].innerText).toString().replace(/,/g, ''))
            }

            for (var i = 1; i < table.rows.length; i++) {
                sumVal51 = sumVal51 + parseFloat((table.rows[i].cells[5].innerText).toString().replace(/,/g, ''))
            }

            for (var i = 1; i < table.rows.length; i++) {
                sumVal61 = sumVal61 + parseFloat((table.rows[i].cells[6].innerText).toString().replace(/,/g, ''))
            }

            for (var i = 1; i < table.rows.length; i++) {
                sumVal71 = sumVal71 + parseFloat((table.rows[i].cells[7].innerText).toString().replace(/,/g, ''))
            }

            for (var i = 1; i < table.rows.length; i++) {
                sumVal81 = sumVal81 + parseFloat((table.rows[i].cells[8].innerText).toString().replace(/,/g, ''))
            }

            for (var i = 1; i < table.rows.length; i++) {
                sumVal91 = sumVal91 + parseFloat((table.rows[i].cells[9].innerText).toString().replace(/,/g, ''))
            }

            for (var i = 1; i < table.rows.length; i++) {
                sumVal101 = sumVal101 + parseFloat((table.rows[i].cells[10].innerText).toString().replace(/,/g, ''))
            }

            for (var i = 1; i < table.rows.length; i++) {
                sumVal111 = sumVal111 + parseFloat((table.rows[i].cells[11].innerText).toString().replace(/,/g, ''))
            }

            for (var i = 1; i < table.rows.length; i++) {
                sumVal121 = sumVal121 + parseFloat((table.rows[i].cells[12].innerText).toString().replace(/,/g, ''))
            }

            for (var i = 1; i < table.rows.length; i++) {
                sumVal131 = sumVal131 + parseFloat((table.rows[i].cells[13].innerText).toString().replace(/,/g, ''))
            }
            document.getElementById("exp_1").innerHTML = sumVal11.toLocaleString('en', {
                minimumFractionDigits: 0,
                maximumFractionDigits: 0
            });
            document.getElementById("exp_2").innerHTML = sumVal21.toLocaleString('en', {
                minimumFractionDigits: 0,
                maximumFractionDigits: 0
            });
            document.getElementById("exp_3").innerHTML = sumVal31.toLocaleString('en', {
                minimumFractionDigits: 0,
                maximumFractionDigits: 0
            });
            document.getElementById("exp_4").innerHTML = sumVal41.toLocaleString('en', {
                minimumFractionDigits: 0,
                maximumFractionDigits: 0
            });
            document.getElementById("exp_5").innerHTML = sumVal51.toLocaleString('en', {
                minimumFractionDigits: 0,
                maximumFractionDigits: 0
            });
            document.getElementById("exp_6").innerHTML = sumVal61.toLocaleString('en', {
                minimumFractionDigits: 0,
                maximumFractionDigits: 0
            });
            document.getElementById("exp_7").innerHTML = sumVal71.toLocaleString('en', {
                minimumFractionDigits: 0,
                maximumFractionDigits: 0
            });
            document.getElementById("exp_8").innerHTML = sumVal81.toLocaleString('en', {
                minimumFractionDigits: 0,
                maximumFractionDigits: 0
            });
            document.getElementById("exp_9").innerHTML = sumVal91.toLocaleString('en', {
                minimumFractionDigits: 0,
                maximumFractionDigits: 0
            });
            document.getElementById("exp_10").innerHTML = sumVal101.toLocaleString('en', {
                minimumFractionDigits: 0,
                maximumFractionDigits: 0
            });
            document.getElementById("exp_11").innerHTML = sumVal111.toLocaleString('en', {
                minimumFractionDigits: 0,
                maximumFractionDigits: 0
            });
            document.getElementById("exp_12").innerHTML = sumVal121.toLocaleString('en', {
                minimumFractionDigits: 0,
                maximumFractionDigits: 0
            });
            document.getElementById("exp_13").innerHTML = sumVal131.toLocaleString('en', {
                minimumFractionDigits: 0,
                maximumFractionDigits: 0
            });
        }
    ...
    <script>
        ...
        function updateSubTotal2() {
            ...
            for (var i = 0; i < table.rows.length; i++) {
                profit1 = profit1 + parseFloat((table.rows[i].cells[1].innerText).toString().replace(/,/g, '')) -
                    parseFloat((table2.rows[i].cells[1].innerText).toString().replace(/,/g, ''));
            ...
            for (var i = 0; i < table.rows.length; i++) {
                profit2 = profit2 + parseFloat((table.rows[i].cells[2].innerText).toString().replace(/,/g, '')) -
                    parseFloat((table2.rows[i].cells[2].innerText).toString().replace(/,/g, ''));
            }

            for (var i = 0; i < table.rows.length; i++) {
                profit3 = profit3 + parseFloat((table.rows[i].cells[3].innerText).toString().replace(/,/g, '')) -
                    parseFloat((table2.rows[i].cells[3].innerText).toString().replace(/,/g, ''));
            }

            for (var i = 0; i < table.rows.length; i++) {
                profit4 = profit4 + parseFloat((table.rows[i].cells[4].innerText).toString().replace(/,/g, '')) -
                    parseFloat((table2.rows[i].cells[4].innerText).toString().replace(/,/g, ''));
            }

            for (var i = 0; i < table.rows.length; i++) {
                profit5 = profit5 + parseFloat((table.rows[i].cells[5].innerText).toString().replace(/,/g, '')) -
                    parseFloat((table2.rows[i].cells[5].innerText).toString().replace(/,/g, ''));
            }

            for (var i = 0; i < table.rows.length; i++) {
                profit6 = profit6 + parseFloat((table.rows[i].cells[6].innerText).toString().replace(/,/g, '')) -
                    parseFloat((table2.rows[i].cells[6].innerText).toString().replace(/,/g, ''));
            }

            for (var i = 0; i < table.rows.length; i++) {
                profit7 = profit7 + parseFloat((table.rows[i].cells[7].innerText).toString().replace(/,/g, '')) -
                    parseFloat((table2.rows[i].cells[7].innerText).toString().replace(/,/g, ''));
            }

            for (var i = 0; i < table.rows.length; i++) {
                profit8 = profit8 + parseFloat((table.rows[i].cells[8].innerText).toString().replace(/,/g, '')) -
                    parseFloat((table2.rows[i].cells[8].innerText).toString().replace(/,/g, ''));
            }

            for (var i = 0; i < table.rows.length; i++) {
                profit9 = profit9 + parseFloat((table.rows[i].cells[9].innerText).toString().replace(/,/g, '')) -
                    parseFloat((table2.rows[i].cells[9].innerText).toString().replace(/,/g, ''));
            }

            for (var i = 0; i < table.rows.length; i++) {
                profit10 = profit10 + parseFloat((table.rows[i].cells[10].innerText).toString().replace(/,/g, '')) -
                    parseFloat((table2.rows[i].cells[10].innerText).toString().replace(/,/g, ''));
            }

            for (var i = 0; i < table.rows.length; i++) {
                profit11 = profit11 + parseFloat((table.rows[i].cells[11].innerText).toString().replace(/,/g, '')) -
                    parseFloat((table2.rows[i].cells[11].innerText).toString().replace(/,/g, ''));
            }

            for (var i = 0; i < table.rows.length; i++) {
                profit12 = profit12 + parseFloat((table.rows[i].cells[12].innerText).toString().replace(/,/g, '')) -
                    parseFloat((table2.rows[i].cells[12].innerText).toString().replace(/,/g, ''));
            }

            for (var i = 0; i < table.rows.length; i++) {
                profit13 = profit13 + parseFloat((table.rows[i].cells[13].innerText).toString().replace(/,/g, '')) -
                    parseFloat((table2.rows[i].cells[13].innerText).toString().replace(/,/g, ''));
            }
            document.getElementById("profit_1").innerHTML = profit1.toLocaleString('en', {
                minimumFractionDigits: 0,
                maximumFractionDigits: 0
            });
            document.getElementById("profit_2").innerHTML = profit2.toLocaleString('en', {
                minimumFractionDigits: 0,
                maximumFractionDigits: 0
            });
            document.getElementById("profit_3").innerHTML = profit3.toLocaleString('en', {
                minimumFractionDigits: 0,
                maximumFractionDigits: 0
            });
            document.getElementById("profit_4").innerHTML = profit4.toLocaleString('en', {
                minimumFractionDigits: 0,
                maximumFractionDigits: 0
            });
            document.getElementById("profit_5").innerHTML = profit5.toLocaleString('en', {
                minimumFractionDigits: 0,
                maximumFractionDigits: 0
            });
            document.getElementById("profit_6").innerHTML = profit6.toLocaleString('en', {
                minimumFractionDigits: 0,
                maximumFractionDigits: 0
            });
            document.getElementById("profit_7").innerHTML = profit7.toLocaleString('en', {
                minimumFractionDigits: 0,
                maximumFractionDigits: 0
            });
            document.getElementById("profit_8").innerHTML = profit8.toLocaleString('en', {
                minimumFractionDigits: 0,
                maximumFractionDigits: 0
            });
            document.getElementById("profit_9").innerHTML = profit9.toLocaleString('en', {
                minimumFractionDigits: 0,
                maximumFractionDigits: 0
            });
            document.getElementById("profit_10").innerHTML = profit10.toLocaleString('en', {
                minimumFractionDigits: 0,
                maximumFractionDigits: 0
            });
            document.getElementById("profit_11").innerHTML = profit11.toLocaleString('en', {
                minimumFractionDigits: 0,
                maximumFractionDigits: 0
            });
            document.getElementById("profit_12").innerHTML = profit12.toLocaleString('en', {
                minimumFractionDigits: 0,
                maximumFractionDigits: 0
            });
            document.getElementById("profit_13").innerHTML = profit13.toLocaleString('en', {
                minimumFractionDigits: 0,
                maximumFractionDigits: 0
            });
        }
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mafamatest/public_html/resources/views/main/front_archives.blade.php ENDPATH**/ ?>