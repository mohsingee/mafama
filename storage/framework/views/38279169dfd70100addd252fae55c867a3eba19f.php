                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-12"
                            ...
                            <div class="col-md-6">
                                ...
                                <form action="<?php echo e(url('add_user_top_city_news')); ?>" method="POST" id=""
                                    ...
                                    <tr>
                                        ...
                                        <td width="20%">
                                            <a class="btn btn-xs btn-success"
                                                href="<?php echo e(url('edit_user_top_city_news') . '/' . $value->id); ?>">Edit</a>
                                            <form action="<?php echo e(url('delete_user_top_city_news')); ?>" method="POST"
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mafamatest/public_html/resources/views/setting/top_city_news.blade.php ENDPATH**/ ?>