		...
		<div class="nk-content-inner">
			<div class="nk-content-body">
				<div class="nk-block-head-content" style="margin-bottom:20px;">
					<h3 class="nk-block-title page-title">Home page top banner</h3>
					...
					<div class="card card-bordered card-stretch">
                        <div class="card-aside-wrap">
							<div class="card-inner card-inner-lg">
								<?php if(permission_access('top_banner_add')==1): ?>
           
								<form id="" action="<?php echo e(url('top_banner_entry')); ?>" method="POST" enctype="multipart/form-data">	
									<?php echo csrf_field(); ?>
									<div class="row gy-4">
										<div class="col-md-1">
								...
								<form action="<?php echo e(url('top_banner_paytime')); ?>" method="POST">
									<?php echo csrf_field(); ?>
									...
									<tbody>
										...
										<tr class="nk-tb-item">
											...
											<td class="nk-tb-col tb-col-md">
												<?php if(permission_access('top_banner_edit')==1): ?>
												<a href="<?php echo url('edittop_banner') ?>/<?= $banner->id ?>" class="btn btn-sm btn-primary">Edit</a>
												<?php endif; ?>
												<?php if(permission_access('top_banner_delete')==1): ?>
												<a href="<?php echo url('deletetop_banner') ?>/<?= $banner->id ?>" class="btn btn-sm btn-danger">Delete</a>
												<?php endif; ?>
											</td>
										</tr>
										<?php 
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mafamatest/public_html/resources/views/top_banner.blade.php ENDPATH**/ ?>