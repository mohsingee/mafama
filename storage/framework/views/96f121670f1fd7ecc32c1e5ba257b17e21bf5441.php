                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="col-md-12 margin-bottom-20">
                        <div class="heading-title heading-dotted col-md-12 margin-bottom-0 text-center">
                            <h4>Email Management / Email Campaign</h4>
                        </div>
                    </div>
                    <div class="col-md-12 text-center margin-bottom-20">
                        <span style="display:inline-block;max-width: 344px;width: 100%;">
                            ...
                            <input onclick="copy1()" class="copy-input" value="<?php echo e($my_profile_link); ?>" id="copyClipboard1"
                        ...
                        <span style="display:inline-block;max-width: 344px;width: 100%;">
                            ...
                            <input onclick="copy()" class="copy-input" value="<?php echo e($my_referral_link); ?>" id="copyClipboard"
                                style="margin-right:20px;" readonly>
                        </span>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="col-md-12"
                                        ...
                                        <div class="col-md-4">
                                            <p class="margin-bottom-0" style="font-size: 15px; color: #da291c;">Folders <a
                                                    href="<?php echo e(url('manage_contacts')); ?>" class="chk-sm"
                                                    style="color: #fff;margin-left:20px;font-weight:900;font-size:14px!important;background:#10c310e0;padding:4px">Manage/Add
                                                    Contact</a></p>
                                        </div>
                                        <div class="col-md-8 text-center email-btn">
                                            <div class="row">
                                                ...
                                                foreach($titles as $value){ ?>
                                                    <div class=" col-md-12 text-center item ">
                                                        <a onclick="titleClick(this.id)"
                                                            class="btn btn-xs btn-black btn-title"
                                                            id="<?php echo e($value->subject); ?>"><?php echo e($value->subject); ?></a>
                                                    </div>
                                                    <?php
                                                $cnt++;
                                                if($cnt == 5){
                                            ...
                                            ?>
                                                ...
                                                <a class="left carousel-control prev" href="javascript:void(0)"><i
                                                        class="glyphicon glyphicon-chevron-left"></i></a>
                                                <a class="right carousel-control next" href="javascript:void(0)"><i
                                    ...
                                    <div class="col-md-2"
                                        style="border-right: 1px solid #f6cbc9; overflow-x: hidden; overflow-y: scroll; height: 500px;">
                                        <h4 style="border-bottom: 1px solid #f6cbc9;">
                                            <label class="checkbox chk-sm" style="color: #da291c;">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="col-md-12 text-center email-btn" style="">
                                            <div class="row">
                                                <div class="col-md-12 text-center">
                                                    <a class="btn btn-xs btn-info text-center personalized_btn"
                                                        style="margin-top: 10px; margin-right: 3px; margin-bottom: 10px;">Personalized</a>
                                                    <a class="btn btn-xs btn-info text-center scripts_btn"
                                                        style="margin-top: 10px; margin-right: 3px; margin-bottom: 10px;">Scripts</a>
                                        ...
                                        <div class="col-md-12 personalized_sec" style="display: none">
                                            <div class="col-md-12 padding-0"
                                                ...
                                                <div class=""
                                                    style="margin-bottom: 10px; border: 1px solid #da291c; border-radius: 3px; padding: 0px 10px;">
                                                    <?php
                                                foreach($greetings as $value){
                                            ?>
                                                    <div class="text-left"
                                                        style="padding-left: 0px; display: inline-flex;">
                                                        <a class="btn btn-xs btn-black greetings"
                                                            style="padding: 3px 20px; margin-top: 10px; margin-bottom: 10px;"
                                                            id="<?= $value->greetings ?>"><?= $value->greetings ?></a>
                                                    </div>
                                                    <?php
                                                }
                                            ?>
                                        ...
                                        <div class="col-md-12 scripts_sec" style="display: none;">
                                            ...
                                            <div class="col-md-12 padding-0">
                                                ...
                                                ?>
                                                    <li class="script_cat <?php if ($c == 0) {
                                                        echo 'active';
                                                    } ?>"><a
                                                            href="#<?= $value->category ?>"
                                                ...
                                                ?>
                                                    <li class="script_cat"><a href="#<?= get_business_category() ?>"
                                                            data-toggle="tab"><?= get_business_category() ?></a></li>
                                                </ul>
                                                ...
                                                ?>
                                                    <div class="tab-pane fade in <?php if ($k == 0) {
                                                        ...
                                                        <div class="col-md-12 padding-0  parent-<?= $value->category ?>">
                                                            <?php 
                                                        foreach ($imgs as $img) { ?>
                                                            <div class="col-md-12 hide-child  child-<?= $value->category ?>"
                                                        ...
                                                        <div class="col-md-12 padding-0">
                                                            <a href="javascript:void(0)" data-id="<?= $value->category ?>"
                                                                class="btn btn-xs btn-danger text-center loadMore"><i
                                                                    class="fa fa-plus"></i></a>
                                                            <a href="javascript:void(0)" data-id="<?= $value->category ?>"
                                                                class="btn btn-xs btn-danger text-center showLess"><i
                                                ...
                                                ?>
                                                    <div class="tab-pane fade in " id="<?= get_business_category() ?>">
                                                        <div
                                                            class="col-md-12 padding-0 parent-<?= get_business_category() ?>">
                                                            <?= get_business_category_desc() ?>
                                                        </div>
                                                        <div class="col-md-12 padding-0">
                                                            <a href="javascript:void(0)"
                                                                data-id="<?= get_business_category() ?>"
                                                                class="btn btn-xs btn-danger text-center loadMore"><i
                                                                    class="fa fa-plus"></i></a>
                                                            <a href="javascript:void(0)"
                                                                data-id="<?= get_business_category() ?>"
                                                    ...
                                                    <input type="hidden" name="script_description"
                                        ...
                                        <div class="col-md-12 margin-top-20">
                                            <div class="form-group">
                                                <input type="hidden" class="form-control" placeholder="To"
                                                    id="malto" name="malto" />
                                            ...
                                            <div class="col-md-10 padding-0">
                                                <div class="fancy-file-upload fancy-file-danger">
                                                    ...
                                                    <input type="file" class="form-control" name="img_path"
                                                        ...
                                                        id="img_path" required />
                                                    <input type="text" class="form-control"
                                                        placeholder="no file selected" readonly="" id="imggg" />
                                            ...
                                            <div class="col-md-10 padding-0">
                                                <ul style="list-style-type: none; padding: 0; margin: 0">
                                                    <?php $__currentLoopData = $colors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <li class="color-td"
                                                            style="background-color: <?php echo e($color->color); ?>; display: inline-block;">
                                                        </li>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </ul>
                                                <!--  <table style="border: 1px solid #da291c4d; margin-bottom: 15px !important; margin-top: 15px;">
                                                    <tbody>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td class="color-td color41"></td>
                                                            <td class="color-td color42"></td>
                                                            <td class="color-td color43"></td>
                                                            <td class="color-td color44"></td>
                                                            <td class="color-td color45"></td>
                                                            <td class="color-td color46"></td>
                                                            <td class="color-td color47"></td>
                                                            <td class="color-td color48"></td>
                                                            <td class="color-td color49"></td>
                                                            <td class="color-td color50"></td>
                                                            <td class="color-td color51"></td>
                                                            <td class="color-td color52"></td>
                                                            <td class="color-td color53"></td>
                                                            <td class="color-td color54"></td>
                                                            <td class="color-td color55"></td>
                                                            <td class="color-td color56"></td>
                                                            <td class="color-td color57"></td>
                                                            <td class="color-td color58"></td>
                                                            <td class="color-td color59"></td>
                                                            <td class="color-td color60"></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="color-td color21"></td>
                                                            <td class="color-td color22"></td>
                                                            <td class="color-td color23"></td>
                                                            <td class="color-td color24"></td>
                                                            <td class="color-td color38"></td>
                                                            <td class="color-td color39"></td>
                                                            <td class="color-td color40"></td>
                                                            <td class="color-td color31"></td>
                                                            <td class="color-td color32"></td>
                                                            <td class="color-td color33"></td>
                                                            <td class="color-td color34"></td>
                                                            <td class="color-td color35"></td>
                                                            <td class="color-td color36"></td>
                                                            <td class="color-td color37"></td>
                                                            <td class="color-td color25"></td>
                                                            <td class="color-td color26"></td>
                                                            <td class="color-td color27"></td>
                                                            <td class="color-td color28"></td>
                                                            <td class="color-td color29"></td>
                                                            <td class="color-td color30"></td>
                                        ...
                                        <div class="col-md-12" style="">
                                            <div class="row">
                                                <div class="col-md-12 text-center email-btn" style="margin-top: 10px;">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-5th text-center" style="padding: 0px;">
                                                            <a class="btn btn-xs btn-info dateonsub"
                                                ...
                                                <div class="col-md-12 reminderon"
        ...
        $(document).ready(function() {
                    ...
                    if ($(".summernote").code() == "") {
                        ...
                        if (submit_value == "Send Now") {
                            ...
                            $.ajax({
                                ...
                                success: function(html) {
                                    ...
                                    if (html == "success") {
                                        ...
                                        notify('Email validity is expired', "info");
                                    }
                            ...
                            $.ajax({
                                ...
                                url: "email_campaign_send_with_reminder",
                                data: formData,
                                contentType: false,
                                cache: false,
                                processData: false,
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        var preview = '<div style="padding:10px; background-color:' + bakg +
                            ...
                            '</div><p style="margin-top: 10px;">' + greeting +
                            '</p><p style="margin-bottom: 0;">' + message + '</p></div>';
            ...
            $('.folder_check').change(function() {
                if ($(this).prop('checked')) {
                    ...
                    $.ajax({
                        url: url,
                        data: 'folder_arr=' + folder_arr + '&contactid=' + contactid +
                    ...
                    $.ajax({
                        ...
                        .then(function(data) {
                            $.ajax({
                                ...
                                data: 'remfolder=' + remfolder + '&_token=<?php echo e(csrf_token()); ?>',
                                type: "POST",
                                success: function(response) {
                                    // alert(response);
            ...
            $(".enter-mail-id").keydown(function(e) {
                if (e.keyCode == 13 || e.keyCode == 32) {
                    ...
                    $('.all-mail').append('<span class="email-ids"><span class="ema">' + getValue +
                        '</span><span class="cancel-email">x</span></span>');
                    var mail_arr = [];
            ...
            $(document).on('click', '.contact_mail', function() {
                ...
                if ($(this).prop('checked')) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            // alert(response);
                            $('.all-mail').append('<span class="email-ids"><span class="ema">' +
                                response +
                                '</span><span class="cancel-email">x</span></span>');
                            var mail_arr = [];
                            $(".email-ids .ema").each(function() {
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mafamatest/public_html/resources/views/email_campaign.blade.php ENDPATH**/ ?>