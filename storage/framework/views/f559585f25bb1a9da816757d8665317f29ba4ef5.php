                     ...
                     <div class="row bg-white" style="border: 1px solid #da291c !important; ">
                             ...
                             <div class="owl-carousel nomargin"
                                 ...
                                 <div class="card text-center">
                                     <div class="card-header" style="height:100px;">
                                         <h4 class="text-center truncate margin-top-20" style="font-size:auto">
                         ...
                         <div class="col-md-2 bg-white text-center">
                             <div class="heading-title  col-md-12 margin-bottom-0 text-center">
                                 ...
                                 <h4 class="bg-white f-28 margin-top-20"><b class="f-36 f_blue f-Cali">Welcome to</b><br>
                                    <span class="f-b">
                             ...
                             <?php if(!empty($middle)): ?>
                             <div class="margin-top-20 text-left f_blue margin-bottom-10"><?php echo $middle->description; ?></div>
                             <?php endif; ?>
                                     ...
                                     <tbody>
                                         ...
                                         <tr>
                                             ...
                                             <td>
                                                  ...
                                                  <?php if( isset($value->birth_state) ): ?>
                                                   <span class="bfh-states " style="color: #666"  data-country="<?php echo e($value->birth_country); ?>" data-state="<?php echo e($value->birth_state); ?>"></span>
                                                   <?php elseif( isset($value->birth_commune) ): ?>
                                                   <?php echo e(showcommuneName($value->birth_commune)); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mafamatest/public_html/resources/views/my_birthplace_list.blade.php ENDPATH**/ ?>