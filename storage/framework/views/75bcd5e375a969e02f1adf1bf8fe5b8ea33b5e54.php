								...
								<table class="table">
									...
									<tbody>
										...
										<tr>
											...
											<td style="border:0px!important; <?php if($details[0]->birth_country != "HT"): ?> display:none <?php endif; ?>">Commune<input type="text" class="form-control" value="<?php echo e((isset($details[0]->birth_commune)) ? showcommuneName($details[0]->birth_commune) : ''); ?>" disabled></td>
																									
											<td style="border:0px!important; <?php if($details[0]->birth_country == "HT"): ?> display:nonel <?php endif; ?>">State
