                                        ...
                                        <div class="col-md-12 padding-0">
                                            <label class="checkbox chk-sm">
                                                <input type="checkbox" value="<?= $value->id ?>"
                                                    <?php echo e(!empty($id) && $value->id == $id ? 'checked' : ''); ?>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <input type="text" class="form-control" placeholder="Campaign Name"
                                                    id="campaign_name" name="campaign_name" required />
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                            ...
                                            <div class="col-md-10 padding-0">
                                                <div class="fancy-file-upload fancy-file-danger">
                                                    ...
                                                    <input type="file" class="form-control" name="img_path"
                                                        onchange="jQuery(this).next('input').val(this.value);" required />
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mafamatest/public_html/resources/views/send_email.blade.php ENDPATH**/ ?>