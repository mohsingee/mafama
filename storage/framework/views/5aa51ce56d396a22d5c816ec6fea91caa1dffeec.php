        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-3">
                ...
                <ul class="nav nav-tabs nav-stacked nav-alternate">
                    ...
                    <li class="">
                        <a href="<?php echo e(url('back-office')); ?>">
                            Back Office
                        </a>
                    </li>
                    <?php else: ?>
                    ...
                    <li>
                        <a href="<?php echo e(url('change_password_front')); ?>">
                            Change Password
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(url('user_access_rights')); ?>">
                            User Access
                        </a>
                    </li>
                    <li>
                    ...
                    <?php if (Auth::id() != "") { ?>
                        <?php if ((Auth::user()->role == "affiliate")) { ?>
                            <li>
                                <a href="<?php echo e(url('front_dashboard')); ?>">
                                    Dashboard
                                </a>
                            </li>
                    <?php }
            ...
            <!-- <?php if(Auth::id() != ""): ?>
                ...
                <?php endif; ?> -->
            <div class="col-md-<?php echo e((Auth::id() != "")?9:12); ?> col-sm-<?php echo e((Auth::id() != "")?9:12); ?>">
                            ...
                            <div class="row">
                                <!--<div class="col-md-4">
                                            <div class="outer-divv" >
                                                <div class="">
                                                    <a href="#">
                                                        <img src="<?php echo e(asset('public/images/maxresdefault.jpg')); ?>" style="width:100%;height:180px;" alt="">
                                                    </a>
                                                </div>
                                            ...
                                            <div class="testimonial">
                                                <div class="col-md-12 testimonial-bordered">
                                                    ...
                                                    <div class="testimonial-content nopadding">
                                                        ...
                                                        <cite>
                                                            <?= $slide->username ?>
                                                            <span class="text-success">New Member</span>
                                                        </cite>
                                                    </div>
                                                </div>
                                            </div>
    ...
    <!-- display: flex; align-items: center; justify-content: center; flex-wrap: wrap; padding-bottom:20px; -->
                                       ...
                                       <div  class="col-md-4">
                                               <div class="form-group">
                                                   ...
                                                   <input type="text" class="form-control" placeholder="Profile First Name" name="first_name" required value="<?php echo e(old('first_name')); ?>" required>
                                               </div>
                                           </div>
                                           <div  class="col-md-4">
                                               <div class="form-group">
                                           ...
                                           <div style="width: 35rem;" class="col-md-4">
                                               <div class="form-group">
                                                   ...
                                                   <input style="width: 32rem;" class="form-control" placeholder="" onchange="getPhoneNo()" id="cellphone" name="format-cellphone" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" type="tel" maxlength="10" value="<?php echo e(old('cellphone')); ?>" required>
                                           ...
                                           <div style="width: 35rem;" class="col-md-4">
                                               <div class="form-group">
                                                   ...
                                                   <input style="width: 32rem;" type="tel" class="form-control" placeholder="" id="business_telephone" name="business_telephone_inp" onchange="getBusinessPhoneNo()" value="<?php echo e(old('business_telephone')); ?>" required>
                                           ...
                                           <div style="width: 35rem" class="col-md-4">
                                               <div class="form-group">
                                                   ...
                                                   <input type="hidden" name="dob" class="form-control" data-date-format="DD MMMM YYYY" value="<?= date('Y-m-d') ?>" id="sendon" value="<?php echo e(old('dob')); ?>">
                                                   <select id="dob_day" name="day" class="bg-white width-100" required>
                                                       <option value="0">Day</option>
                                                       <?php for($i=01; $i<=31; $i++): ?> <option value="<?php echo e($i); ?>"><?php echo e($i); ?></option>
                                                           <?php endfor; ?>
                                                   </select>
                                                   ...
                                                   <select id="dob_year" name="year" class="bg-white width-100" required>
                                                       ...
                                                       <?php for($i=$year_start; $i<=$year_end; $i++): ?> <option value="<?php echo e($i); ?>"><?php echo e($i); ?></option>
                                                           <?php endfor; ?>
                                                   </select>
                                           ...
                                           <div style="width: 35rem" class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <?php $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                   <!-- <div class="plan_card"> -->
                                                   <label class="form-control selectedplan" data-id="<?php echo e($plan->id); ?>" data-fees="<?php echo e($plan->monthly_fee); ?>" onclick="checkValue()">
                                                   <!-- <input type="radio" name="selectedplan" > -->
                                                   <p class="plan_card">    
                                                       <?php echo e($plan->name); ?> 
                                                       
                                                       <span>
                                                       <?php echo e($plan->monthly_fee); ?>/per month
                                                       </span>
                                                   </p>
                                                   </label>
                                                   <!-- </div> -->
...
<div id="tab_t" class="tab-pane <?php echo e(request()->has('year') ? 'active' : ''); ?>">

    <h4>Transactions</h4>

    <div class="row">
        <?php if(!empty($transaction_section_one)): ?>
        <div class="col-sm-6 first-column ">
            <div class="regsection">
                <?php echo $transaction_section_one->description; ?>

            </div>
        </div>
        <?php endif; ?>
        <?php if(!empty($transaction_section_two)): ?>
        <div class="col-sm-6 second-column">
            <div class="regsection">
                <?php echo $transaction_section_two->description; ?>
    ...
    <div class="year-filter-wraper">
        <a href="/?year=2023#tab_t" class="<?php echo e((Request::get('year') == '2023' ) ? 'active1' : ''); ?> btn btn-md btn-info margin-right-10">2023</a>
        <a href="/?year=2022#tab_t" class="<?php echo e((Request::get('year') == '2022' ) ? 'active1' : ''); ?> btn btn-md btn-info margin-right-10">2022</a>
    </div>
    <table class="table table-striped table-bordered table-hover">
        <thead>
            <tr>
                ...
                ?>
                <?php $__currentLoopData = $months_arr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $valuee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                
                <th id="month_record" class="tab1"><?php echo e(date("M", mktime(0, 0, 0, $valuee, 10))); ?></th>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <table class="table table-striped table-bordered table-hover my_tbl" id="datatable_sample">
        ...
        <tbody class="tabb">
            ...
            ?>
            <tr>
                <td style="width: 2% !important"><?php echo e($trans['code']??""); ?></td>
                <td class="<?php echo e($class); ?> <?php echo e($class_les); ?>" style="width: 5% !important"><b>$</b><?php echo e($trans['amount']); ?></td>
                <td>
                    <?php if($trans['description'] == "Level commission income received for joining in network"): ?>
                    Downline Earning
                    <?php endif; ?>

                    <?php if($trans['description'] == "Affiliate level commission received"): ?>
                    Direct Earning
                    <?php endif; ?>

                    <?php if($trans['description'] != "Level commission income received for joining in network" && $trans['description'] != "Affiliate level commission received"): ?>
                ...
                <td><?php echo e($trans['first_name'] ?? ""); ?> <?php echo e($trans['last_name'] ?? ""); ?></td>
                <td><?php echo e($trans['country'] ?? ""); ?></td>
                <td style="width: 15% !important"><?php echo e($trans['state'] ?? ""); ?> <?php echo e($trans['city'] ?? ""); ?> <?php echo e($trans['commune'] ?? ""); ?></td>
                <td style="width: 14% !important"><?php echo e(($trans['created_at'])->format('d M Y')); ?></td>
                <td><?php echo e(($trans['created_at'])->format('h:i A')); ?></td>
            </tr>
        ...
        <tfoot style="background: purple !IMPORTANT">
            ...
            <td id="totaly" style="color: white !important; font-weight:600 !important">$<?php echo e($tootal); ?></td>
                ...
                <h4 class="modal-title" id="myModalLabel">Welcome to Mafama.</h4>
                 <div class="modal-body ">
                     <h4 style="border-bottom: 1px solid #f6cbc9;">
                                <?php echo e($plan_expire_message); ?>
        ...
        <div class="modal-content ">
            ...
            <form id="form-id" method="POST" role="form" enctype="multipart/form-data">
                ...
                <div class="modal-body ">
                    <?php if ($abanner != "") { ?>
                        <div class="col-md-12">
                            <div style="padding: 0 10px"><?php echo $abanner->preview; ?></div>
                        </div>
                    <?php } ?>
                    <div class="col-md-12">
                        <?php
                        ...
                        ?>
                            <ul style="list-style: none; padding: 0; margin-bottom: 0px">
                                ...
                                ?>
                                    <li class="affiliate_popup1" style="padding: 10px; float: left; margin-bottom: 10px;" id="po<?= $value->id ?>"><?php echo $value->preview; ?></li>
                                <?php
                                }
                                ?>
                            </ul>
                    ...
                    <?php if($popup_setting != ""): ?>
                    <?php if($popup_setting->email_status == '1'): ?>
                    <?php $mailstatus = ""; ?>
                    <?php if($popup_mail != ""): ?>
                    <?php
...
<?php if($current_plan_total_day > 29): ?>
...
<script type="text/javascript">
 $(".plan_expired_popup_close").click(function(){
    ...
    function folder_check_doc() {
        ...
        $.ajax({
            url: url,
            data: 'folder_arr=' + folder_arr + '&contactid=' + contactid + '&_token=<?php echo e(csrf_token()); ?>',
            type: "POST",
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mafamatest/public_html/resources/views/main.blade.php ENDPATH**/ ?>