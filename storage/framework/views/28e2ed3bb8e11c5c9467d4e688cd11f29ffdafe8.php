...
<link
   ...
   <!-- phone format input library cdn end -->
    ...
    <!-- REVOLUTION SLIDER -->
    <link href="<?php echo e(asset('assets/plugins/slider.revolution/css/extralayers.css')); ?>" rel="stylesheet" type="text/css" />
    <link href="<?php echo e(asset('assets/plugins/slider.revolution/css/settings.css')); ?>" rel="stylesheet" type="text/css" />

    <link href="<?php echo e(asset('assets/css/essentials.css')); ?>" rel="stylesheet" type="text/css" />
    <link href="<?php echo e(asset('assets/css/layout.css')); ?>" rel="stylesheet" type="text/css" />
    <!-- PAGE LEVEL SCRIPTS -->
    <link href="<?php echo e(asset('assets/css/header-1.css')); ?>" rel="stylesheet" type="text/css" />
    <link href="<?php echo e(asset('assets/css/color_scheme/green.css')); ?>" rel="stylesheet" type="text/css" id="color_scheme" />
    <link href="<?php echo e(asset('assets/css/layout-datatables.css')); ?>" rel="stylesheet" type="text/css" />
    <link href="<?php echo e(asset('custom.css')); ?>" rel="stylesheet" type="text/css" />
    <link rel="stylesheet" href="<?php echo e(asset('fullcalendar/fullcalendar.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('fullcalendar/fullcalendar.print.css')); ?>" media="print">
    <link rel="stylesheet"
            ...
            <div class="container">
                <nav class="nav-main" style="text-align: center;">
                    <ul id="" class="nav nav-pills text-danger nav-main text-center"
                        ...
                        <li class="margin-right-10"><input name="en" value="en" class="language_check mr-4"
                                type="checkbox" <?php echo e($lang_code == 'en' ? 'checked' : ''); ?> /> <img
                                class="flag-lang language_flags" src="<?php echo e(asset('assets/images/flags/us.png')); ?>"
                                alt="lang" /> English</a></li>
                        <li class="margin-right-10"><input name="es" value="es" class="language_check mr-4"
                                type="checkbox" <?php echo e($lang_code == 'es' ? 'checked' : ''); ?> /> <img
                                class="flag-lang language_flags" src="<?php echo e(asset('assets/images/flags/es.png')); ?>"
                                alt="lang" /> Espagnol</a></li>
                        <li class="margin-right-10"><input name="fr" value="fr" class="language_check mr-4"
                                type="checkbox" <?php echo e($lang_code == 'fr' ? 'checked' : ''); ?> /> <img
                                class="flag-lang language_flags" src="<?php echo e(asset('assets/images/flags/fr.png')); ?>"
                                alt="lang" /> Francais</a></li>
                        <li class="margin-right-10"><input name="ht" value="ht" class="language_check mr-4"
                                type="checkbox" <?php echo e($lang_code == 'ht' ? 'checked' : ''); ?> /> <img
                                class="flag-lang language_flags" src="<?php echo e(asset('assets/images/flags/ht.png')); ?>"
                                alt="lang" /> Kreyol Haiten</a></li>
                        <li class="margin-right-10"><input name="ar" value="ar" class="language_check mr-4"
                                type="checkbox" <?php echo e($lang_code == 'ar' ? 'checked' : ''); ?> /> <img
                                class="flag-lang language_flags" src="<?php echo e(asset('assets/images/flags/sa.png')); ?>"
                                alt="lang" /> Arabic</a></li>
                        <li class="margin-right-10"><input name="pt" value="pt" class="language_check mr-4"
                                type="checkbox" <?php echo e($lang_code == 'pt' ? 'checked' : ''); ?> /> <img
                                class="flag-lang language_flags" src="<?php echo e(asset('assets/images/flags/pt.png')); ?>"
                                alt="lang" /> Portuguese</a></li>
                        <li class="margin-right-10"><input name="ko" value="ko" class="language_check mr-4"
                                type="checkbox" <?php echo e($lang_code == 'ko' ? 'checked' : ''); ?> /> <img
                                class="flag-lang language_flags" src="<?php echo e(asset('assets/images/flags/kr.png')); ?>"
                                alt="lang" /> Korean</a></li>
                        <li class="margin-right-10"><input name="sw" value="sw" class="language_check mr-4"
                                type="checkbox" <?php echo e($lang_code == 'sw' ? 'checked' : ''); ?> /> <img
                                class="flag-lang language_flags" src="<?php echo e(asset('assets/images/flags/tz.png')); ?>"
                                alt="lang" /> Swahili</a></li>
                        <li class="margin-right-10"><input name="de" value="de" class="language_check mr-4"
                                type="checkbox" <?php echo e($lang_code == 'de' ? 'checked' : ''); ?> /> <img
                                class="flag-lang language_flags" src="<?php echo e(asset('assets/images/flags/de.png')); ?>"
                ...
                <div class="row">
                    <div class="col-md-4 col-xs-12 padding-0">
                        ...
                        <li>
                            <a class="dropdown-toggle no-text-underline" data-toggle="dropdown" href="#"><img class="flag-lang" src="<?php echo e(asset('assets/images/flags/us.png')); ?>" width="16" height="11" alt="lang" /> ENGLISH</a>
                            <ul class="dropdown-langs dropdown-menu">
                                <li><a tabindex="-1" href="#"><img class="flag-lang" src="<?php echo e(asset('assets/images/flags/us.png')); ?>" width="16" height="11" alt="lang" /> ENGLISH</a></li>
                                <li class="divider"></li>
                                <li><a tabindex="-1" href="#"><img class="flag-lang" src="<?php echo e(asset('assets/images/flags/de.png')); ?>" width="16" height="11" alt="lang" /> GERMAN</a></li>
                                <li><a tabindex="-1" href="#"><img class="flag-lang" src="<?php echo e(asset('assets/images/flags/ru.png')); ?>" width="16" height="11" alt="lang" /> RUSSIAN</a></li>
                                <li><a tabindex="-1" href="#"><img class="flag-lang" src="<?php echo e(asset('assets/images/flags/it.png')); ?>" width="16" height="11" alt="lang" /> ITALIAN</a></li>
                            </ul>
                        </li>
                    </ul>-->
                        <ul class="top-links list-inline">
                            ...
                            <li>
                                <?php if(auth()->guard()->guest()): ?>
                                    <?php if(isset($status[0]->affiliatedisplay) && $status[0]->affiliatedisplay == 'on'): ?>
                                        <a href="<?php echo e(url('affiliate_registration')); ?>" class="btn btn-lg btn-info"
                    ...
                    <div class="col-md-4 col-xs-12 padding-0 text-center top-bar-sidediv">
                        ...
                        <?php else: ?>
                            <a data-clipboard-text="<?php echo e($mysharing_link); ?>" href="javascript:void(0)"
                                class="btn btn-lg btn-info clipboard"
                                style="width: 80%; line-height: 18px; font-size: 15px;">SHARE LINK</a>
                            <div class="margin-top-10">
                                <a class="btn btn-sm btn-success rounded"
                                    href="https://wa.me/?text=<?php echo e($mysharing_link); ?>" style="line-height: 10px;">
                                    <i class="fa fa-whatsapp fa-3x padding-0"></i>
                                </a>
                            </div>
                        <?php endif; ?>
                    ...
                    <div class="col-md-4 col-xs-12 padding-0 top-bar-sidediv">
                        ...
                        <?php if(auth()->guard()->guest()): ?>
                            <form method="POST" action="<?php echo e(route('login')); ?>" style="margin-bottom: 0">
                                <?php echo csrf_field(); ?>
                            ...
                            <div class="nav-item dropdown text-right userdrop">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    <?php
                                        ...
                                        ?>
                                    <li>
                                        <a href="<?php echo e(url('change_password_front')); ?>">Change Password</a>
                                    </li>
                                    <?php } ?>
                                    <li>
...
//echo Route::currentRouteName();
        ...
        <div class="row margin-top-10 margin-bottom-10">
            ...
            <div class="col-md-6 padding-0">
                ...
                <div class="col-md-6"
                    ...
                    <a href="<?php echo e(url('business_registration')); ?>" class="btn btn-lg btn-info"
                        style="width: 100%;">Register a Business</a>
                </div>
                <div class="col-md-6"
                    style="margin-top: 10px; text-align: center; padding-left: 5px; padding-right: 10px;">
                    <form action="<?php echo e(url('search_a_business')); ?>" role="form" method="post"
        ...
        <?php
            ...
            ?>
        <?php echo $__env->yieldContent('abanner'); ?>
            ...
            <div id="header" class="sticky clearfix">
                ...
                <header id="topNav">
                    <div class="container">
                        ...
                        <!-- Logo -->
                        <!--<a class="logo pull-left" href="<?php echo e(url('/')); ?>">
                            <img src="<?php echo e(asset('images/logo1.jpg')); ?>" alt="" />
                        </a>-->
                        <!--
                            Top Nav
                        ...
                        <div class="navbar-collapse nav-main-collapse collapse submenu-dark" style="float: none;">
                            ...
                            <nav class="nav-main" style="text-align: center;">
                                <ul id="topMain" class="nav nav-pills nav-main text-center"
                                    ...
                                    <li><a href="<?php echo e(url('/')); ?>"><i class="fas fa-home"
                                                style="font-style: normal"></i></a></li>
                                    <li><a href="<?php echo e(url('notifications')); ?>">
                                            <div class="noti_sec"><i class="fas fa-bell"></i><span
                                                    class="noti_count"><?php echo e(notification_count()); ?></span></div>
                                        </a></li>
                                    <li><a href="<?php echo e(url('front_dashboard')); ?>">Dashboard</a></li>
                                    <?php }else{ ?>
                                                        ...
                                                        <ul class="list-unstyled">
                                                            <li>
                                                                <?php
                                                                            ...
                                                                            ?>
                                                                <a href="<?php echo e(url('profile')); ?>"><i
                                                            ...
                                                            <li>
                                                                <?php
                                                                            ...
                                                                            ?>
                                                                <a href="<?php echo e(url('banner')); ?>"><i
                                                            ...
                                                            <!--  <li>
                                                                            ...
                                                                            ?>
                                                                                    <a href="<?php echo e(url('import_contacts')); ?>"><i class="fa fa-caret-square-o-right"></i> Import Contact</a>
                                                                            <?php
                                                                                }
                                                                            ?>
                                                                        </li> -->
                                                            <li>
                                                                <?php
                                                                            ...
                                                                            ?>
                                                                <a href="<?php echo e(url('user_access_rights')); ?>"><i
                                                            ...
                                                            <li>
                                                                <?php
                                                                            ...
                                                                            ?>
                                                                <a href="<?php echo e(url('survey_polls')); ?>"><i
                                                                        class="fa fa-caret-square-o-right"></i>
                                                                    Survey/Polls</a>
                                                                <?php
                                                                                }
                                                            ...
                                                            <li>
                                                                <?php
                                                                            ...
                                                                            ?>
                                                                <a href="<?php echo e(url('add_appointment_setting')); ?>"><i
                                                                        class="fa fa-caret-square-o-right"></i>
                                                                    Appointment</a>
                                                                <?php
                                                                                }
                                                        ...
                                                        <ul class="list-unstyled">
                                                            <li>
                                                                <?php
                                                                            ...
                                                                            ?>
                                                                <a href="<?php echo e(url('client_mgmt_setting')); ?>"><i
                                                            ...
                                                            <li>
                                                                <?php
                                                                            ...
                                                                            ?>
                                                                <a href="<?php echo e(url('email_mgmt_setting')); ?>"><i
                                                            ...
                                                            <li>
                                                                <?php
                                                                            ...
                                                                            ?>
                                                                <a href="<?php echo e(url('financial_mgmt_setting')); ?>"><i
                                                                        class="fa fa-caret-square-o-right"></i>
                                                            ...
                                                            <li>
                                                                <?php
                                                                            ...
                                                                            ?>
                                                                <a href="<?php echo e(url('forms_library')); ?>"><i
                                                            ...
                                                            <li>
                                                                <?php
                                                                            ...
                                                                            ?>
                                                                <a href="<?php echo e(url('setting_tutorials')); ?>"><i
                                                                        class="fa fa-caret-square-o-right"></i>
                                                                    Tutorial</a>
                                                                <?php
                                                                                }
                                                            ...
                                                            <li>
                                                                ...
                                                                ?>
                                                                <a href="<?php echo e(url('setting_birthplace')); ?>"><i
                                                                        class="fa fa-caret-square-o-right"></i>
                                                            ...
                                                            <li>
                                                                <a href="<?php echo e(url('setting_art_and_culture')); ?>"><i
                                                                        class="fa fa-caret-square-o-right"></i>
                                                                    Art and Culture</a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(url('setting_top_city_news')); ?>"><i
                                                                        class="fa fa-caret-square-o-right"></i>
                                                                    Top City News</a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(url('setting_my_faith')); ?>"><i
                                                                        class="fa fa-caret-square-o-right"></i>
                                                                    My Faith</a>
                                                            </li>
                                                            <?php if(Auth::check()): ?>
                                                                ...
                                                                <?php if($plan == 0): ?>
                                                                    ...
                                                                    <?php if(Auth::user()->role == 'affiliate_user'): ?>
                                                                        <li>
                                                                            <a href="<?php echo e(url('renew-plan')); ?>"><i
                                                                                    class="fa fa-caret-square-o-right"></i>
                                                                                Renew Plan</a>
                                                                        </li>
                                                                    <?php endif; ?>
                                                        ...
                                                        <ul class="list-unstyled">
                                                            <li>
                                                                <?php
                                                                            ...
                                                                            ?>
                                                                <a href="<?php echo e(url('manage_appointment')); ?>"><i
                                                            ...
                                                            <li>
                                                                <?php
                                                                            ...
                                                                            ?>
                                                                <a href="<?php echo e(url('change_appointment')); ?>"><i
                                                            ...
                                                            <li>
                                                                <?php
                                                                            ...
                                                                            ?>
                                                                <a href="<?php echo e(url('cancel_appointment')); ?>"><i
                                                            ...
                                                            <li>
                                                                <?php
                                                                            ...
                                                                            ?>
                                                                <a href="<?php echo e(url('comparison_appointment')); ?>"><i
                                                                        class="fa fa-caret-square-o-right"></i>
                                                    ...
                                                    <div class="col-md-6">
                                                        <ul class="list-unstyled">
                                                            <!-- <li>
                                                                            ...
                                                                            ?>
                                                                                    <a href="<?php echo e(url('add_client')); ?>"><i class="fa fa-caret-square-o-right"></i> Add Client</a>
                                                                            <?php
                                                                                }
                                                                            ?>
                                                                        </li> -->
                                                            ...
                                                            <li>
                                                                <?php
                                                                            ...
                                                                            ?>
                                                                <a href="<?php echo e(url('appointment_step1')); ?>"><i
                                                            ...
                                                            <li>
                                                                <?php
                                                                            ...
                                                                            ?>
                                                                <a href="<?php echo e(url('appointment_tutorials')); ?>"><i
                                                                        class="fa fa-caret-square-o-right"></i>
                                                                    Tutorial</a>
                                                                <?php
                                                                                }
                                                        ...
                                                        <ul class="list-unstyled">
                                                            <li>
                                                                <?php
                                                                            ...
                                                                            ?>
                                                                <a href="<?php echo e(url('add_client')); ?>"><i
                                                            ...
                                                            <li>
                                                                <?php
                                                                            ...
                                                                            ?>
                                                                <a href="<?php echo e(url('manage_clients')); ?>"><i
                                                                        class="fa fa-caret-square-o-right"></i> Manage
                                                                    Client Profile</a>
                                                                <?php
                                                                                }
                                                            ...
                                                            <li>
                                                                <?php
                                                                            ...
                                                                            ?>
                                                                <a href="<?php echo e(url('schedule_birthday')); ?>"><i
                                                                        class="fa fa-caret-square-o-right"></i>
                                                                    Scheduler</a>
                                                                <?php
                                                                                }
                                                    ...
                                                    <div class="col-md-6">
                                                        <ul class="list-unstyled">
                                                            <!--  <li>
                                                                            ...
                                                                            ?>
                                                                                    <a href="<?php echo e(url('comparison_client')); ?>"><i class="fa fa-caret-square-o-right"></i> Comparison</a>
                                                                            <?php
                                                                                }
                                                                            ?>
                                                                        </li> -->
                                                            <li>
                                                                <?php
                                                                            ...
                                                                            ?>
                                                                <a href="<?php echo e(url('profile_info')); ?>"><i
                                                                        class="fa fa-caret-square-o-right"></i> Client
                                                                    Access</a>
                                                                <?php
                                                                                }
                                                            ...
                                                            <?php if(Auth::check()): ?>
                                                                <?php if(Auth::user()->role == 'affiliate'): ?>
                                                                    ...
                                                                    ?>
                                                                        <a href="<?php echo e(url('client-survey-records')); ?>"><i
                                                                                class="fa fa-caret-square-o-right"></i>
                                                            ...
                                                            <li>
                                                                <?php
                                                                            ...
                                                                            ?>
                                                                <a href="<?php echo e(url('client_tutorials')); ?>"><i
                                                                        class="fa fa-caret-square-o-right"></i>
                                                                    Tutorial</a>
                                                                <?php
                                                                                }
                                                        ...
                                                        <ul class="list-unstyled">
                                                            <li>
                                                                <?php
                                                                                ...
                                                                                ?>
                                                                <a href="<?php echo e(url('email_campaign')); ?>"><i
                                                                        class="fa fa-caret-square-o-right"></i> Email
                                                                    Campaign</a>
                                                                <?php
                                                                                    }
                                                            ...
                                                            <li>
                                                                <?php
                                                                                ...
                                                                                ?>
                                                                <a href="<?php echo e(url('send_email')); ?>"><i
                                                            ...
                                                            <li>
                                                                <?php
                                                                                ...
                                                                                ?>
                                                                <a href="<?php echo e(url('send_cards')); ?>"><i
                                                                        class="fa fa-caret-square-o-right"></i> Send
                                                                    Cards</a>
                                                                <?php
                                                                                    }
                                                            ...
                                                            <li>
                                                                <?php
                                                                                ...
                                                                                ?>
                                                                <a href="<?php echo e(url('send_video')); ?>"><i
                                                                        class="fa fa-caret-square-o-right"></i> Send
                                                                    Videos</a>
                                                                <?php
                                                                                    }
                                                        ...
                                                        <ul class="list-unstyled">
                                                            <li>
                                                                <?php
                                                                                ...
                                                                                ?>
                                                                <a href="<?php echo e(url('send_sms')); ?>"><i
                                                                        class="fa fa-caret-square-o-right"></i> Send
                                                                    SMS</a>
                                                                <?php
                                                                                    }
                                                            ...
                                                            <li>
                                                                <?php
                                                                                ...
                                                                                ?>
                                                                <a href="<?php echo e(url('comparison_email')); ?>"><i
                                                                        class="fa fa-caret-square-o-right"></i>
                                                                    Comparison</a>
                                                                <?php
                                                                                    }
                                                            ...
                                                            <li>
                                                                <?php
                                                                                ...
                                                                                ?>
                                                                <a href="<?php echo e(url('manage_folders')); ?>"><i
                                                                        class="fa fa-caret-square-o-right"></i>
                                                                    Manage</a>
                                                                <?php
                                                                                    }
                                                            ...
                                                            <!--<li class="li-submenu"><a class="" href="javascript:void(0);"><i class="fa fa-caret-square-o-right"></i> Manage<i class="fa fa-angle-down pull-right" style="margin-top:5px;"></i></a></a>
                                                                                <ul class="list-unstyled submenu-ul" style="display: none;">
                                                                                    <li><a href="<?php echo e(url('manage_folders')); ?>"><i class="fa fa fa-circle"></i> Manage Folders</a></li>
                                                            ...
                                                            <li>
                                                                <?php
                                                                                ...
                                                                                ?>
                                                                <a href="<?php echo e(url('email_tutorials')); ?>"><i
                                                                        class="fa fa-caret-square-o-right"></i>
                                                                    Tutorial</a>
                                                                <?php
                                                                                    }
                                                    ...
                                                    <div class="col-md-6">
                                                        <ul class="list-unstyled">
                                                            <!--<li class="li-submenu"><a class="" href="javascript:void(0);"><i class="fa fa-caret-square-o-right"></i> Record Transactions<i class="fa fa-angle-down pull-right" style="margin-top:5px;"></i></a></a>
                                                                            <ul class="list-unstyled submenu-ul" style="display: none;">
                                                                                <li><a href="<?php echo e(url('revenue_records')); ?>"><i class="fa fa fa-circle"></i> Record Revenues</a></li>
                                                            ...
                                                            <li>
                                                                <?php
                                                                            ...
                                                                            ?>
                                                                <a href="<?php echo e(url('revenue_records')); ?>"><i
                                                            ...
                                                            <!-- <li>
                                                                            ...
                                                                            ?>
                                                                                    <a href="<?php echo e(url('balancesheet')); ?>"><i class="fa fa-caret-square-o-right"></i> Balance sheet</a>
                                                                            <?php
                                                                                }
                                                                            ?>
                                                                        </li> -->
                                                            <li>
                                                                <?php
                                                                            ...
                                                                            ?>
                                                                <a href="<?php echo e(url('create_budget')); ?>"><i
                                                                        class="fa fa-caret-square-o-right"></i>
                                                                    Budget</a>
                                                                <?php
                                                                                }
                                                            ...
                                                            <li>
                                                                <?php
                                                                            ...
                                                                            ?>
                                                                <a href="<?php echo e(url('create_projection')); ?>"><i
                                                                        class="fa fa-caret-square-o-right"></i>
                                                                    Projection</a>
                                                                <?php
                                                                                }
                                                            ...
                                                            <li>
                                                                <a href="<?php echo e(url('calculator')); ?>"><i
                                                                        class="fa fa-caret-square-o-right"></i>
                                                                    Calculator</a>
                                                            </li>
                                                        </ul>
                                                        ...
                                                        <ul class="list-unstyled">
                                                            <li>
                                                                <?php
                                                                            ...
                                                                            ?>
                                                                <a href="<?php echo e(url('profit_loss_stmt')); ?>"><i
                                                                        class="fa fa-caret-square-o-right"></i>
                                                                    Reports</a>
                                                                <?php
                                                                                }
                                                            ...
                                                            <li>
                                                                <?php
                                                                            ...
                                                                            ?>
                                                                <a href="<?php echo e(url('comparison_finance')); ?>"><i
                                                                        class="fa fa-caret-square-o-right"></i>
                                                            ...
                                                            <li>
                                                                <?php
                                                                            ...
                                                                            ?>
                                                                <a href="<?php echo e(url('financial_tutorials')); ?>"><i
                                                                        class="fa fa-caret-square-o-right"></i>
                                                                    Tutorial</a>
                                                                <?php
                                                                                }
                                    ...
                                    <!--     <li><a href="<?php echo e(url('front_archives')); ?>">Archives</a></li> -->
                                                        ...
                                                        <ul class="list-unstyled">
                                                            <li>
                                                                <?php
                                                                                ...
                                                                                ?>
                                                                <a href="<?php echo e(url('edit_archives')); ?>"><i
                                                                        class="fa fa-caret-square-o-right"></i>
                                                                    Edit</a>
                                                                <?php
                                                                                    }
                                                            ...
                                                            <li>
                                                                <?php
                                                                                ...
                                                                                ?>
                                                                <a href="<?php echo e(url('delete_archives')); ?>"><i
                                                                        class="fa fa-caret-square-o-right"></i>
                                                                    Deletion</a>
                                                                <?php
                                                                                    }
                                                            ...
                                                            <li>
                                                                <?php
                                                                                ...
                                                                                ?>
                                                                <a href="<?php echo e(url('appointment_archives')); ?>"><i
                                                                        class="fa fa-caret-square-o-right"></i>
                                                                    Appointment</a>
                                                                <?php
                                                                                    }
                                                            ...
                                                            <li>
                                                                <?php
                                                                                ...
                                                                                ?>
                                                                <a href="<?php echo e(url('financial_archives')); ?>"><i
                                                                        class="fa fa-caret-square-o-right"></i>
                                                                    Financial Management</a>
                                                                <?php
                                                                                    }
                                                        ...
                                                        <ul class="list-unstyled">
                                                            <li>
                                                                <?php
                                                                                ...
                                                                                ?>
                                                                <a href="<?php echo e(url('client_archives')); ?>"><i
                                                            ...
                                                            <li>
                                                                <?php
                                                                                ...
                                                                                ?>
                                                                <a href="<?php echo e(url('email_archives')); ?>"><i
                                                                        class="fa fa-caret-square-o-right"></i> Email
                                                                    Management</a>
                                                                <?php
                                                                                    }
                                                            ...
                                                            <li>
                                                                <?php
                                                                                ...
                                                                                ?>
                                                                <a href="<?php echo e(url('comparison-tab1')); ?>"><i
                                                            ...
                                                            <li>
                                                                <?php
                                                                                ...
                                                                                ?>
                                                                <a href="<?php echo e(url('archives_tutorials')); ?>"><i
                                                                        class="fa fa-caret-square-o-right"></i>
                                                                    Tutorial</a>
                                                                <?php
                                                                                    }
                            ...
                            <nav class="nav-main">
                                <ul id="topMain" class="nav nav-pills nav-main text-center">
                                    <li><a href="<?php echo e(url('/')); ?>">Home</a></li>
                                    <!-- <li><a href="<?php echo e(url('client_profile')); ?>">Profile</a></li> -->
                                    <li>
                                        <?php
                                                if($links[11]->status == "on"){
                                            ?>
                                        <a href="<?php echo e(url('appointment_step1')); ?>">Make Appointment on the Network</a>
                                        <?php
                                                }
                                            ?>
                                    </li>
                                    <li>
                                        <?php
                                            ...
                                            ?>
                                        <a href="<?php echo e(url('change_appointment')); ?>">Change Appointment</a>
                                        <?php
                                                }
                                            ?>
                                    </li>
                                    <li>
                                        <?php
                                            ...
                                            ?>
                                        <a href="<?php echo e(url('cancel_appointment')); ?>">Cancel Appointment</a>
                                        <?php
                                                }
                                            ?>
                                    </li>
                                    <li>
                                        <?php
                                            ...
                                            ?>
                                        <a href="<?php echo e(url('member_profile_info')); ?>">Client Access</a>
                                        <?php
                                                }
                                            ?>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(url('member_library_form')); ?>">Client Library Form</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(url('survey_polls')); ?>">Survey/Polls</a>
                                    </li>
                                </ul>
                            </nav>
                            <?php }else{ ?>
                            <?php if(Auth::check()): ?>
                                ...
                                <nav class="nav-main">
                                    <ul id="topMain" class="nav nav-pills nav-main text-center">
                                        ...
                                        <li><a href="<?php echo e(url('notifications')); ?>">
                                                <div class="noti_sec"><i class="fas fa-bell"></i><span
                                                        class="noti_count"><?php echo e($count = App\Http\Controllers\MainController::notification_count()); ?></span>
                                                </div>
                                            </a></li>
                                        <li><a href="<?php echo e(url('front_dashboard')); ?>">Dashboard</a></li>
                                        <?php }else{ ?>
                                            ...
                                            <ul class="dropdown-menu" style="left: 16%;">
                                                <li>
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <ul class="list-unstyled">
                                                                <?php if(isLinkAccess($links[0]->id) == 1): ?>
                                                                    <li>
                                                                        <?php
                                    ...
                                    ?>
                                                                ...
                                                                <?php endif; ?>
                                                                <?php if(isLinkAccess($links[2]->id) == 1): ?>
                                                                    <!--  <li>
                                    <?php
                                    ...
                                    ?>
                                                                ...
                                                                <?php endif; ?>
                                                                <?php if(isLinkAccess($links[3]->id) == 1): ?>
                                                                    <li>
                                                                        <?php
                                    ...
                                    ?>
                                                                ...
                                                                <?php endif; ?>
                                                                <?php if(isLinkAccess($links[6]->id) == 1): ?>
                                                                    <!--<li><a href=""><i class="fa fa-caret-square-o-right"></i> Calender meetings/Tasks</a></li>-->
                                                                    <li>
                                                                        <?php
                                    ...
                                    ?>
                                                                        <a
                                                                            href="<?php echo e(url('add_appointment_setting')); ?>"><i
                                                                                class="fa fa-caret-square-o-right"></i>
                                                                            Appointment</a>
                                                                        <?php
                                        }
                                    ?>
                                                                ...
                                                                <?php endif; ?>
                                                                 <!--<li>-->
                                                                 <!--           <a href="<?php echo e(url('renew-plan')); ?>" style="color: hwb(120 0% 49.8%) !important;"><i-->
                                                                 <!--                   class="fa fa-caret-square-o-right" ></i>-->
                                                                 <!--               Renew Plan</a>-->
                                                                 <!--       </li>-->
                                                                         <?php if(Auth::check()): ?>
                                                    ...
                                                    <?php endif; ?>
                                                <?php endif; ?>
                                                                <?php if(isLinkAccess($links[4]->id) == 1): ?>
                                                                    <li>
                                                                        <?php
                                        if($links[4]->status == "on"){
                                    ?>
                                    ...
                                    ?>
                                                                ...
                                                                <?php endif; ?>
                                                                <?php if(isLinkAccess($links[7]->id) == 1): ?>
                                                                    <li>
                                                                        <?php
                                    ...
                                    ?>
                                                                ...
                                                                <?php endif; ?>
                                                                <?php if(isLinkAccess($links[8]->id) == 1): ?>
                                                                    <li>
                                                                        <?php
                                        if($links[8]->status == "on"){
                                    ?>
                                                                        <a
                                                                            href="<?php echo e(url('financial_mgmt_setting')); ?>"><i
                                                                                class="fa fa-caret-square-o-right"></i>
                                                                            Financial Management</a>
                                                                        <?php
                                        }
                                    ...
                                    <ul class="list-unstyled submenu-ul" style="display: none;">
                                        <li><a href="<?php echo e(url('add_appointment_setting')); ?>"><i class="fa fa fa-circle"></i> Appointment Settings</a></li>
                                ...
                                <li class="li-submenu"><a class="" href="javascript:void(0);"><i class="fa fa-caret-square-o-right"></i> Financial  Management <i class="fa fa-angle-down pull-right" style="margin-top:5px;"></i></a>
                                    <ul class="list-unstyled submenu-ul" style="display: none;">
                                        ...
                                        <li><a href="templates.php"><i class="fa fa fa-circle"></i> Choose a template</a></li>
                                                                ...
                                                                <?php if(isLinkAccess($links[9]->id) == 1): ?>
                                                                    <li>
                                                                        <?php
                                    ...
                                    ?>
                                                                ...
                                                                <?php endif; ?>
                                                                <?php if(isLinkAccess($links[10]->id) == 1): ?>
                                                                    <li>
                                                                        <?php
                                            ...
                                            <ul class="dropdown-menu" style="left: 24%;">
                                                <li>
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <ul class="list-unstyled">
                                                                <?php if(isLinkAccess($links[14]->id) == 1): ?>
                                                                    <li>
                                                                        <?php
                                    ...
                                    ?>
                                                                ...
                                                                <?php if(isLinkAccess($links[12]->id) == 1): ?>
                                                                    <li>
                                                                        <?php
                                        if($links[12]->status == "on"){
                                    ?>
                                    ...
                                    ?>
                                                                ...
                                                                <?php endif; ?>
                                                                <?php if(isLinkAccess($links[13]->id) == 1): ?>
                                                                    <li>
                                                                        <?php
                                        if($links[13]->status == "on"){
                                    ?>
                                    ...
                                    ?>
                                                                ...
                                                                <?php endif; ?>
                                                                <?php if(isLinkAccess($links[58]->id) == 1): ?>
                                                                    <li>
                                                                        <?php
                                        if($links[58]->status == "on"){
                                    ?>
                                                                        <a
                                                                            href="<?php echo e(url('comparison_appointment')); ?>"><i
                                                                                class="fa fa-caret-square-o-right"></i>
                                                                            Appointment Comparison</a>
                                                                        <?php
                                        }
                                    ?>
                                                        ...
                                                        <div class="col-md-6">
                                                            <ul class="list-unstyled">
                                                                <?php if(isLinkAccess($links[59]->id) == 1): ?>
                                                                    <li>
                                                                        <?php
                                    ...
                                    ?>
                                                                ...
                                                                <?php if(isLinkAccess($links[11]->id) == 1): ?>
                                                                    <li>
                                                                        <?php
                                        if($links[11]->status == "on"){
                                    ?>
                                    ...
                                    ?>
                                                                ...
                                                                <?php if(isLinkAccess($links[15]->id) == 1): ?>
                                                                    <li>
                                                                        <?php
                                            ...
                                            <ul class="dropdown-menu" style="left: 36%;">
                                                <li>
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <ul class="list-unstyled">
                                                                <?php if(isLinkAccess($links[16]->id) == 1): ?>
                                                                    <li>
                                                                        <?php
                                    ...
                                    ?>
                                                                ...
                                                                <?php endif; ?>
                                                                <?php if(isLinkAccess($links[17]->id) == 1): ?>
                                                                    <li>
                                                                        <?php
                                    ...
                                    ?>
                                                                ...
                                                                <?php endif; ?>
                                                                <?php if(isLinkAccess($links[18]->id) == 1): ?>
                                                                    <li>
                                                                        <?php
                                    ...
                                    <ul class="list-unstyled submenu-ul" style="display: none;">
                                        <li><a href="<?php echo e(url('schedule_birthday')); ?>"><i class="fa fa fa-circle"></i> Schedule Birthday</a></li>
                                        <li><a href="schedule_holiday.php"><i class="fa fa fa-circle"></i> Schedule Holiday</a></li>
                                                        ...
                                                        <div class="col-md-6">
                                                            <ul class="list-unstyled">
                                                                <?php if(isLinkAccess($links[19]->id) == 1): ?>
                                                                    <!-- <li>
                                    <?php
                                    ...
                                    ?>
                                                                ...
                                                                <?php endif; ?>
                                                                <?php if(isLinkAccess($links[20]->id) == 1): ?>
                                                                    <li>
                                                                        <?php
                                        if($links[20]->status == "on"){
                                    ?>
                                    ...
                                    ?>
                                                                                <a
                                                                                    href="<?php echo e(url('client-survey-records')); ?>"><i
                                                                                        class="fa fa-caret-square-o-right"></i>
                                                                                    Client Survey Results</a>
                                                                                <?php
                                        }
                                    ...
                                    ?>
                                                                                <a
                                                                                    href="<?php echo e(url('client-report-view')); ?>"><i
                                                                                        class="fa fa-caret-square-o-right"></i>
                                    ...
                                    <ul class="list-unstyled submenu-ul" style="display: none;">
                                        <li><a href="<?php echo e(url('profile_info')); ?>"><i class="fa fa fa-circle"></i> Profile</a></li>
                                        <li><a href="tasks.php"><i class="fa fa fa-circle"></i> Tasks</a></li>
                                    </ul>
                                </li>-->
                                                                <?php if(isLinkAccess($links[21]->id) == 1): ?>
                                                                    <li>
                                                                        <?php
                                            ...
                                            <ul class="dropdown-menu email-li" style="left: 50%;">
                                                <li>
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <ul class="list-unstyled">
                                                                <?php if(isLinkAccess($links[22]->id) == 1): ?>
                                                                    <li>
                                                                        <?php
                                    ...
                                    ?>
                                                                ...
                                                                <?php endif; ?>
                                                                <?php if(isLinkAccess($links[23]->id) == 1): ?>
                                                                    <li>
                                                                        <?php
                                    ...
                                    ?>
                                                                ...
                                                                <?php endif; ?>
                                                                <?php if(isLinkAccess($links[24]->id) == 1): ?>
                                                                    <li>
                                                                        <?php
                                    ...
                                    ?>
                                                                ...
                                                                <?php endif; ?>
                                                                <?php if(isLinkAccess($links[25]->id) == 1): ?>
                                                                    <li>
                                                                        <?php
                                    ...
                                    ?>
                                                        ...
                                                        <div class="col-md-6">
                                                            <ul class="list-unstyled">
                                                                <?php if(isLinkAccess($links[27]->id) == 1): ?>
                                                                    <li>
                                                                        <?php
                                    ...
                                    ?>
                                                                ...
                                                                <?php endif; ?>
                                                                <?php if(isLinkAccess($links[28]->id) == 1): ?>
                                                                    <li>
                                                                        <?php
                                    ...
                                    ?>
                                                                ...
                                                                <?php endif; ?>
                                                                <?php if(isLinkAccess($links[29]->id) == 1): ?>
                                                                    <li>
                                                                        <?php
                                    ...
                                    <ul class="list-unstyled submenu-ul" style="display: none;">
                                        ...
                                        <li><a href=""><i class="fa fa fa-circle"></i> My Mailbox</a></li>
                                                                ...
                                                                <?php if(isLinkAccess($links[34]->id) == 1): ?>
                                                                    <li>
                                                                        <?php
                                    ...
                                    <ul class="list-unstyled submenu-ul" style="display: none;">
                                        ...
                                        <li><a href=""><i class="fa fa fa-circle"></i> Uploads Files</a></li>
                                                                ...
                                                                <?php if(isLinkAccess($links[35]->id) == 1): ?>
                                                                    <li>
                                                                        <?php
                                    ...
                                    ?>
                                                                ...
                                                                <?php endif; ?>
                                                                <?php if(isLinkAccess($links[36]->id) == 1): ?>
                                                                    <li>
                                                                        <?php
                                        if($links[36]->status == "on"){
                                    ?>
                                                                        <a href="<?php echo e(url('balancesheet')); ?>"><i
                                                                                class="fa fa-caret-square-o-right"></i>
                                                                            Balance sheet</a>
                                                                        <?php
                                        }
                                    ?>
                                                                ...
                                                                <?php endif; ?>
                                                                <?php if(isLinkAccess($links[38]->id) == 1): ?>
                                                                    <li>
                                                                        <?php
                                    ...
                                    ?>
                                                                ...
                                                                <?php endif; ?>
                                                                <?php if(isLinkAccess($links[39]->id) == 1): ?>
                                                                    <li>
                                                                        <?php
                                    ...
                                    ?>
                                                        ...
                                                        <div class="col-md-6">
                                                            <ul class="list-unstyled">
                                                                <?php if(isLinkAccess($links[42]->id) == 1): ?>
                                                                    <li>
                                                                        <?php
                                    ...
                                    ?>
                                                                ...
                                                                <?php endif; ?>
                                                                <?php if(isLinkAccess($links[45]->id) == 1): ?>
                                                                    <li>
                                                                        <?php
                                    ...
                                    ?>
                                                                ...
                                                                <?php endif; ?>
                                                                <?php if(isLinkAccess($links[48]->id) == 1): ?>
                                                                    <li>
                                                                        <?php
                                            ...
                                            <ul class="dropdown-menu archives-li" style="left: 65%;">
                                                <li>
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <ul class="list-unstyled">
                                                                <li> <a href="<?php echo e(url('front_archives')); ?>"> <i
                                                                            class="fa fa-caret-square-o-right"></i>Archives</a>
                                                                </li>
                                                                <?php
                                                                    $enable = 2;
                                                                ?>
                                                                <?php if(isLinkAccess($links[50]->id) == $enable): ?>
                                                                    <li>
                                                                        <?php
                                    ...
                                    ?>
                                                                ...
                                                                <?php endif; ?>
                                                                <?php if(isLinkAccess($links[51]->id) == $enable): ?>
                                                                    <li>
                                                                        <?php
                                    ...
                                    ?>
                                                                ...
                                                                <?php endif; ?>
                                                                <?php if(isLinkAccess($links[52]->id) == $enable): ?>
                                                                    <li>
                                                                        <?php
                                    ...
                                    ?>
                                                                ...
                                                                <?php endif; ?>
                                                                <?php if(isLinkAccess($links[53]->id) == $enable): ?>
                                                                    <li>
                                                                        <?php
                                    ...
                                    ?>
                                                        ...
                                                        <div class="col-md-6">
                                                            <ul class="list-unstyled">
                                                                <?php if(isLinkAccess($links[54]->id) == $enable): ?>
                                                                    <li>
                                                                        <?php
                                    ...
                                    ?>
                                                                ...
                                                                <?php endif; ?>
                                                                <?php if(isLinkAccess($links[55]->id) == $enable): ?>
                                                                    <li>
                                                                        <?php
                                    ...
                                    ?>
                                                                ...
                                                                <?php if(isLinkAccess($links[56]->id) == 1): ?>
                                                                    <li>
                                                                        <?php
                                    ...
                                    ?>
                                                                ...
                                                                <?php if(isLinkAccess($links[57]->id) == $enable): ?>
                                                                    <li>
                                                                        <?php
                                        ...
                                        <ul class="list-unstyled">
                                            <li>
                                                <?php
                                                    if($links[50]->status == "on"){
                                                ?>
                                                        <a href="<?php echo e(url('edit_archives')); ?>"><i class="fa fa-caret-square-o-right"></i> Edit</a>
                                                <?php
                                                    }
                                                ?>
                                            </li>
                                            <li>
                                                <?php
                                                    if($links[51]->status == "on"){
                                                ?>
                                                        <a href="<?php echo e(url('delete_archives')); ?>"><i class="fa fa-caret-square-o-right"></i> Deletion</a>
                                                <?php
                                                    }
                                                ?>
                                            </li>
                                            <li>
                                                <?php
                                                    if($links[52]->status == "on"){
                                                ?>
                                                        <a href="<?php echo e(url('appointment_archives')); ?>"><i class="fa fa-caret-square-o-right"></i> Appointment</a>
                                                <?php
                                                    }
                                                ?>
                                            </li>
                                            <li>
                                                <?php
                                                    if($links[53]->status == "on"){
                                                ?>
                                                        <a href="<?php echo e(url('financial_archives')); ?>"><i class="fa fa-caret-square-o-right"></i> Financial Management</a>
                                                <?php
                                                    }
                                                ?>
                                            </li>
                                        ...
                                        <ul class="list-unstyled">
                                            <li>
                                                <?php
                                                    if($links[54]->status == "on"){
                                                ?>
                                                        <a href="<?php echo e(url('client_archives')); ?>"><i class="fa fa-caret-square-o-right"></i> Clients Management</a>
                                                <?php
                                                    }
                                                ?>
                                            </li>
                                            <li>
                                                <?php
                                                    if($links[55]->status == "on"){
                                                ?>
                                                        <a href="<?php echo e(url('email_archives')); ?>"><i class="fa fa-caret-square-o-right"></i> Email Management</a>
                                                <?php
                                                    }
                                                ?>
                                            </li>
                                            <li>
                                                <?php
                                                    if($links[56]->status == "on"){
                                                ?>
                                                        <a href="<?php echo e(url('comparison-tab1')); ?>"><i class="fa fa-caret-square-o-right"></i> Yearly Comparison</a>
                                                <?php
                                                    }
                                                ?>
                                            </li>
                                            <li>
                                                <?php
                                                    if($links[57]->status == "on"){
                                                ?>
                                                        <a href="<?php echo e(url('archives_tutorials')); ?>"><i class="fa fa-caret-square-o-right"></i> Tutorial</a>
                                                <?php
                                                    }
                                                ?>
                                            </li>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body ">
                    <div class="row gy-4" style="margin-top: 10px;">
                        ...
                        <hr>
                        <form action="<?php echo e(url('add_enquiry_entry')); ?>" method="POST" id=""
                            ...
                            <div class="col-md-12" style="margin-top: 30px;">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Name" name="name"
                                        required="" autocomplete="off" value="<?php echo e(old('name')); ?>">
    ...
    <!-- REVOLUTION SLIDER -->
    <script type="text/javascript"
        src="<?php echo e(asset('assets/plugins/slider.revolution/js/jquery.themepunch.tools.min.js')); ?>"></script>
    <script type="text/javascript"
        src="<?php echo e(asset('assets/plugins/slider.revolution/js/jquery.themepunch.revolution.min.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('assets/js/view/demo.revolution_slider.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('assets/plugins/datatables/js/jquery.dataTables.min.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('assets/plugins/datatables/js/dataTables.tableTools.min.js')); ?>">
    </script>
    <script type="text/javascript" src="<?php echo e(asset('assets/plugins/datatables/js/dataTables.colReorder.min.js')); ?>">
    </script>
    <script type="text/javascript" src="<?php echo e(asset('assets/plugins/datatables/js/dataTables.scroller.min.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('assets/plugins/datatables/dataTables.bootstrap.js')); ?>"></script>
    <script src="<?php echo e(asset('fullcalendar/fullcalendar.min.js')); ?>"></script>
    ...
    <?php if(Auth::check() && Auth::user()->role == 'affiliate'): ?>
        <!--  <script type="text/javascript" src="<?php echo e(asset('includes/eventHandling.js')); ?>"></script> -->
    <?php endif; ?>
    <!-- <script type="text/javascript" src="<?php echo e(asset('includes/eventHandling.js')); ?>"></script> -->
...
<script>
    ...
    <script type="text/javascript">
        ...
        function showPosition(position) {
            ...
            $.ajax({
                ...
                data: '_token=<?php echo e(csrf_token()); ?>' + '&latitude=' + latitude + '&longitude=' + longitude,
                type: "POST",
                success: function(response) {
    ...
    <script type="text/javascript">
        ...
        //     // if("<?php echo e($lang_code); ?>" !='en'){
        //     var language_code = "<?php echo e($lang_code); ?>"
...
<?php /**PATH /home/mafamatest/public_html/resources/views/layouts/main.blade.php ENDPATH**/ ?>