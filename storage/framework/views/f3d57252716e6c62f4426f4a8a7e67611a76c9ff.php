                                ...
                                <div class=" card-inner-lg" style="background-color:#fff">
                                    ...
                                    <div class="row" style="border: 1px solid #da291c !important; padding-top:30px;margin-bottom:30px; ">
                                        <div class="col-md-12">
                                            ...
                                            <form action="<?php echo e(url('update_admin_my_faith')); ?>" method="POST"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <form action="<?php echo e(url('add_admin_my_faith')); ?>" method="POST"
                                                id="" enctype="multipart/form-data">
                                                <?php echo csrf_field(); ?>
                                                <div class="col-md-12"
                                                    style="border-radius: 10px; padding: 0px; padding-top: 10px; padding-bottom: 20px;">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="20%">
                                                        ...
                                                        <form action="<?php echo e(url('delete_admin_my_faith')); ?>"
                                                            method="POST" id="" enctype="multipart/form-data"
                                                            style="display: inline-flex;">
                                                            <?php echo csrf_field(); ?>
                                                            <a class="btn btn-xs btn-info"
                                                                href="<?php echo e(url('edit_admin_my_faith') . '/' . $value->id); ?>">Edit</a>
                                                            &nbsp;
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mafamatest/public_html/resources/views/admin/setting/my_faith.blade.php ENDPATH**/ ?>