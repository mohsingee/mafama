    ...
    <div class="col-md-12 padding-o">
      <div class="content">
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-<?php echo e(Auth::check() && ($role_type =='affiliate' || $role_type =='free_affiliate')  ? '3' : '4'); ?>" >
              <div class="card card-chart">
               <!--  <div id="wwo-weather-widget-2"></div><script type='text/javascript' src='https://www.worldweatheronline.com/widget/v5/weather-widget.ashx?loc=2590477&wid=2&tu=1&div=wwo-weather-widget-2' async></script><noscript><a href="https://www.worldweatheronline.com/oakview-weather/maryland/us.aspx" alt="Hour by hour Oakview, Maryland weather">Oakview, Maryland weather forecast hourly</a></noscript> -->
                <div class="card-header card-header-primary">
                   <h3 class="card-title" id="timer"><?php echo e($weather['cdate']); ?></h3>
                </div>
                <div class="card-body">
              ...
              <div class="card weather">
                <div class="card-body weather-1">
                    <table class="wea-table" >
                        <tr>
                     <td style="width: 60%;">
                        <img src="<?php echo e($weather['icon']); ?>" style="width:23px">
                         <label class="temp"><?php echo e($weather['temp_c']); ?> °C/<?php echo e($weather['temp_f']); ?> °F</label>
                        <br>
                        <label class="wea-text"><?php echo e($weather['desc']); ?></label>
                        </td>
                            <td style="width: 40%;">


                                <ul class="we-li">
                                    <li>Wind: <span class="text-light"><?php echo e($weather['wind']); ?></span></li>
                                    <li>Pressure: <span class="text-light"><?php echo e($weather['pressure']); ?></span></li>
                                    <li>Humidity: <span class="text-light"><?php echo e($weather['humidity']); ?></span></li>
                                </ul>
                            </td>
                        </tr>
                    </table>
          ...
          <?php if($role_type =='affiliate' || $role_type =='free_affiliate'): ?>
            <div class="col-md-3">
              <div class="card card-chart">
                <div class="card-header card-header-primary">
      ...
      <div class="content">
        ...
        <div class="col-md-4">
               ...
               <div class="col-lg-4 col-md-6 col-sm-6 margin-bottom-none">
                ...
                <div class="card card-stats">
                  <div class="card-header card-header-primary card-header-icon">
                    <div class="card-icon">
                     <img src="<?php echo e(asset('public/images/icons/revenue.png')); ?>" width="35px">
                    </div>
                    <p class="card-category"> Revenue Records</p>
                    <div class="appointmenttt appointmenttt_1">
                      <a href="<?php echo e(url('revenue_records')); ?>"> <h3 class="card-title"><?php echo e($total_revenue); ?></h3></a>
                    ...
                    <div class="text-left">
                      ...
                      <input type="hidden" id="date_1" value="<?php echo e(date('Y-m-d')); ?>">
                    </div>
                  </div>
                  <div class="card-footer">
                    <div class="stats">
                      <img src="<?php echo e(asset('public/images/icons/calendar.png')); ?>" style="width: 17px; height: 17px; margin-right: 10px;"> <p id="datetitlee_1">For month of <?php echo e(date('F')); ?></p>
                    </div>
                  </div>
                </div>
         ...
         <div class="col-lg-4 col-md-6 col-sm-6 margin-bottom-none">
                <div class="card card-stats">
                  <div class="card-header card-header-info card-header-icon">
                    ...
                    <div class="appointmenttt appointmenttt_2">
                      <a href="<?php echo e(url('expenses_reord')); ?>"> <h3 class="card-title"><?php echo e($total_expense); ?></h3></a>
                      <span class="prev"><i class="fas fa-chevron-left"></i></span>
                      <span class="next"><i class="fas fa-chevron-right"></i></span>
                    </div>
                    <div class="text-left">
                      ...
                      <input type="hidden" id="date_2" value="<?php echo e(date('Y-m-d')); ?>">
                    </div>
                  </div>
                  <div class="card-footer">
                    <div class="stats">
                      <img src="<?php echo e(asset('public/images/icons/calendar.png')); ?>" style="width: 17px; height: 17px; margin-right: 10px;"> <p id="datetitlee_2">For month of <?php echo e(date('F')); ?></p>
                    </div>
                  </div>
                </div>
                ...
                <div class="card card-stats">
                  <div class="card-header card-header-warning card-header-icon">
                    ...
                    <div class="appointmenttt appointmenttt_3">
                        ...
                        $bal=str_replace('-',' ',$bal);
                        ?>
                       <a href="<?php echo e(url('profit_loss_stmt')); ?>"><h3 class="card-title"><?php echo e($bal); ?></h3></a>
                      <span class="prev"><i class="fas fa-chevron-left"></i></span>
                      <span class="next"><i class="fas fa-chevron-right"></i></span>
                    </div>
                    <div class="text-left">
                      ...
                      <input type="hidden" id="date_3" value="<?php echo e(date('Y-m-d')); ?>">
                    </div>
                  </div>
                  <div class="card-footer">
                    <div class="stats">
                      <img src="<?php echo e(asset('public/images/icons/calendar.png')); ?>" style="width: 17px; height: 17px; margin-right: 10px;"> <p id="datetitlee_3">For month of <?php echo e(date('F')); ?></p>
                    </div>
                  </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6  margin-bottom-none">
              <!-- <a href="<?php echo e(url('dashboard_manage_appointment')); ?>"> -->
                <div class="card card-stats">
                  <div class="card-header card-header-warning card-header-icon">
                    <div class="card-icon">
                      <img src="<?php echo e(asset('public/images/icons/appointment.png')); ?>" width="35px">
                    </div>
                    <p class="card-category">Appointments</p>
                    <div class="appointmenttt appointmenttt1">

                      <a href="<?php echo e(url('manage_appointment')); ?>"><h3 class="card-title"><?php echo e($total_appointment); ?></h3></a>
                    ...
                    <div class="text-left">
                      ...
                      <input type="hidden" id="date1" value="<?php echo e(date('Y-m-d')); ?>">
                    </div>
                  </div>
                  <div class="card-footer">
                    <div class="stats">
                      <img src="<?php echo e(asset('public/images/icons/calendar.png')); ?>" style="width: 17px; height: 17px; margin-right: 10px;"> <p id="datetitlee1">For month of <?php echo e(date('F')); ?></p>
                    </div>
                  </div>
                </div>
              <!-- </a> -->
            ...
            <!-- <div class="col-lg-4 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-danger card-header-icon">
                  <div class="card-icon">
                    <img src="<?php echo e(asset('public/images/icons/email.png')); ?>" width="35px">
                  </div>
                  <p class="card-category">Sent Emails</p>
                  <h3 class="card-title"><?php echo e($totalemail); ?></h3>
                </div>
                <div class="card-footer">
                  <div class="stats">
                    <img src="<?php echo e(asset('public/images/icons/calendar.png')); ?>" style="width: 17px; height: 17px; margin-right: 10px;"> For month of <?php echo e(date('F')); ?>
                ...
                <div class="card card-stats">
                  <div class="card-header card-header-success card-header-icon">
                    ...
                    <div class="appointmenttt appointmenttt2">
                      ...
                      <a href="<?php echo e(url('new_client_lists')); ?>"><h3 class="card-title"><?php echo e($new_clients); ?></h3></a>
                    ...
                    <div class="text-left">
                      ...
                      <input type="hidden" id="date2" value="<?php echo e(date('Y-m-d')); ?>">
                    </div>
                  </div>
                  <div class="card-footer">
                    <div class="stats">
                      <img src="<?php echo e(asset('public/images/icons/calendar.png')); ?>" style="width: 17px; height: 17px; margin-right: 10px;"> <p id="datetitlee2">For month of <?php echo e(date('F')); ?></p>
                    </div>
                  </div>
                </div>
            </div>
                ...
                <div class="card card-stats">
                  <div class="card-header card-header-danger card-header-icon">
                    ...
                    <div class="appointmenttt appointmenttt3">
                      ...
                      <a href="<?php echo e(url('manage_clients')); ?>"><h3 class="card-title"><?php echo e($total_client_mgt); ?></h3></a>
                    ...
                    <div class="text-left">
                      ...
                      <input type="hidden" id="date3" value="<?php echo e(date('Y-m-d')); ?>">
                    </div>
                  </div>
                  <div class="card-footer">
                    <div class="stats">
                      <img src="<?php echo e(asset('public/images/icons/calendar.png')); ?>" style="width: 17px; height: 17px; margin-right: 10px;"> <p id="datetitlee3">For month of <?php echo e(date('F')); ?></p>
                    </div>
                  </div>
                </div>
            </div>
                ...
                <div class="card card-stats">
                  <div class="card-header card-header-success card-header-icon">
                    ...
                    <div class="appointmenttt appointmenttt14">
                        ...
                        <a href="<?php echo e(url('lab/pharmacy?order=today')); ?>"><h3 class="card-title"><?php echo e($today_orders); ?></h3></a>
                    ...
                    <div class="text-left">
                      ...
                      <input type="hidden" id="date14" value="<?php echo e(date('Y-m-d')); ?>">
                    </div>
                  </div>
                  <div class="card-footer">
                    <div class="stats">
                      <img src="<?php echo e(asset('public/images/icons/calendar.png')); ?>" style="width: 17px; height: 17px; margin-right: 10px;"> <p id="datetitlee14">For month of <?php echo e(date('F')); ?></p>
                    </div>
                  </div>
                </div>
            </div>
                ...
                <div class="card card-stats">
                  <div class="card-header card-header-danger card-header-icon">
                    ...
                    <div class="appointmenttt appointmenttt13">
                      ...
                      <a href="<?php echo e(url('lab/lab-test')); ?>"><h3 class="card-title"><?php echo e($total_lab_tests); ?></h3></a>
                    ...
                    <div class="text-left">
                      ...
                      <input type="hidden" id="date13" value="<?php echo e(date('Y-m-d')); ?>">
                    </div>
                  </div>
                  <div class="card-footer">
                    <div class="stats">
                      <img src="<?php echo e(asset('public/images/icons/calendar.png')); ?>" style="width: 17px; height: 17px; margin-right: 10px;"> <p id="datetitlee13">For month of <?php echo e(date('F')); ?></p>
                    </div>
                  </div>
                </div>
            </div>
                ...
                <div class="card card-stats">
                  <div class="card-header card-header-info card-header-icon">
                    ...
                    <div class="appointmenttt appointmenttt15">
                        ...
                        <a href="<?php echo e(url('lab/pharmacy')); ?>"><h3 class="card-title"><?php echo e($total_pharmacy_orders); ?></h3></a>
                    ...
                    <div class="text-left">
                      ...
                      <input type="hidden" id="date15" value="<?php echo e(date('Y-m-d')); ?>">
                    </div>
                  </div>
                  <div class="card-footer">
                    <div class="stats">
                      <img src="<?php echo e(asset('public/images/icons/calendar.png')); ?>" style="width: 17px; height: 17px; margin-right: 10px;"> <p id="datetitlee15">For month of <?php echo e(date('F')); ?></p>
                    </div>
                  </div>
                </div>
            </div>
                ...
                <div class="card card-stats">
                  <div class="card-header card-header-success card-header-icon">
                    ...
                    <div class="appointmenttt appointmenttt4">
                      ...
                      <a href="<?php echo e(url('/paymentbalance_report')); ?>"><h3 class="card-title"><?php echo e($payments_total); ?>/<?php echo e($balance_total); ?></h3></a>
                   ...
                   <!--  <div class="text-left">
                      ...
                      <input type="hidden" id="date4" value="<?php echo e(date('Y-m-d')); ?>">
                    </div> -->
                  </div>
                  <!-- <div class="card-footer">
                    <div class="stats">
                      <img src="<?php echo e(asset('public/images/icons/calendar.png')); ?>" style="width: 17px; height: 17px; margin-right: 10px;"> <p id="datetitlee4">For month of <?php echo e(date('F')); ?></p>
                    </div>
                  </div> -->
                </div>
            </div>
                ...
                <div class="card card-stats">
                  <div class="card-header card-header-info card-header-icon">
                    ...
                    <div class="appointmenttt appointmenttt11">
                      ...
                      <a href="<?php echo e(url('send_email/13')); ?>"><h3 class="card-title"><?php echo e($basket_1_users); ?></h3></a>
                   ...
                   <!--  <div class="text-left">
                      ...
                      <input type="hidden" id="date11" value="<?php echo e(date('Y-m-d')); ?>">
                    </div> -->
                  </div>
                 <!--  <div class="card-footer">
                    <div class="stats">
                      <img src="<?php echo e(asset('public/images/icons/calendar.png')); ?>" style="width: 17px; height: 17px; margin-right: 10px;"> <p id="datetitlee11">For month of <?php echo e(date('F')); ?></p>
                    </div>
                  </div> -->
                </div>
            </div>
                ...
                <div class="card card-stats">
                  <div class="card-header card-header-primary card-header-icon">
                    ...
                    <div class="appointmenttt appointmenttt5">
                      ...
                      <a href="<?php echo e(url('schedule_birthday')); ?>"><h3 class="card-title"><?php echo e($birthdays_total); ?></h3></a>
                    ...
                    <div class="text-left">
                      ...
                      <input type="hidden" id="date5" value="<?php echo e(date('Y-m-d')); ?>">
                    </div>
                  </div>
                  <div class="card-footer">
                    <div class="stats">
                      <img src="<?php echo e(asset('public/images/icons/calendar.png')); ?>" style="width: 17px; height: 17px; margin-right: 10px;"> <p id="datetitlee5">For month of <?php echo e(date('F')); ?></p>
                    </div>
                  </div>
                </div>
            </div>--->
                ...
                <div class="card card-stats">
                  <div class="card-header card-header-primary card-header-icon">
                    ...
                    <div class="appointmenttt appointmenttt6">
                      ...
                      <a href="<?php echo e(url('calender_meeting')); ?>"><h3 class="card-title"><?php echo e($events_total); ?></h3></a>
                    ...
                    <div class="text-left">
                      ...
                      <input type="hidden" id="date6" value="<?php echo e(date('Y-m-d')); ?>">
                    </div>
                  </div>
                  <div class="card-footer">
                    <div class="stats">
                      <img src="<?php echo e(asset('public/images/icons/calendar.png')); ?>" style="width: 17px; height: 17px; margin-right: 10px;"> <p id="datetitlee6">For month of <?php echo e(date('F')); ?></p>
                    </div>
                  </div>
                </div>
            </div>--->
              ...
              <div class="col-lg-4 col-md-6 col-sm-6 margin-bottom-none">
                <div class="card card-stats bg-info">
                  <div class="card-header card-header-primary card-header-icon">
                    ...
                    <p class="card-category"><a href="<?php echo e(url('affiliate_dashboard')); ?>" style="color:#fff">View Full Schedule</a></p>
                   ...
                   <!--  <div class="text-left">
                      ...
                      <input type="hidden" id="date9" value="<?php echo e(date('Y-m-d')); ?>">
                    </div> -->
                  </div>
                 <!--  <div class="card-footer">
                    <div class="stats">
                      <img src="<?php echo e(asset('public/images/icons/calendar.png')); ?>" style="width: 17px; height: 17px; margin-right: 10px;"> <p id="datetitlee9">For month of <?php echo e(date('F')); ?></p>
                    </div>
                  </div> -->
                </div>
            </div>
                ...
                <div class="card card-stats">
                  <div class="card-header card-header-warning card-header-icon">
                    ...
                    <div class="appointmenttt appointmenttt8">
                      ...
                      <a href="<?php echo e(url('send_email/9')); ?>"><h3 class="card-title"><?php echo e($clients_total); ?></h3></a>
                   ...
                   <!--    <span class="prev"><i class="fas fa-chevron-left"></i></span>
                    ...
                    <!-- <div class="text-left">
                      ...
                      <input type="hidden" id="date8" value="<?php echo e(date('Y-m-d')); ?>">
                    </div> -->
                  </div>
                  <!-- <div class="card-footer">
                    <div class="stats">
                      <img src="<?php echo e(asset('public/images/icons/calendar.png')); ?>" style="width: 17px; height: 17px; margin-right: 10px;"> <p id="datetitlee8">For month of <?php echo e(date('F')); ?></p>
                    </div>
                  </div> -->
                </div>
            </div>
                ...
                <div class="card card-stats">
                  <div class="card-header card-header-primary card-header-icon">
                    ...
                    <div class="appointmenttt appointmenttt10">
                      ...
                      <a href="<?php echo e(url('send_email/8')); ?>"><h3 class="card-title"><?php echo e($friends); ?></h3></a>
                   ...
                   <!--  <div class="text-left">
                      ...
                      <input type="hidden" id="date10" value="<?php echo e(date('Y-m-d')); ?>">
                    </div> -->
                  </div>
                  <!-- <div class="card-footer">
                    <div class="stats">
                      <img src="<?php echo e(asset('public/images/icons/calendar.png')); ?>" style="width: 17px; height: 17px; margin-right: 10px;"> <p id="datetitlee10">For month of <?php echo e(date('F')); ?></p>
                    </div>
                  </div> -->
                </div>
            </div>
                ...
                <div class="card card-stats">
                  <div class="card-header card-header-danger card-header-icon">
                    ...
                    <div class="appointmenttt appointmenttt7">
                      ...
                      <a href="<?php echo e(url('send_email/7')); ?>"><h3 class="card-title"><?php echo e($family_total); ?></h3></a>
                   ...
                   <!--  <div class="text-left">
                      ...
                      <input type="hidden" id="date7" value="<?php echo e(date('Y-m-d')); ?>">
                    </div> -->
                  </div>
                  <!-- <div class="card-footer">
                    <div class="stats">
                      <img src="<?php echo e(asset('public/images/icons/calendar.png')); ?>" style="width: 17px; height: 17px; margin-right: 10px;"> <p id="datetitlee7">For month of <?php echo e(date('F')); ?></p>
                    </div>
                  </div> -->
                </div>
            </div>
                ...
                <div class="card card-stats">
                  <div class="card-header card-header-info card-header-icon">
                    ...
                    <div class="appointmenttt appointmenttt12">
                      ...
                      <a href="<?php echo e(url('send_email/12')); ?>"><h3 class="card-title"><?php echo e($basket_2_users); ?></h3></a>
                    ...
                    <div class="text-left"> 
                      ...
                      <input type="hidden" id="date12" value="<?php echo e(date('Y-m-d')); ?>">
                    </div>
                  </div>
                  <div class="card-footer">
                    <div class="stats">
                      <img src="<?php echo e(asset('public/images/icons/calendar.png')); ?>" style="width: 17px; height: 17px; margin-right: 10px;"> <p id="datetitlee12">For month of <?php echo e(date('F')); ?></p>
                    </div>
                  </div>
                </div>
            </div>-->
...
<div class="row">
  ...
  <div class="col-md-12" id="labTestRecords">
     <table class="table table-striped table-bordered table-hover table1" id="sample_editable_1">
          ...
          <tbody>
              <?php if(count($lab_records) >0 ): ?>
              <?php $__currentLoopData = $lab_records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lab): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr>
               <td><?php echo e(date('M,d,Y :  h:i A',strtotime($lab->created_at))); ?></td>
                  <td><a class="get_ordered_info" data-email="<?php echo e($lab->email); ?>" data-id="<?php echo e($lab->id); ?>" style="color:red"><?php echo e($lab->name); ?></a></td>
                  <!-- <td>
                   <?php if($lab->status==1): ?>  
                   <?php 
                   $user=\App\User::get_user_info($lab->completed_by);
                   ?> 
                      <a class="get_completed_info3" data-email="<?php echo e($user->email); ?>" data-id="<?php echo e($lab->id); ?>" style="color:red"><?php echo e($user->name); ?></a>
                    <?php else: ?>
                     -
                    <?php endif; ?>  
                  </td> -->
                  ...
                  <td>
                      <?php if(!empty($lab->uploaded_file)): ?>
                      <a href="<?php echo e(url('download_file/'.$lab->id)); ?>" class="btn btn-xs btn-primary float-right"> <i class="fa fa-download" aria-hidden="true"></i>
                      </a>
                      <?php endif; ?>
                  </td>
                  <td>
                      ...
                      <?php elseif($lab->status==1): ?>
                       <a href="javascript:void(0);" class="btn btn-xs btn-success"  data-id="<?php echo e($lab->id); ?>" >Completed</a>
                      <?php elseif($lab->status==2): ?>
                        <a href="javascript:void(0);" class="btn btn-xs btn-primary"><?php echo e($lab->test_name); ?> in progress</a>
                      <?php endif; ?>
                  </td>
                   <td>
                   <?php if($lab->status==0): ?>
                      <a href="<?php echo e(url('upload-lab-test-result/'.$lab->id)); ?>" data-id="<?php echo e($lab->id); ?>"  class="btn btn-xs btn-info mark-as-progress22">confirm</a>
                      <?php elseif($lab->status==1): ?> 
                      <?php elseif($lab->status==2): ?>
                       <a href="<?php echo e(url('upload-lab-test-result/'.$lab->id)); ?>"  class="btn btn-xs btn-info">mark as complete</a>
                      <?php endif; ?>
                  </td>
              </tr>
...
<?php endif; ?>          
  ...
  <!-- <script src="<?php echo e(asset('public/assets/js/core/bootstrap-material-design.min.js')); ?>"></script> -->
  <script src="<?php echo e(asset('public/assets/js/plugins/perfect-scrollbar.jquery.min.js')); ?>"></script>
  <!-- Plugin for the momentJs  -->
  <!-- <script src="<?php echo e(asset('public/assets/js/plugins/moment.min.js')); ?>"></script> -->
  <!--  Plugin for Sweet Alert -->
  <script src="<?php echo e(asset('public/assets/js/plugins/sweetalert2.js')); ?>"></script>
  <!-- Forms Validations Plugin -->
  <script src="<?php echo e(asset('public/assets/js/plugins/jquery.validate.min.js')); ?>"></script>
  <!-- Plugin for the Wizard, full documentation here: https://github.com/VinceG/twitter-bootstrap-wizard -->
  <!-- <script src="<?php echo e(asset('public/assets/js/plugins/jquery.bootstrap-wizard.js')); ?>"></script> -->
  <!--  Plugin for Select, full documentation here: http://silviomoreto.github.io/bootstrap-select -->
  <!-- <script src="<?php echo e(asset('public/assets/js/plugins/bootstrap-selectpicker.js')); ?>"></script> -->
  <!--  Plugin for the DateTimePicker, full documentation here: https://eonasdan.github.io/bootstrap-datetimepicker/ -->
  <!-- <script src="<?php echo e(asset('public/assets/js/plugins/bootstrap-datetimepicker.min.js')); ?>"></script> -->
  <!--  DataTables.net Plugin, full documentation here: https://datatables.net/  -->
  <!-- <script src="<?php echo e(asset('public/assets/js/plugins/jquery.dataTables.min.js')); ?>"></script> -->
  <!--  Plugin for Tags, full documentation here: https://github.com/bootstrap-tagsinput/bootstrap-tagsinputs  -->
  <!-- <script src="<?php echo e(asset('public/assets/js/plugins/bootstrap-tagsinput.js')); ?>"></script> -->
  <!-- Plugin for Fileupload, full documentation here: http://www.jasny.net/bootstrap/javascript/#fileinput -->
  <!-- <script src="<?php echo e(asset('public/assets/js/plugins/jasny-bootstrap.min.js')); ?>"></script> -->
  <!--  Full Calendar Plugin, full documentation here: https://github.com/fullcalendar/fullcalendar    -->
  <!-- <script src="<?php echo e(asset('public/assets/js/plugins/fullcalendar.min.js')); ?>"></script> -->
  <!-- Vector Map plugin, full documentation here: http://jvectormap.com/documentation/ -->
  <!-- <script src="<?php echo e(asset('public/assets/js/plugins/jquery-jvectormap.js')); ?>"></script> -->
  <!--  Plugin for the Sliders, full documentation here: http://refreshless.com/nouislider/ -->
  <!-- <script src="<?php echo e(asset('public/assets/js/plugins/nouislider.min.js')); ?>"></script> -->
  <!-- Include a polyfill for ES6 Promises (optional) for IE11, UC Browser and Android browser support SweetAlert -->
  <!-- <script src="https://cdnjs.cloudflare.com/ajax/libs/core-js/2.4.1/core.js') }}"></script> -->
  <!-- Library for adding dinamically elements -->
  <!-- <script src="<?php echo e(asset('public/assets/js/plugins/arrive.min.js')); ?>"></script> -->
  <!--  Google Maps Plugin    -->
  <!-- <script src="https://maps.googleapis.com/maps/api/js?key=YOUR_KEY_HERE"></script> -->
  <!-- Chartist JS -->
  <script src="<?php echo e(asset('public/assets/js/plugins/chartist.min.js')); ?>"></script>
  <!--  Notifications Plugin    -->
  <script src="<?php echo e(asset('public/assets/js/plugins/bootstrap-notify.js')); ?>"></script>
  <!-- Control Center for Material Dashboard: parallax effects, scripts for the example pages etc -->
  <script src="<?php echo e(asset('public/assets/js/material-dashboard.js?v=2.1.2')); ?>" type="text/javascript"></script>
  <!-- Material Dashboard DEMO methods, don't include it in your project! -->
  <script src="<?php echo e(asset('public/assets/demo/demo.js')); ?>"></script>
  <script>
  ...
  <script type="text/javascript">
      ...
      $(document).on("click", ".appointmenttt1 .prev", function(){
        ...
        $.ajax({
              ...
              data: 'count_basis=' + count_basis + '&date=' + date + '&_token=<?php echo e(csrf_token()); ?>',
              type: "POST",
            success: function (response) {
                $(".appointmenttt1 .card-title").html(response[0]);
 ...
 $(document).on("click", ".dash_btn7", function(){
        ...
        $.ajax({
              ...
              data:'folder='+folder+ '&val=' + val + '&_token=<?php echo e(csrf_token()); ?>',
              type: "POST",
            success: function (response) {
                // alert(response);
      ...
      $(document).on("click", ".appointmenttt7 .prev", function(){
        ...
        $.ajax({
              ...
              data: 'folder=7&count_basis=' + count_basis + '&date=' + date + '&_token=<?php echo e(csrf_token()); ?>',
              type: "POST",
            success: function (response) {
                $(".appointmenttt7 .card-title").html(response[0]);
 ...
 $(document).on("click", ".dash_btn8", function(){
        ...
        $.ajax({
              url: "<?php echo url('/'); ?>/dashboardfoldercount",
              data: 'folder=9&val=' + val + '&_token=<?php echo e(csrf_token()); ?>',
              type: "POST",
            success: function (response) {
                // alert(response);
      ...
      $(document).on("click", ".appointmenttt8 .prev", function(){
        ...
        $.ajax({
              url: "<?php echo url('/'); ?>/dashboardfoldercount_pre",
              data: 'folder=9&count_basis=' + count_basis + '&date=' + date + '&_token=<?php echo e(csrf_token()); ?>',
              type: "POST",
            success: function (response) {
                $(".appointmenttt8 .card-title").html(response[0]);
 ...
 $(document).on("click", ".dash_btn9", function(){
        ...
        $.ajax({
              url: "<?php echo url('/'); ?>/dashboardfoldercount",
              data: 'folder=10&val=' + val + '&_token=<?php echo e(csrf_token()); ?>',
              type: "POST",
            success: function (response) {
                // alert(response);
      ...
      $(document).on("click", ".appointmenttt9 .prev", function(){
        ...
        $.ajax({
              url: "<?php echo url('/'); ?>/dashboardfoldercount_pre",
              data: 'folder=10&count_basis=' + count_basis + '&date=' + date + '&_token=<?php echo e(csrf_token()); ?>',
              type: "POST",
            success: function (response) {
                $(".appointmenttt9 .card-title").html(response[0]);
 ...
 $(document).on("click", ".dash_btn10", function(){
        ...
        $.ajax({
              url: "<?php echo url('/'); ?>/dashboardfoldercount",
              data: 'folder=8&val=' + val + '&_token=<?php echo e(csrf_token()); ?>',
              type: "POST",
            success: function (response) {
                // alert(response);
      ...
      $(document).on("click", ".appointmenttt10 .prev", function(){
        ...
        $.ajax({
              url: "<?php echo url('/'); ?>/dashboardfoldercount_pre",
              data: 'folder=8&count_basis=' + count_basis + '&date=' + date + '&_token=<?php echo e(csrf_token()); ?>',
              type: "POST",
            success: function (response) {
                $(".appointmenttt10 .card-title").html(response[0]);
 ...
 $(document).on("click", ".dash_btn11", function(){
        ...
        $.ajax({
              url: "<?php echo url('/'); ?>/dashboardfoldercount",
              data: 'folder=13&val=' + val + '&_token=<?php echo e(csrf_token()); ?>',
              type: "POST",
            success: function (response) {
                // alert(response);
      ...
      $(document).on("click", ".appointmenttt11 .prev", function(){
        ...
        $.ajax({
              url: "<?php echo url('/'); ?>/dashboardfoldercount_pre",
              data: 'folder=13&count_basis=' + count_basis + '&date=' + date + '&_token=<?php echo e(csrf_token()); ?>',
              type: "POST",
            success: function (response) {
                $(".appointmenttt11 .card-title").html(response[0]);
 ...
 $(document).on("click", ".dash_btn12", function(){
        ...
        $.ajax({
              url: "<?php echo url('/'); ?>/dashboardfoldercount",
              data: 'folder=12&val=' + val + '&_token=<?php echo e(csrf_token()); ?>',
              type: "POST",
            success: function (response) {
                // alert(response);
      ...
      $(document).on("click", ".appointmenttt12 .prev", function(){
        ...
        $.ajax({
              url: "<?php echo url('/'); ?>/dashboardfoldercount_pre",
              data: 'folder=12&count_basis=' + count_basis + '&date=' + date + '&_token=<?php echo e(csrf_token()); ?>',
              type: "POST",
            success: function (response) {
                $(".appointmenttt12 .card-title").html(response[0]);
...
$(document).on("click", ".mark-as-progress", function () {
     if(confirm('<?php echo e($lab_name); ?>, ' + ' Are you sure to do this test?'))
     {
     var id=$(this).attr('data-id');
     $.ajax({
            url: "<?php echo e(url('mark-as-progress')); ?>",
    ...
    $(".ordered_div_info").css('display','block');
        ...
        if($(this).html() != 0){
            ...
            $.ajax({
                  ...
                  data: 'id=' + id + '&email=' + email + '&_token=<?php echo e(csrf_token()); ?>',
                  type: "POST",
                success: function (response) {                   
...
{    
    e.preventDefault();
     $("#labTestRecords").html('');
        ...
        $.ajax({
            method: 'POST',
            url:"<?php echo e(url('get_lab_test_for_laboratory')); ?>",
             beforeSend: function(){
                        $("#loading").show();
                        $("#wrapper").hide();
                      },
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mafamatest/public_html/resources/views/main/front_dashboard.blade.php ENDPATH**/ ?>