                ...
                <div class="col-md-12 col-sm-2">
                    ...
                    <div class="col-md-12">
                        <ul class="nav nav-tabs nav-button-tabs nav-justified" style="">
                            <li class="active"><a href="<?php echo e(url('manage_appointment')); ?>">Appointment History</a></li>
                            <li><a href="<?php echo e(url('client_list')); ?>">Client List</a></li>
                                ...
                                <div class="tab-pane fade in active" id="tab11">
                                    <div class="">
                                        <div class="year-filter-wraper">
                                            <a href="<?php echo e(url('/manage_appointment?year=2023')); ?>"
                                                class="<?php echo e(Request::get('year') == '2023' ? 'active1' : ''); ?> btn btn-md btn-info margin-right-10">2023</a>
                                            <a href="<?php echo e(url('/manage_appointment?year=2022')); ?>"
                                                class="<?php echo e(Request::get('year') == '2022' ? 'active1' : ''); ?> btn btn-md btn-info margin-right-10">2022</a>
                                                ...
                                                <table class="table table-striped table-bordered table-hover main-table"
                                                    ...
                                                    <thead>
                                                        ...
                                                        <tr class="" style="cursor: pointer">
                                                            <th class=""></th>
                                                            <th data-month="1"
                                                                class="<?php echo e(request()->month == 1 ? 'active1' : ''); ?> month-clk button-1">
                                                                Jan</th>
                                                            <th data-month="2"
                                                                class="<?php echo e(request()->month == 2 ? 'active1' : ''); ?> month-clk button-1">
                                                                Feb</th>
                                                            <th data-month="3"
                                                                class="<?php echo e(request()->month == 3 ? 'active1' : ''); ?> month-clk button-1">
                                                                Mar</th>
                                                            <th data-month="4"
                                                                class="<?php echo e(request()->month == 4 ? 'active1' : ''); ?> month-clk button-1">
                                                                Apr</th>
                                                            <th data-month="5"
                                                                class="<?php echo e(request()->month == 5 ? 'active1' : ''); ?> month-clk button-1">
                                                                May</th>
                                                            <th data-month="6"
                                                                class="<?php echo e(request()->month == 6 ? 'active1' : ''); ?> month-clk button-1">
                                                                Jun</th>
                                                            <th data-month="7"
                                                                class="<?php echo e(request()->month == 7 ? 'active1' : ''); ?> month-clk button-1">
                                                                Jul</th>
                                                            <th data-month="8"
                                                                class="<?php echo e(request()->month == 8 ? 'active1' : ''); ?> month-clk button-1">
                                                                Aug</th>
                                                            <th data-month="9"
                                                                class="<?php echo e(request()->month == 9 ? 'active1' : ''); ?> month-clk button-1">
                                                                Sep</th>
                                                            <th data-month="10"
                                                                class="<?php echo e(request()->month == 10 ? 'active1' : ''); ?> month-clk button-1">
                                                                Oct</th>
                                                            <th data-month="11"
                                                                class="<?php echo e(request()->month == 11 ? 'active1' : ''); ?> month-clk button-1">
                                                                Nov</th>
                                                            <th data-month="12"
                                                                class="<?php echo e(request()->month == 12 ? 'active1' : ''); ?> month-clk button-1">
                                                                Dec</th>
                                                            <th data-month="all"
                                                                class="<?php echo e(request()->month == 'all' ? 'active1' : ''); ?> month-clk button-1">
                                                                Total</th>
                                                            <th data-month="graph"
                                                                class="<?php echo e(request()->month == 'graph' ? 'active1' : ''); ?> month-clk button-1">
                                                                Graph</th>
                                                        </tr>
                                                    </thead>
                                                            ...
                                                            <div class="container bg-white col-md-8 mx-auto">
                                                                ...
                                                                <table>
                                                                    <?php
                                                                        ...
                                                                        // rsort($graph_data);
                                                                    ?>
                                                                    <?php $__currentLoopData = $graph_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ind => $gd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <?php
                                                                            $rgbColor = [];
                                                                        ...
                                                                        ?>
                                                                        <tr>
                                                                            <td style="color:#da291c"><?php echo e($gd['month']); ?>
                                                                            ...
                                                                            <td>
                                                                                <div style="width: 400px; display:flex">
                                                                                    <div
                                                                                        style="border-radius:2px; width: <?php echo e(($gd['val'] / $max_val) * 100); ?>%; background: rgb(<?= implode(',', $rgbColor) ?>); height: 20px;">
                                                                                    </div>
                                                                                </div>
                                                                            </td>
                                                                            <td>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mafamatest/public_html/resources/views/manage_appointment.blade.php ENDPATH**/ ?>