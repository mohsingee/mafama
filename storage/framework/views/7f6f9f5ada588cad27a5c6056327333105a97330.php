                  ...
                  <div class="row">
                    ...
                    <div class="col-md-9">
                      <ul style="list-style-type: none; padding: 0; margin: 0">
                        <?php $__currentLoopData = $colors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><li class="color-td" style="background-color: <?php echo e($color->color); ?>; display: inline-block;"></li><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></ul>
                    </div>
                  </div>
                    <div class="nk-chat">
                    ...
                    <li class="nk-chat-head-user">
                        <div class="user-card">
                            ...
                            <div class="col-md-12" style="padding: 0px;">
                                ...
                                <?php if(!empty($banner)): ?>
                                <img  src="<?php echo e(asset('public/videos/'.$banner->img)); ?>" style="width: 100%; height: 102px;" >
                                <?php endif; ?>
                            </div>
                                    ...
                                    <div class="user_banner1"><table cellpadding="0" cellspacing="0" class="style1" style="width: 100%;margin-bottom:0px;"><tbody><tr><td id="ctl00_ucBanner1_td_banner" style="width: 100%;"><table border="0" cellspacing="0" cellpadding="0" style="width: 100%;"><tbody><tr><td style="vertical-align: top;"><table border="0" cellpadding="0" cellspacing="0" style="width: 100%;"><tbody><tr><td style="text-align: left; vertical-align: top;"><table width="100%" border="0" cellspacing="0" cellpadding="0"><tbody><tr><td class="Slogan" style="text-align: center; vertical-align: top; height: 30px; padding-bottom: 5px; padding-top: 5px;"><div class="business_name1" style="font-weight: bold; font-size: 10px; color: rgb(255, 255, 170);"><?php if($affiliate_banner->business_name != ""){ echo $affiliate_banner->business_name; } else{ echo $affiliate_details->company; ?>  <?php } ?></div></td></tr><tr><td style="text-align: center; vertical-align: top; padding-left: 10px; padding-right: 10px;">
                                        <div class="description" style="min-height: 20px; padding: 0px;"><?php if($affiliate_banner->message != ""){ echo $affiliate_banner->message; }?></div>
                                            ...
                                            <div class="web_address1"><?php if($affiliate_banner->web_address != ""){ ?><b>Web Address: </b> <?= $affiliate_banner->web_address; ?><?php } ?></div></td></tr></tbody></table></td><td style="">
                                                <img id="bannimg" src="<?php if($affiliate_banner->img != ""){ ?><?php echo e(asset('public/videos')); ?>/<?= $affiliate_banner->img ?><?php }else{?><?php echo e(asset('public/images/affiliates')); ?>/<?= $affiliate_details->image ?> <?php } ?>"  style="border: 2px solid white;   padding: 2px; border-radius: 12px; margin: 10px;"></td></tr></tbody></table></td></tr></tbody></table></td></tr></tbody></table></div>
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="videos-attachments" style="overflow-y: scroll;height: 400px;">
                                                                <div  class="col-md-12" id="videos" class="videos">
                                                                    <?php $__empty_1 = true; $__currentLoopData = $videos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $values1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                                    <div>
                                                                        <?php if($values->video_link!=''): ?>
                                                                        <video width="150" height="150" controls><source src="<?php echo e(asset('public/videos/'.$values1->video_link)); ?>" type="video/mp4"></video><br />
                                                                        <?php endif; ?>
                                                                    </div><br />        
                                                                ...
                                                                <div  class="col-md-12" id="attachments"  class="attachments">
                                                                    <?php $__empty_1 = true; $__currentLoopData = $attachments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $values): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                                    <div>
                                                                        <?php if($values->attachment!=''): ?>
                                                                        <img src="<?php echo e(asset('public/images/'.$values->attachment)); ?>" class="img-thumbnail" width="150" height="150" /><br />
                                                                        <?php endif; ?>
                                                                    </div><br />
                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<?php echo $__env->make('chat.chat_script', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mafamatest/public_html/resources/views/chat.blade.php ENDPATH**/ ?>